...
.method private static readFavorityPlaylist(Landroid/content/Context;)V
    ...
    invoke-static {p0, v0, v5}, Lcom/miui/player/provider/PlaylistHelper;->createPlaylist(Landroid/content/Context;Ljava/lang/String;Z)Landroid/net/Uri;
    ...
    const-string v4, "create favority failed"
    ...
    .line 208
    .local v11, localSet:Ljava/util/HashSet;,"Ljava/util/HashSet<Ljava/lang/Long;>;"
    new-instance v12, Ljava/util/HashSet;

    invoke-direct {v12}, Ljava/util/HashSet;-><init>()V

    .line 209
    .local v12, onlineSet:Ljava/util/HashSet;,"Ljava/util/HashSet<Ljava/lang/String;>;"
    const/4 v0, 0x2
    ...
    .line 213
    .local v2, audioKeys:[Ljava/lang/String;
    ...
    .line 231
    :cond_3
    const-class v4, Lcom/miui/player/provider/FavoriteCache;

    monitor-enter v4

    .line 232
    :try_start_2
    sput-wide v9, Lcom/miui/player/provider/FavoriteCache;->sFavoritePlaylistId:J

    .line 233
    sput-object v11, Lcom/miui/player/provider/FavoriteCache;->sFavoriteLocalTracks:Ljava/util/HashSet;

    .line 234
    sput-object v12, Lcom/miui/player/provider/FavoriteCache;->sFavoriteOnlineTracks:Ljava/util/HashSet;
...
.method public static remove(Landroid/content/Context;[J)I
    ...
    sget-wide v5, Lcom/miui/player/provider/FavoriteCache;->sFavoritePlaylistId:J

    invoke-static {v5, v6}, Lcom/miui/player/provider/PlayerStore$MiuiPlaylists$Members;->getMembersUri(J)Landroid/net/Uri;
