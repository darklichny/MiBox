...
.method private registInternel(Landroid/content/Context;Ljava/lang/String;Lcom/miui/player/util/SongListCache$SongListWaiter;)V
    ...
    iget-object v3, p0, Lcom/miui/player/util/SongListCache;->sUrlToSongListWaiterMap:Ljava/util/HashMap;
    ...
    .line 95
    .local v0, queue:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Lcom/miui/player/util/SongListCache$SongListWaiter;>;"
    if-nez v0, :cond_0

    .line 96
    new-instance v0, Ljava/util/ArrayList;

    .end local v0           #queue:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Lcom/miui/player/util/SongListCache$SongListWaiter;>;"
    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    .line 97
    .restart local v0       #queue:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Lcom/miui/player/util/SongListCache$SongListWaiter;>;"
    iget-object v3, p0, Lcom/miui/player/util/SongListCache;->sUrlToSongListWaiterMap:Ljava/util/HashMap;
    ...
    .line 102
    iget-object v3, p0, Lcom/miui/player/util/SongListCache;->sUrlToRequestMap:Ljava/util/HashMap;
    ...
    .line 104
    new-instance v1, Lcom/miui/player/util/SongListCache$SongListLoadRunnable;

    .end local v1           #runnable:Ljava/lang/Runnable;
    invoke-direct {v1, p0, p1, p2}, Lcom/miui/player/util/SongListCache$SongListLoadRunnable;-><init>(Lcom/miui/player/util/SongListCache;Landroid/content/Context;Ljava/lang/String;)V
    ...
    .line 107
    sget-object v3, Lcom/miui/player/util/SongListCache;->sThreadPoolExecutor:Ljava/util/concurrent/ExecutorService;

    if-nez v3, :cond_2

    .line 108
    const-class v4, Lcom/miui/player/util/SongListCache;
    ...
    sput-object v3, Lcom/miui/player/util/SongListCache;->sThreadPoolExecutor:Ljava/util/concurrent/ExecutorService;
...
# virtual methods
.method public getAllMusicInfoSongList(Ljava/util/Collection;)I
    .locals 2
    .parameter
    .annotation system Ldalvik/annotation/Signature;
        value = {
    ...
    .prologue
    .line 50
    .local p1, ref:Ljava/util/Collection;,"Ljava/util/Collection<Lcom/miui/player/plugin/onlinemusic/MusicInfoSongList;>;"
    ...
    .line 51
    .local v0, old:I
    iget-object v1, p0, Lcom/miui/player/util/SongListCache;->sUrlToSongListMap:Ljava/util/HashMap;
...
.method public getMusicInfoSongList(Ljava/lang/String;)Lcom/miui/player/plugin/onlinemusic/MusicInfoSongList;
    .locals 2
    .parameter "url"
    ...
    .line 57
    iget-object v0, p0, Lcom/miui/player/util/SongListCache;->sUrlToSongListMap:Ljava/util/HashMap;
