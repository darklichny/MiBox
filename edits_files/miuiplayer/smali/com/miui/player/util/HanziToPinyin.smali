.class public Lcom/miui/player/util/HanziToPinyin;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/miui/player/util/HanziToPinyin$Token;
    }
.end annotation
...
.field private static sInstance:Lcom/miui/player/util/HanziToPinyin;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/miui/player/util/HanziToPinyin;->UNIHANS:[C
    ...
    sput-object v0, Lcom/miui/player/util/HanziToPinyin;->PINYINS:[[B
    ...
    sput-object v0, Lcom/miui/player/util/HanziToPinyin;->COLLATOR:Ljava/text/Collator;
...
.method protected constructor <init>(Z)V
    ...
    .line 282
    iput-boolean p1, p0, Lcom/miui/player/util/HanziToPinyin;->mHasChinaCollator:Z
...
.method private addToken(Ljava/lang/StringBuilder;Ljava/util/ArrayList;I)V
    ...
    .prologue
    .line 430
    .local p2, tokens:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Lcom/miui/player/util/HanziToPinyin$Token;>;"
    ...
    new-instance v1, Lcom/miui/player/util/HanziToPinyin$Token;

    invoke-direct {v1, p3, v0, v0}, Lcom/miui/player/util/HanziToPinyin$Token;-><init>(ILjava/lang/String;Ljava/lang/String;)V
...
.method public static getInstance()Lcom/miui/player/util/HanziToPinyin;
    .locals 5

    .prologue
    .line 286
    const-class v3, Lcom/miui/player/util/HanziToPinyin;

    monitor-enter v3

    .line 287
    :try_start_0
    sget-object v2, Lcom/miui/player/util/HanziToPinyin;->sInstance:Lcom/miui/player/util/HanziToPinyin;
    ...
    .line 294
    new-instance v2, Lcom/miui/player/util/HanziToPinyin;

    const/4 v4, 0x1

    invoke-direct {v2, v4}, Lcom/miui/player/util/HanziToPinyin;-><init>(Z)V

    sput-object v2, Lcom/miui/player/util/HanziToPinyin;->sInstance:Lcom/miui/player/util/HanziToPinyin;
...
.method private getToken(C)Lcom/miui/player/util/HanziToPinyin$Token;
    .locals 13
    .parameter "character"
    ...
    .line 305
    new-instance v7, Lcom/miui/player/util/HanziToPinyin$Token;

    invoke-direct {v7}, Lcom/miui/player/util/HanziToPinyin$Token;-><init>()V

    .line 306
    .local v7, token:Lcom/miui/player/util/HanziToPinyin$Token;
    ...
    iput-object v4, v7, Lcom/miui/player/util/HanziToPinyin$Token;->source:Ljava/lang/String;
    ...
    iput v9, v7, Lcom/miui/player/util/HanziToPinyin$Token;->type:I

    .line 312
    iput-object v4, v7, Lcom/miui/player/util/HanziToPinyin$Token;->target:Ljava/lang/String;
    ...
    .line 315
    iput v12, v7, Lcom/miui/player/util/HanziToPinyin$Token;->type:I
    ...
    .line 319
    :cond_1
    sget-object v9, Lcom/miui/player/util/HanziToPinyin;->COLLATOR:Ljava/text/Collator;
    ...
    .line 325
    iput v11, v7, Lcom/miui/player/util/HanziToPinyin$Token;->type:I
    ...
    .line 343
    .local v0, begin:I
    sget-object v9, Lcom/miui/player/util/HanziToPinyin;->UNIHANS:[C
    ...
    .local v3, j:I
    :goto_3
    sget-object v9, Lcom/miui/player/util/HanziToPinyin;->PINYINS:[[B
    ...
    iput-object v9, v7, Lcom/miui/player/util/HanziToPinyin$Token;->target:Ljava/lang/String;
...
.method public get(Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    .line 376
    .local v6, tokens:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Lcom/miui/player/util/HanziToPinyin$Token;>;"
    iget-boolean v7, p0, Lcom/miui/player/util/HanziToPinyin;->mHasChinaCollator:Z
    ...
    .line 391
    invoke-direct {p0, v3, v6, v5}, Lcom/miui/player/util/HanziToPinyin;->addToken(Ljava/lang/StringBuilder;Ljava/util/ArrayList;I)V
    ...
    .line 406
    :cond_7
    invoke-direct {p0, v0}, Lcom/miui/player/util/HanziToPinyin;->getToken(C)Lcom/miui/player/util/HanziToPinyin$Token;

    move-result-object v4

    .line 407
    .local v4, t:Lcom/miui/player/util/HanziToPinyin$Token;
    iget v7, v4, Lcom/miui/player/util/HanziToPinyin$Token;->type:I
    ...
    .line 417
    :cond_a
    iget v5, v4, Lcom/miui/player/util/HanziToPinyin$Token;->type:I
    ...
    .end local v4           #t:Lcom/miui/player/util/HanziToPinyin$Token;
    :cond_b
    invoke-virtual {v3}, Ljava/lang/StringBuilder;->length()I
