...
.method public constructor <init>(Lcom/xiaomi/xmsf/payment/ap;JZ)V
    ...
    iput-object p1, p0, Lcom/xiaomi/xmsf/payment/s;->yw:Lcom/xiaomi/xmsf/payment/ap;

    invoke-virtual {p1}, Lcom/xiaomi/xmsf/payment/ap;->fx()Landroid/support/v4/app/s;
    ...
    iput-wide p2, p0, Lcom/xiaomi/xmsf/payment/s;->tG:J
    ...
    iput-object v0, p0, Lcom/xiaomi/xmsf/payment/s;->fL:Ljava/lang/String;
    ...
    iput-object v0, p0, Lcom/xiaomi/xmsf/payment/s;->fM:Ljava/lang/String;

    iput-boolean p4, p0, Lcom/xiaomi/xmsf/payment/s;->yu:Z
...
.method protected A(I)Z
    ...
    iget-object v0, p0, Lcom/xiaomi/xmsf/payment/s;->yw:Lcom/xiaomi/xmsf/payment/ap;

    iget-wide v1, p0, Lcom/xiaomi/xmsf/payment/s;->tG:J
...
.method protected abstract D(Z)Ljava/lang/String;
.end method
...
.method protected a(Ljava/lang/String;Ljava/lang/String;J)Z
    ...
    invoke-virtual {v0}, Lcom/xiaomi/xmsf/payment/ap;->fy()Landroid/support/v4/app/z;
    ...
    invoke-virtual {v0}, Lcom/xiaomi/xmsf/payment/ap;->fx()Landroid/support/v4/app/s;
...
.method protected b(Lorg/json/JSONObject;)Lcom/xiaomi/xmsf/payment/data/Connection$NetworkError;
    ...
    :cond_2
    iput-object v0, p0, Lcom/xiaomi/xmsf/payment/s;->tc:Ljava/lang/String;

    iput-object v1, p0, Lcom/xiaomi/xmsf/payment/s;->mUrl:Ljava/lang/String;

    iget-boolean v0, p0, Lcom/xiaomi/xmsf/payment/s;->yu:Z
    ...
    invoke-virtual {v2, v0}, Lcom/xiaomi/xmsf/payment/data/Connection;->S(Z)V

    invoke-virtual {v2}, Lcom/xiaomi/xmsf/payment/data/Connection;->iC()Lcom/xiaomi/xmsf/payment/data/Connection$NetworkError;
    ...
    invoke-virtual {v2}, Lcom/xiaomi/xmsf/payment/data/Connection;->iA()Ljava/lang/String;
    ...
    :cond_3
    iput-object v0, p0, Lcom/xiaomi/xmsf/payment/s;->yv:Ljava/lang/String;
...
.method protected bE()V
    ...
    iget-object v0, v0, Lcom/xiaomi/xmsf/payment/ap;->jS:Landroid/widget/Button;
    ...
    iget-object v2, p0, Lcom/xiaomi/xmsf/payment/s;->yw:Lcom/xiaomi/xmsf/payment/ap;

    invoke-virtual {v2}, Lcom/xiaomi/xmsf/payment/ap;->fx()Landroid/support/v4/app/s;

    move-result-object v2

    invoke-direct {v1, v2}, Landroid/app/ProgressDialog;-><init>(Landroid/content/Context;)V

    iput-object v1, v0, Lcom/xiaomi/xmsf/payment/ap;->ta:Landroid/app/ProgressDialog;

    iget-object v0, p0, Lcom/xiaomi/xmsf/payment/s;->yw:Lcom/xiaomi/xmsf/payment/ap;

    iget-object v0, v0, Lcom/xiaomi/xmsf/payment/ap;->ta:Landroid/app/ProgressDialog;

    iget-object v1, p0, Lcom/xiaomi/xmsf/payment/s;->yw:Lcom/xiaomi/xmsf/payment/ap;
    ...
    iget-object v4, p0, Lcom/xiaomi/xmsf/payment/s;->yw:Lcom/xiaomi/xmsf/payment/ap;

    iget-object v4, v4, Lcom/xiaomi/xmsf/payment/ap;->alM:Ljava/lang/String;
...
.method protected bF()Z
    ...
    iget-object v1, v1, Lcom/xiaomi/xmsf/payment/ap;->jS:Landroid/widget/Button;

    invoke-virtual {v1, v0}, Landroid/widget/Button;->setEnabled(Z)V

    iget-object v1, p0, Lcom/xiaomi/xmsf/payment/s;->yw:Lcom/xiaomi/xmsf/payment/ap;

    iget-object v1, v1, Lcom/xiaomi/xmsf/payment/ap;->ta:Landroid/app/ProgressDialog;
...
.method protected bK()Z
    ...
    iget-boolean v1, p0, Lcom/xiaomi/xmsf/payment/s;->yu:Z
    ...
    iget-object v1, p0, Lcom/xiaomi/xmsf/payment/s;->tc:Ljava/lang/String;

    iget-wide v2, p0, Lcom/xiaomi/xmsf/payment/s;->tG:J
...
.method protected bL()Lcom/xiaomi/xmsf/payment/data/Connection;
    ...
    iget-object v1, p0, Lcom/xiaomi/xmsf/payment/s;->Cv:Lcom/xiaomi/xmsf/payment/a/b;

    iget-boolean v2, p0, Lcom/xiaomi/xmsf/payment/s;->yu:Z

    invoke-virtual {p0, v2}, Lcom/xiaomi/xmsf/payment/s;->D(Z)Ljava/lang/String;
    ...
    iget-wide v4, p0, Lcom/xiaomi/xmsf/payment/s;->tG:J
    ...
    iget-object v3, p0, Lcom/xiaomi/xmsf/payment/s;->fL:Ljava/lang/String;

    invoke-virtual {v1, v2, v3}, Lcom/xiaomi/xmsf/payment/data/g;->J(Ljava/lang/String;Ljava/lang/String;)Lcom/xiaomi/xmsf/payment/data/g;

    iget-object v2, p0, Lcom/xiaomi/xmsf/payment/s;->fM:Ljava/lang/String;
    ...
    iget-object v3, p0, Lcom/xiaomi/xmsf/payment/s;->fM:Ljava/lang/String;
