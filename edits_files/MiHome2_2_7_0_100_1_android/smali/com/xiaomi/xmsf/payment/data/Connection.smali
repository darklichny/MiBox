...
# instance fields
.field protected Ah:Lorg/json/JSONObject;

.field protected Ai:Ljava/net/URL;

.field protected Aj:Lcom/xiaomi/xmsf/payment/data/g;
...
.method private a(Ljava/lang/String;Ljava/lang/String;ZLjava/io/OutputStream;)Lcom/xiaomi/xmsf/payment/data/Connection$NetworkError;
    ...
    invoke-direct {p0, v0}, Lcom/xiaomi/xmsf/payment/data/Connection;->ao(I)Lcom/xiaomi/xmsf/payment/data/Connection$NetworkError;
...
.method private ao(I)Lcom/xiaomi/xmsf/payment/data/Connection$NetworkError;
    .locals 3
...
.method private b(Ljava/net/URL;)V
    ...
    iput-boolean v0, p0, Lcom/xiaomi/xmsf/payment/data/Connection;->Ak:Z

    const/4 v0, 0x1

    iput-boolean v0, p0, Lcom/xiaomi/xmsf/payment/data/Connection;->Al:Z
    ...
    iput-object p1, p0, Lcom/xiaomi/xmsf/payment/data/Connection;->Ai:Ljava/net/URL;
...
.method public R(Z)V
    ...
    iput-boolean p1, p0, Lcom/xiaomi/xmsf/payment/data/Connection;->Ak:Z
...
.method public S(Z)V
    ...
    iput-boolean p1, p0, Lcom/xiaomi/xmsf/payment/data/Connection;->Al:Z
...
.method protected b(Ljava/io/OutputStream;)Lcom/xiaomi/xmsf/payment/data/Connection$NetworkError;
    ...
    iget-object v0, p0, Lcom/xiaomi/xmsf/payment/data/Connection;->Ai:Ljava/net/URL;
    ...
    :cond_0
    iget-object v0, p0, Lcom/xiaomi/xmsf/payment/data/Connection;->Aj:Lcom/xiaomi/xmsf/payment/data/g;
    ...
    iput-object v0, p0, Lcom/xiaomi/xmsf/payment/data/Connection;->Aj:Lcom/xiaomi/xmsf/payment/data/g;

    :cond_1
    iget-boolean v0, p0, Lcom/xiaomi/xmsf/payment/data/Connection;->Al:Z

    if-eqz v0, :cond_2

    iget-object v0, p0, Lcom/xiaomi/xmsf/payment/data/Connection;->Aj:Lcom/xiaomi/xmsf/payment/data/g;

    invoke-virtual {v0}, Lcom/xiaomi/xmsf/payment/data/g;->tF()V
    ...
    iget-boolean v2, p0, Lcom/xiaomi/xmsf/payment/data/Connection;->Ak:Z
    ...
    iget-object v2, p0, Lcom/xiaomi/xmsf/payment/data/Connection;->Ai:Ljava/net/URL;
    ...
    iget-boolean v3, p0, Lcom/xiaomi/xmsf/payment/data/Connection;->Ak:Z
    ...
    :cond_4
    iget-boolean v1, p0, Lcom/xiaomi/xmsf/payment/data/Connection;->Ak:Z
...
.method public iB()Lcom/xiaomi/xmsf/payment/data/Connection$NetworkError;
    ...
    iput-object v2, p0, Lcom/xiaomi/xmsf/payment/data/Connection;->Ah:Lorg/json/JSONObject;
    :try_end_0
...
.method public iC()Lcom/xiaomi/xmsf/payment/data/Connection$NetworkError;
    .locals 5
...
.method public iz()Lorg/json/JSONObject;
    .locals 1

    iget-object v0, p0, Lcom/xiaomi/xmsf/payment/data/Connection;->Ah:Lorg/json/JSONObject;
