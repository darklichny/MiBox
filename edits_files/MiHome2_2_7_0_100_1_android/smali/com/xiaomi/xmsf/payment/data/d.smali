...
.method public constructor <init>(Landroid/content/Context;Lcom/xiaomi/xmsf/payment/a/b;)V
    ...
    iput-object p2, p0, Lcom/xiaomi/xmsf/payment/data/d;->Cv:Lcom/xiaomi/xmsf/payment/a/b;
...
.method protected a(Lcom/xiaomi/xmsf/payment/data/Connection$NetworkError;)V
    ...
    invoke-virtual {p0, v0}, Lcom/xiaomi/xmsf/payment/data/d;->A(I)Z

    goto :goto_0

    :cond_6
    invoke-virtual {p0}, Lcom/xiaomi/xmsf/payment/data/d;->bK()Z
...
.method protected abstract bL()Lcom/xiaomi/xmsf/payment/data/Connection;
.end method
...
.method protected varargs e([Ljava/lang/Void;)Lcom/xiaomi/xmsf/payment/data/Connection$NetworkError;
    ...
    iget-object v0, p0, Lcom/xiaomi/xmsf/payment/data/d;->Cv:Lcom/xiaomi/xmsf/payment/a/b;

    iget-object v1, p0, Lcom/xiaomi/xmsf/payment/data/d;->mContext:Landroid/content/Context;

    invoke-virtual {v0, v1}, Lcom/xiaomi/xmsf/payment/a/b;->ac(Landroid/content/Context;)Lcom/xiaomi/xmsf/payment/data/Connection$NetworkError;
    ...
    :cond_1
    invoke-virtual {p0}, Lcom/xiaomi/xmsf/payment/data/d;->kY()Lcom/xiaomi/xmsf/payment/data/Connection$NetworkError;
    ...
    invoke-virtual {v0, v1}, Lcom/xiaomi/xmsf/payment/a/b;->ad(Landroid/content/Context;)Lcom/xiaomi/xmsf/payment/data/Connection$NetworkError;
...
.method protected kY()Lcom/xiaomi/xmsf/payment/data/Connection$NetworkError;
    .locals 3

    iget-object v0, p0, Lcom/xiaomi/xmsf/payment/data/d;->mContext:Landroid/content/Context;

    invoke-static {v0}, Lcom/xiaomi/xmsf/payment/data/f;->bd(Landroid/content/Context;)Z
    ...
    :cond_1
    invoke-virtual {p0}, Lcom/xiaomi/xmsf/payment/data/d;->bL()Lcom/xiaomi/xmsf/payment/data/Connection;

    move-result-object v1

    invoke-virtual {v1}, Lcom/xiaomi/xmsf/payment/data/Connection;->iB()Lcom/xiaomi/xmsf/payment/data/Connection$NetworkError;
    ...
    invoke-virtual {v1}, Lcom/xiaomi/xmsf/payment/data/Connection;->iz()Lorg/json/JSONObject;
...
.method protected onPreExecute()V
    ...
    invoke-virtual {p0}, Lcom/xiaomi/xmsf/payment/data/d;->bE()V
