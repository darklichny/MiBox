...
# instance fields
.field protected EZ:Landroid/widget/Button;

.field protected Fa:Landroid/widget/Button;

.field protected Fb:Landroid/widget/Button;
...
.method public X(Z)V
    ...
    iget-object v0, p0, Lcom/xiaomi/xmsf/account/ui/i;->EZ:Landroid/widget/Button;

    if-eqz v0, :cond_1

    iget-object v1, p0, Lcom/xiaomi/xmsf/account/ui/i;->EZ:Landroid/widget/Button;
...
.method protected b(Landroid/support/v4/app/Fragment;Z)V
    ...
    invoke-virtual {p0}, Lcom/xiaomi/xmsf/account/ui/i;->fy()Landroid/support/v4/app/z;
    ...
    invoke-virtual {v2, v0}, Landroid/support/v4/app/D;->aE(I)Landroid/support/v4/app/D;
    ...
    invoke-virtual {v2, v0}, Landroid/support/v4/app/D;->br(Ljava/lang/String;)Landroid/support/v4/app/D;
...
.method protected b(Landroid/view/View;Z)V
    ...
    invoke-virtual {p0}, Lcom/xiaomi/xmsf/account/ui/i;->fx()Landroid/support/v4/app/s;
...
.method protected ku()V
    ...
    invoke-virtual {p0}, Lcom/xiaomi/xmsf/account/ui/i;->aY()V
...
.method public onClick(Landroid/view/View;)V
    ...
    invoke-virtual {p0}, Lcom/xiaomi/xmsf/account/ui/i;->kv()V
    ...
    :cond_1
    iget-object v0, p0, Lcom/xiaomi/xmsf/account/ui/i;->Fa:Landroid/widget/Button;
    ...
    :cond_2
    iget-object v0, p0, Lcom/xiaomi/xmsf/account/ui/i;->Fb:Landroid/widget/Button;

    if-ne p1, v0, :cond_0

    invoke-virtual {p0}, Lcom/xiaomi/xmsf/account/ui/i;->kt()V
...
.method public onViewCreated(Landroid/view/View;Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, Lcom/xiaomi/xmsf/account/ui/i;->EZ:Landroid/widget/Button;
    ...
    iput-object v0, p0, Lcom/xiaomi/xmsf/account/ui/i;->Fa:Landroid/widget/Button;
    ...
    iput-object v0, p0, Lcom/xiaomi/xmsf/account/ui/i;->Fb:Landroid/widget/Button;
