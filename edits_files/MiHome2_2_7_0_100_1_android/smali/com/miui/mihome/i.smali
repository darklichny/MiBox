.class public Lcom/miui/mihome/i;
.super Landroid/content/res/Resources;


# static fields
.field private static xt:Ljava/util/ArrayList;

.field public static xu:Ljava/util/ArrayList;

.field public static xv:Ljava/util/ArrayList;

.field public static xw:Ljava/util/ArrayList;
...
.field private final xs:Lcom/miui/mihome/m;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/miui/mihome/i;->xt:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    sput-object v0, Lcom/miui/mihome/i;->xu:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    sput-object v0, Lcom/miui/mihome/i;->xv:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    sput-object v0, Lcom/miui/mihome/i;->xw:Ljava/util/ArrayList;

    sget-object v0, Lcom/miui/mihome/i;->xt:Ljava/util/ArrayList;
    ...
    sget-object v0, Lcom/miui/mihome/i;->xu:Ljava/util/ArrayList;
    ...
    sget-object v0, Lcom/miui/mihome/i;->xv:Ljava/util/ArrayList;

    const-string v1, "com.miui.mihome2:drawable/v5_menu_full_bg_light"

    invoke-virtual {v0, v1}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    sget-object v0, Lcom/miui/mihome/i;->xw:Ljava/util/ArrayList;
...
.method public constructor <init>(Landroid/content/res/Resources;)V
    ...
    new-instance v0, Lcom/miui/mihome/m;

    invoke-direct {v0}, Lcom/miui/mihome/m;-><init>()V

    iput-object v0, p0, Lcom/miui/mihome/i;->xs:Lcom/miui/mihome/m;

    new-instance v0, Landroid/util/TypedValue;

    invoke-direct {v0}, Landroid/util/TypedValue;-><init>()V

    iput-object v0, p0, Lcom/miui/mihome/i;->mTmpValue:Landroid/util/TypedValue;

    const-class v0, Landroid/content/res/Resources;

    const-string v1, "mCompatibilityInfo"

    invoke-static {v0, v1, p1}, Lcom/miui/mihome/o;->a(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-static {v1, v2, p0, v0}, Lcom/miui/mihome/o;->a(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/Object;Ljava/lang/Object;)Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-virtual {p0}, Lcom/miui/mihome/i;->getConfiguration()Landroid/content/res/Configuration;

    move-result-object v1

    invoke-virtual {p0}, Lcom/miui/mihome/i;->getDisplayMetrics()Landroid/util/DisplayMetrics;

    move-result-object v2

    invoke-virtual {p0, v1, v2}, Lcom/miui/mihome/i;->updateConfiguration(Landroid/content/res/Configuration;Landroid/util/DisplayMetrics;)V
...
.method private a(Landroid/util/TypedValue;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p0, v7, v8}, Lcom/miui/mihome/i;->m(J)Landroid/graphics/drawable/Drawable;
    ...
    :cond_1
    invoke-virtual {p0, p2}, Lcom/miui/mihome/i;->ag(I)Lmiui/mihome/a/a/e;
    ...
    invoke-virtual {v0, v1, v4}, Lmiui/mihome/a/a/e;->b(ILjava/lang/String;)Lmiui/mihome/a/a/j;
    ...
    :cond_2
    iget-object v3, v9, Lmiui/mihome/a/a/j;->awn:Ljava/io/InputStream;
    ...
    invoke-direct/range {v0 .. v5}, Lcom/miui/mihome/i;->createFromResourceStream(Landroid/content/res/Resources;Landroid/util/TypedValue;Ljava/io/InputStream;Ljava/lang/String;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/drawable/Drawable;
    :try_end_0
    ...
    :goto_1
    :try_start_1
    iget-object v0, v9, Lmiui/mihome/a/a/j;->awn:Ljava/io/InputStream;
    ...
    iget-object v2, p0, Lcom/miui/mihome/i;->xs:Lcom/miui/mihome/m;

    new-instance v3, Ljava/lang/ref/WeakReference;

    invoke-direct {v3, v1}, Ljava/lang/ref/WeakReference;-><init>(Ljava/lang/Object;)V

    invoke-virtual {v2, v7, v8, v3}, Lcom/miui/mihome/m;->put(JLjava/lang/Object;)V
...
.method private a(Lmiui/mihome/a/a/e;)Z
    ...
    invoke-virtual {p1}, Lmiui/mihome/a/a/e;->rh()Lmiui/mihome/a/a/b;

    move-result-object v0

    invoke-virtual {v0}, Lmiui/mihome/a/a/b;->dd()Ljava/lang/String;
...
.method private createFromResourceStream(Landroid/content/res/Resources;Landroid/util/TypedValue;Ljava/io/InputStream;Ljava/lang/String;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/drawable/Drawable;
    ...
    iput v6, p5, Landroid/graphics/BitmapFactory$Options;->inTargetDensity:I
    ...
    invoke-static/range {v0 .. v5}, Lcom/miui/mihome/i;->a(Landroid/content/res/Resources;Landroid/graphics/Bitmap;[BLandroid/graphics/Rect;Landroid/graphics/Rect;Ljava/lang/String;)Landroid/graphics/drawable/Drawable;
    ...
    :cond_9
    invoke-static {p1, v1, v2, v3, p4}, Lcom/miui/mihome/i;->a(Landroid/content/res/Resources;Landroid/graphics/Bitmap;[BLandroid/graphics/Rect;Ljava/lang/String;)Landroid/graphics/drawable/Drawable;
...
.method private m(J)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v1, p0, Lcom/miui/mihome/i;->mTmpValue:Landroid/util/TypedValue;

    monitor-enter v1

    :try_start_0
    iget-object v0, p0, Lcom/miui/mihome/i;->xs:Lcom/miui/mihome/m;

    invoke-virtual {v0, p1, p2}, Lcom/miui/mihome/m;->get(J)Ljava/lang/Object;
    ...
    invoke-virtual {v0, p1, p2}, Lcom/miui/mihome/m;->delete(J)V
...
# virtual methods
.method ag(I)Lmiui/mihome/a/a/e;
    .locals 4
    ...
    :try_start_0
    invoke-virtual {p0, p1}, Lcom/miui/mihome/i;->getResourceName(I)Ljava/lang/String;

    move-result-object v1

    sget-object v2, Lcom/miui/mihome/i;->xt:Ljava/util/ArrayList;
    ...
    :cond_2
    sget-object v2, Lcom/miui/mihome/i;->xu:Ljava/util/ArrayList;
    ...
    :cond_3
    sget-object v2, Lcom/miui/mihome/i;->xv:Ljava/util/ArrayList;
    ...
    :cond_4
    invoke-virtual {p0, p1}, Lcom/miui/mihome/i;->getResourcePackageName(I)Ljava/lang/String;
    ...
    iget-object v2, p0, Lcom/miui/mihome/i;->xr:Ljava/lang/String;
    ...
    iput-object v1, p0, Lcom/miui/mihome/i;->xr:Ljava/lang/String;
...
.method public getColor(I)I
    ...
    invoke-virtual {p0, p1}, Lcom/miui/mihome/i;->ag(I)Lmiui/mihome/a/a/e;

    move-result-object v1

    if-eqz v1, :cond_0

    invoke-direct {p0, v1}, Lcom/miui/mihome/i;->a(Lmiui/mihome/a/a/e;)Z

    move-result v2

    if-nez v2, :cond_0

    invoke-virtual {v1, p1}, Lmiui/mihome/a/a/e;->I(I)Ljava/lang/Integer;
...
.method public getDrawable(I)Landroid/graphics/drawable/Drawable;
    ...
    :try_start_0
    iget-object v0, p0, Lcom/miui/mihome/i;->mTmpValue:Landroid/util/TypedValue;

    const/4 v2, 0x1

    invoke-virtual {p0, p1, v0, v2}, Lcom/miui/mihome/i;->getValue(ILandroid/util/TypedValue;Z)V

    invoke-direct {p0, v0, p1}, Lcom/miui/mihome/i;->a(Landroid/util/TypedValue;I)Landroid/graphics/drawable/Drawable;
    ...
    :try_start_1
    invoke-virtual {p0, p1, v1}, Lcom/miui/mihome/i;->getDrawableForDensity(II)Landroid/graphics/drawable/Drawable;
    :try_end_1
...
.method public getString(I)Ljava/lang/String;
    ...
    invoke-virtual {v1, p1}, Lmiui/mihome/a/a/e;->J(I)Ljava/lang/CharSequence;
