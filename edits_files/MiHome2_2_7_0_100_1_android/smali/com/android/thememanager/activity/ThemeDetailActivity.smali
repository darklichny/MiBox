...
.method static synthetic a(Lcom/android/thememanager/activity/ThemeDetailActivity;)Lmiui/mihome/resourcebrowser/model/Resource;
    ...
    iget-object v0, p0, Lcom/android/thememanager/activity/ThemeDetailActivity;->hz:Lmiui/mihome/resourcebrowser/model/Resource;
...
.method private dH()Lcom/android/thememanager/util/ThemeApplyParameters;
    ...
    invoke-direct {p0}, Lcom/android/thememanager/activity/ThemeDetailActivity;->ts()J

    move-result-wide v2

    iput-wide v2, v1, Lcom/android/thememanager/util/ThemeApplyParameters;->applyFlags:J

    iget-wide v2, p0, Lcom/android/thememanager/activity/ThemeDetailActivity;->aJ:J
...
.method private tr()V
    ...
    iget-boolean v0, p0, Lcom/android/thememanager/activity/ThemeDetailActivity;->ON:Z

    if-eqz v0, :cond_0

    iget-object v0, p0, Lcom/android/thememanager/activity/ThemeDetailActivity;->OM:Landroid/widget/FrameLayout;
    ...
    invoke-virtual {p0}, Lcom/android/thememanager/activity/ThemeDetailActivity;->oI()Z
...
.method private ts()J
    ...
    iget-wide v0, p0, Lcom/android/thememanager/activity/ThemeDetailActivity;->aJ:J
    ...
    iget-wide v0, p0, Lcom/android/thememanager/activity/ThemeDetailActivity;->afE:J
...
.method public dI()V
    ...
    iget-object v0, p0, Lcom/android/thememanager/activity/ThemeDetailActivity;->nF:Lmiui/mihome/resourcebrowser/view/ResourceOperationHandler;
...
.method public dN()V
    ...
    iget-object v2, p0, Lcom/android/thememanager/activity/ThemeDetailActivity;->hz:Lmiui/mihome/resourcebrowser/model/Resource;
    ...
    iget v2, p0, Lcom/android/thememanager/activity/ThemeDetailActivity;->nE:I
...
.method protected j(Lmiui/mihome/resourcebrowser/view/ResourceOperationView;)Lmiui/mihome/resourcebrowser/view/ResourceOperationHandler;
    ...
    iget-object v1, p0, Lcom/android/thememanager/activity/ThemeDetailActivity;->kd:Lmiui/mihome/resourcebrowser/ResourceContext;
...
.method protected oD()Lmiui/mihome/resourcebrowser/model/Resource;
    ...
    invoke-super {p0}, Lmiui/mihome/resourcebrowser/activity/ResourceDetailActivity;->oD()Lmiui/mihome/resourcebrowser/model/Resource;
...
.method protected oJ()V
    ...
    invoke-super {p0}, Lmiui/mihome/resourcebrowser/activity/ResourceDetailActivity;->oJ()V
    ...
    :goto_1
    iput-wide v0, p0, Lcom/android/thememanager/activity/ThemeDetailActivity;->afE:J

    new-instance v0, Ljava/io/File;

    iget-object v1, p0, Lcom/android/thememanager/activity/ThemeDetailActivity;->hz:Lmiui/mihome/resourcebrowser/model/Resource;
    ...
    iget-wide v4, p0, Lcom/android/thememanager/activity/ThemeDetailActivity;->afE:J

    cmp-long v1, v4, v2

    if-eqz v1, :cond_3

    iget-boolean v1, p0, Lcom/android/thememanager/activity/ThemeDetailActivity;->OH:Z
    ...
    :cond_3
    sget-object v0, Lcom/android/thememanager/activity/ThemeDetailActivity;->mK:Ljava/lang/String;

    iget-object v1, p0, Lcom/android/thememanager/activity/ThemeDetailActivity;->xN:Lmiui/mihome/resourcebrowser/model/d;
    ...
    :goto_4
    iget-object v1, p0, Lcom/android/thememanager/activity/ThemeDetailActivity;->xP:Lmiui/mihome/resourcebrowser/view/ResourceOperationView;

    invoke-virtual {v1, v0}, Lmiui/mihome/resourcebrowser/view/ResourceOperationView;->bd(I)V

    :cond_7
    invoke-direct {p0}, Lcom/android/thememanager/activity/ThemeDetailActivity;->tr()V
    ...
    iput-wide v2, p0, Lcom/android/thememanager/activity/ThemeDetailActivity;->afE:J
...
.method protected v()V
    ...
    iget-object v0, p0, Lcom/android/thememanager/activity/ThemeDetailActivity;->kd:Lmiui/mihome/resourcebrowser/ResourceContext;
    ...
    iput-wide v0, p0, Lcom/android/thememanager/activity/ThemeDetailActivity;->aJ:J
...
.method protected w()V
    ...
    invoke-virtual {p0, v0}, Lcom/android/thememanager/activity/ThemeDetailActivity;->bf(I)V
