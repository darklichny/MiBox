...
.field private apZ:Ljava/lang/Object;
...
.method public constructor <init>(Lcom/android/thememanager/a/h;Lmiui/mihome/resourcebrowser/controller/f;)V
    ...
    iput-object p1, p0, Lcom/android/thememanager/a/i;->tt:Lcom/android/thememanager/a/h;
    ...
    iput-object v0, p0, Lcom/android/thememanager/a/i;->apZ:Ljava/lang/Object;
...
.method private c(Lmiui/mihome/resourcebrowser/util/ResourceImportHandler$ResourceForImport;)V
    ...
    invoke-virtual {p0, v0}, Lcom/android/thememanager/a/i;->dX(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p0, v0}, Lcom/android/thememanager/a/i;->dY(Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v0, p0, Lcom/android/thememanager/a/i;->tt:Lcom/android/thememanager/a/h;
...
.method private xn()Z
    ...
    iget-object v4, p0, Lcom/android/thememanager/a/i;->fV:Ljava/util/List;

    monitor-enter v4

    :try_start_0
    iget-object v0, p0, Lcom/android/thememanager/a/i;->fV:Ljava/util/List;
    ...
    iget-object v6, p0, Lcom/android/thememanager/a/i;->tt:Lcom/android/thememanager/a/h;
    ...
    :cond_3
    iget-object v3, p0, Lcom/android/thememanager/a/i;->tt:Lcom/android/thememanager/a/h;
    ...
    invoke-virtual {v3}, Lmiui/mihome/resourcebrowser/controller/f;->xa()Lmiui/mihome/resourcebrowser/controller/b;
    ...
    invoke-virtual {p0, v4}, Lcom/android/thememanager/a/i;->dX(Ljava/lang/String;)Ljava/lang/String;
    ...
    :goto_3
    invoke-direct {p0}, Lcom/android/thememanager/a/i;->xo()V
...
.method private xo()V
    ...
    iget-object v2, p0, Lcom/android/thememanager/a/i;->fV:Ljava/util/List;
    ...
    iput v1, v0, Lcom/android/thememanager/a/g;->Wb:I
...
.method private xp()V
    ...
    iget-object v1, p0, Lcom/android/thememanager/a/i;->fV:Ljava/util/List;
...
.method public dX(Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v1, p0, Lcom/android/thememanager/a/i;->tt:Lcom/android/thememanager/a/h;
    ...
    invoke-static {p1}, Lmiui/mihome/resourcebrowser/util/ResourceHelper;->dk(Ljava/lang/String;)Ljava/lang/String;
...
.method protected fM()V
    ...
    iget-object v3, p0, Lcom/android/thememanager/a/i;->fV:Ljava/util/List;

    monitor-enter v3

    :try_start_0
    iget-object v5, p0, Lcom/android/thememanager/a/i;->fV:Ljava/util/List;
...
.method protected fN()V
    ...
    iget-object v2, p0, Lcom/android/thememanager/a/i;->tt:Lcom/android/thememanager/a/h;
...
.method protected fO()Z
    ...
    iget-object v1, p0, Lcom/android/thememanager/a/i;->apZ:Ljava/lang/Object;

    monitor-enter v1

    :try_start_0
    iget-boolean v2, p0, Lcom/android/thememanager/a/i;->apY:Z

    if-eqz v2, :cond_0

    const/4 v0, 0x0

    iput-boolean v0, p0, Lcom/android/thememanager/a/i;->apY:Z
...
.method protected fP()V
    ...
    :cond_0
    invoke-direct {p0}, Lcom/android/thememanager/a/i;->xn()Z
...
.method protected kM()V
    ...
    invoke-direct {p0}, Lcom/android/thememanager/a/i;->xp()V

    invoke-super {p0}, Lmiui/mihome/resourcebrowser/util/k;->kM()V
