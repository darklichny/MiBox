...
.field final synthetic lz:Lcom/android/thememanager/comment/a;
...
.method public constructor <init>(Lcom/android/thememanager/comment/a;ZI)V
    ...
    iput-object p1, p0, Lcom/android/thememanager/comment/b;->lz:Lcom/android/thememanager/comment/a;

    invoke-direct {p0, p1}, Lmiui/mihome/resourcebrowser/widget/a;-><init>(Lmiui/mihome/resourcebrowser/widget/e;)V

    iput-boolean v0, p0, Lcom/android/thememanager/comment/b;->lx:Z

    iput v0, p0, Lcom/android/thememanager/comment/b;->ly:I

    iput-boolean p2, p0, Lcom/android/thememanager/comment/b;->lx:Z

    iput p3, p0, Lcom/android/thememanager/comment/b;->ly:I
...
.method private ae(Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v1, p0, Lcom/android/thememanager/comment/b;->lz:Lcom/android/thememanager/comment/a;
...
.method private af(Ljava/lang/String;)Z
    ...
    iget-boolean v0, p0, Lcom/android/thememanager/comment/b;->lx:Z
...
.method protected a(Lmiui/mihome/resourcebrowser/widget/c;)Ljava/util/List;
    ...
    iget-object v0, p0, Lcom/android/thememanager/comment/b;->lz:Lcom/android/thememanager/comment/a;
    ...
    invoke-static {v0}, Lmiui/mihome/resourcebrowser/controller/online/I;->dI(Ljava/lang/String;)Lmiui/mihome/resourcebrowser/controller/online/RequestUrl;

    move-result-object v0

    const-string v1, "page"

    iget v2, p0, Lcom/android/thememanager/comment/b;->ly:I
    ...
    :cond_0
    invoke-static {v1}, Lcom/android/thememanager/comment/d;->cE(Ljava/lang/String;)Landroid/util/Pair;
    ...
    iget-object v2, p0, Lcom/android/thememanager/comment/b;->lz:Lcom/android/thememanager/comment/a;
...
.method protected d(Ljava/util/List;)V
    ...
    invoke-virtual {v0}, Lcom/android/thememanager/comment/ResourceCommentsActivity;->bC()V
...
.method protected onPreExecute()V
    ...
    iget v0, p0, Lcom/android/thememanager/comment/b;->ly:I
    ...
    :goto_0
    invoke-virtual {p0, v0}, Lcom/android/thememanager/comment/b;->N(Z)V
