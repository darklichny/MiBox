...
# instance fields
.field private EU:Lmiui/mihome/app/screenelement/util/m;

.field private EV:Ljava/util/HashMap;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/thememanager/view/LockscreenConfigSettings;->EV:Ljava/util/HashMap;

    const/16 v0, 0x64

    iput v0, p0, Lcom/android/thememanager/view/LockscreenConfigSettings;->EX:I

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lcom/android/thememanager/view/LockscreenConfigSettings;->EY:Ljava/util/HashMap;
...
.method static synthetic a(Lcom/android/thememanager/view/LockscreenConfigSettings;Ljava/lang/String;)Lcom/android/thememanager/view/h;
    ...
    invoke-direct {p0, p1}, Lcom/android/thememanager/view/LockscreenConfigSettings;->bq(Ljava/lang/String;)Lcom/android/thememanager/view/h;
...
.method static synthetic a(Lcom/android/thememanager/view/LockscreenConfigSettings;)Ljava/util/HashMap;
    ...
    iget-object v0, p0, Lcom/android/thememanager/view/LockscreenConfigSettings;->EV:Ljava/util/HashMap;
...
.method private a(ILjava/lang/Object;)V
    ...
    iget-object v0, p0, Lcom/android/thememanager/view/LockscreenConfigSettings;->EY:Ljava/util/HashMap;
...
.method public static aB(Landroid/content/Context;)Z
    ...
    invoke-static {p0}, Lcom/android/thememanager/view/LockscreenConfigSettings;->aC(Landroid/content/Context;)Ljava/io/InputStream;
...
.method private static aC(Landroid/content/Context;)Ljava/io/InputStream;
    .locals 2
    ...
    invoke-static {p0}, Lcom/android/thememanager/util/c;->I(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-virtual {v1, v0}, Lmiui/mihome/a/a/d;->aG(Ljava/lang/String;)Lmiui/mihome/a/a/j;
    ...
    iget-object v0, v0, Lmiui/mihome/a/a/j;->awn:Ljava/io/InputStream;
...
.method private aD(I)Ljava/lang/Object;
    .locals 2
...
.method static synthetic b(Lcom/android/thememanager/view/LockscreenConfigSettings;)Lmiui/mihome/app/screenelement/util/m;
    ...
    iget-object v0, p0, Lcom/android/thememanager/view/LockscreenConfigSettings;->EU:Lmiui/mihome/app/screenelement/util/m;

    return-object v0
.end method

.method private bq(Ljava/lang/String;)Lcom/android/thememanager/view/h;
    .locals 2
...
.method private getNextRequestCode()I
    ...
    iget v0, p0, Lcom/android/thememanager/view/LockscreenConfigSettings;->EX:I

    add-int/lit8 v1, v0, 0x1

    iput v1, p0, Lcom/android/thememanager/view/LockscreenConfigSettings;->EX:I
...
.method private kp()V
    ...
    sget-object v1, Lcom/android/thememanager/util/c;->je:Ljava/lang/String;
...
.method private kq()V
    ...
    iget-object v0, p0, Lcom/android/thememanager/view/LockscreenConfigSettings;->EW:Ljava/lang/String;
    ...
    invoke-direct {p0}, Lcom/android/thememanager/view/LockscreenConfigSettings;->kr()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {v0, v1}, Lmiui/mihome/app/screenelement/util/m;->cc(Ljava/lang/String;)Z
...
.method public onActivityResult(IILandroid/content/Intent;)V
    ...
    invoke-direct {p0, p1}, Lcom/android/thememanager/view/LockscreenConfigSettings;->aD(I)Ljava/lang/Object;
    ...
    invoke-direct {p0}, Lcom/android/thememanager/view/LockscreenConfigSettings;->kq()V
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    invoke-static {p0}, Lcom/android/thememanager/view/LockscreenConfigSettings;->aB(Landroid/content/Context;)Z
    ...
    invoke-virtual {p0}, Lcom/android/thememanager/view/LockscreenConfigSettings;->gT()Lcom/actionbarsherlock/b/f;
    ...
    invoke-direct {p0}, Lcom/android/thememanager/view/LockscreenConfigSettings;->kp()V

    invoke-static {}, Lcom/android/thememanager/util/c;->cr()Ljava/lang/String;

    move-result-object v0

    iput-object v0, p0, Lcom/android/thememanager/view/LockscreenConfigSettings;->EW:Ljava/lang/String;

    new-instance v0, Lmiui/mihome/app/screenelement/util/m;

    invoke-direct {v0}, Lmiui/mihome/app/screenelement/util/m;-><init>()V

    iput-object v0, p0, Lcom/android/thememanager/view/LockscreenConfigSettings;->EU:Lmiui/mihome/app/screenelement/util/m;

    iget-object v0, p0, Lcom/android/thememanager/view/LockscreenConfigSettings;->EU:Lmiui/mihome/app/screenelement/util/m;

    iget-object v1, p0, Lcom/android/thememanager/view/LockscreenConfigSettings;->EW:Ljava/lang/String;

    invoke-virtual {v0, v1}, Lmiui/mihome/app/screenelement/util/m;->cd(Ljava/lang/String;)Z

    invoke-direct {p0}, Lcom/android/thememanager/view/LockscreenConfigSettings;->ks()V
...
.method public onPreferenceChange(Landroid/preference/Preference;Ljava/lang/Object;)Z
    ...
    iget-object v1, p0, Lcom/android/thememanager/view/LockscreenConfigSettings;->EV:Ljava/util/HashMap;
...
.method public onPreferenceClick(Landroid/preference/Preference;)Z
    ...
    :cond_0
    invoke-virtual {v0}, Lcom/android/thememanager/view/h;->iO()Z
