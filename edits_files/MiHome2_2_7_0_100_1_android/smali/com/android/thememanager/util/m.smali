...
.method public constructor <init>()V
    ...
    invoke-direct {p0, v0}, Lcom/android/thememanager/util/m;-><init>(I)V
...
.method private declared-synchronized a(Landroid/graphics/Bitmap;Ljava/lang/String;IZ)Landroid/graphics/Bitmap;
    ...
    :try_start_0
    iget-object v0, p0, Lcom/android/thememanager/util/m;->Wj:Lmiui/mihome/resourcebrowser/util/h;
    ...
    iget v4, p0, Lcom/android/thememanager/util/m;->Wk:I

    iget v1, p0, Lcom/android/thememanager/util/m;->Wl:I
    :try_end_0
    ...
    invoke-virtual {p0}, Lcom/android/thememanager/util/m;->qY()I
    ...
    iget-object v1, p0, Lcom/android/thememanager/util/m;->Wj:Lmiui/mihome/resourcebrowser/util/h;
...
.method private b(Ljava/lang/String;II)Landroid/graphics/Bitmap;
    ...
    invoke-direct {p0, p1, p2, p3}, Lcom/android/thememanager/util/m;->a(Ljava/lang/String;II)I
...
.method public a(Ljava/lang/String;IZ)Landroid/graphics/Bitmap;
    ...
    invoke-virtual {p0, p1}, Lcom/android/thememanager/util/m;->m(Ljava/lang/String;)Landroid/graphics/Bitmap;

    move-result-object v0

    if-nez v0, :cond_1

    iget v1, p0, Lcom/android/thememanager/util/m;->Wk:I

    iget v2, p0, Lcom/android/thememanager/util/m;->Wl:I

    invoke-direct {p0, p1, v1, v2}, Lcom/android/thememanager/util/m;->b(Ljava/lang/String;II)Landroid/graphics/Bitmap;

    move-result-object v1

    if-eqz v1, :cond_1

    iget-object v2, p0, Lcom/android/thememanager/util/m;->Wj:Lmiui/mihome/resourcebrowser/util/h;

    invoke-virtual {v2, p2}, Lmiui/mihome/resourcebrowser/util/h;->am(I)Z

    move-result v2

    if-eqz v2, :cond_0

    invoke-direct {p0, v1, p1, p2, p3}, Lcom/android/thememanager/util/m;->a(Landroid/graphics/Bitmap;Ljava/lang/String;IZ)Landroid/graphics/Bitmap;
