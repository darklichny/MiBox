...
# instance fields
.field private final agE:Landroid/appwidget/AppWidgetHost;
...
.method constructor <init>(Landroid/content/Context;)V
    ...
    iput-wide v0, p0, Lcom/android/launcher2/cA;->agF:J

    iput-object p1, p0, Lcom/android/launcher2/cA;->mContext:Landroid/content/Context;
    ...
    iput-object v0, p0, Lcom/android/launcher2/cA;->agE:Landroid/appwidget/AppWidgetHost;

    return-void
.end method

.method static synthetic a(Lcom/android/launcher2/cA;)Landroid/content/Context;
    .locals 1

    iget-object v0, p0, Lcom/android/launcher2/cA;->mContext:Landroid/content/Context;
...
.method private a(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;)V
    ...
    iget-object v1, p0, Lcom/android/launcher2/cA;->mContext:Landroid/content/Context;
...
.method private a(Landroid/database/sqlite/SQLiteDatabase;Landroid/content/ContentValues;)Z
    ...
    invoke-direct {p0, p1, p2, v0}, Lcom/android/launcher2/cA;->a(Landroid/database/sqlite/SQLiteDatabase;Landroid/content/ContentValues;I)Z
...
.method private a(Landroid/database/sqlite/SQLiteDatabase;Landroid/content/ContentValues;I)Z
    ...
    invoke-static {p3}, Lcom/android/launcher2/gadget/aq;->dl(I)Lcom/android/launcher2/gadget/O;

    move-result-object v0

    const-string v1, "spanX"

    iget v2, v0, Lcom/android/launcher2/gadget/O;->Ay:I
    ...
    iget v0, v0, Lcom/android/launcher2/gadget/O;->Az:I
...
.method private a(Landroid/database/sqlite/SQLiteDatabase;Landroid/content/ContentValues;Landroid/content/ComponentName;II)Z
    ...
    :try_start_0
    iget-object v0, p0, Lcom/android/launcher2/cA;->agE:Landroid/appwidget/AppWidgetHost;
...
.method private a(Landroid/database/sqlite/SQLiteDatabase;Landroid/content/ContentValues;Lcom/android/launcher2/dP;)Z
    .locals 3
    ...
    invoke-virtual {p3, v1}, Lcom/android/launcher2/dP;->getString(I)Ljava/lang/String;
...
.method private a(Landroid/database/sqlite/SQLiteDatabase;Landroid/content/ContentValues;Lcom/android/launcher2/dP;Landroid/content/pm/PackageManager;)Z
    .locals 6
    ...
    invoke-virtual {p3, v0}, Lcom/android/launcher2/dP;->getString(I)Ljava/lang/String;
    ...
    invoke-virtual {p3, v1, v0}, Lcom/android/launcher2/dP;->getInt(II)I
    ...
    invoke-direct/range {v0 .. v5}, Lcom/android/launcher2/cA;->a(Landroid/database/sqlite/SQLiteDatabase;Landroid/content/ContentValues;Landroid/content/ComponentName;II)Z
...
.method private a(Landroid/database/sqlite/SQLiteDatabase;Landroid/content/ContentValues;Lcom/android/launcher2/dP;Landroid/content/pm/PackageManager;Landroid/content/Intent;)Z
    .locals 7
    ...
    :cond_1
    invoke-static {v3, v6}, Lmiui/mihome/a/a/c;->o(Ljava/lang/String;Ljava/lang/String;)Landroid/graphics/drawable/BitmapDrawable;
    ...
    invoke-virtual {p3, v2}, Lcom/android/launcher2/dP;->getDrawable(I)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v2, p0, Lcom/android/launcher2/cA;->mContext:Landroid/content/Context;
    ...
    invoke-virtual {p3, v4}, Lcom/android/launcher2/dP;->getString(I)Ljava/lang/String;
    ...
    invoke-static {v2}, Lcom/android/launcher2/J;->d(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Bitmap;

    move-result-object v0

    invoke-static {p2, v0}, Lcom/android/launcher2/dw;->a(Landroid/content/ContentValues;Landroid/graphics/Bitmap;)V
...
.method private a(Landroid/database/sqlite/SQLiteDatabase;Landroid/content/ContentValues;Lcom/android/launcher2/dP;Landroid/content/pm/PackageManager;Landroid/content/Intent;Ljava/util/List;)Z
    .locals 8
    ...
    invoke-virtual {p3, v2, v3}, Lcom/android/launcher2/dP;->getBoolean(IZ)Z
    ...
    invoke-direct/range {p0 .. p5}, Lcom/android/launcher2/cA;->a(Landroid/database/sqlite/SQLiteDatabase;Landroid/content/ContentValues;Lcom/android/launcher2/dP;Landroid/content/pm/PackageManager;Landroid/content/Intent;)Z
    ...
    invoke-virtual {p3, v2}, Lcom/android/launcher2/dP;->getString(I)Ljava/lang/String;
    ...
    iget-object v5, p0, Lcom/android/launcher2/cA;->mContext:Landroid/content/Context;
    ...
    invoke-virtual {p3, v0, v5}, Lcom/android/launcher2/dP;->getBoolean(IZ)Z
...
.method private b(Landroid/database/sqlite/SQLiteDatabase;Landroid/content/ContentValues;Lcom/android/launcher2/dP;)Z
    .locals 1
    ...
    invoke-static {v0}, Lcom/android/launcher2/gadget/aq;->dW(Ljava/lang/String;)I
...
.method private c(Landroid/database/sqlite/SQLiteDatabase;Landroid/content/ContentValues;Lcom/android/launcher2/dP;)Z
    .locals 8
    ...
    iget-object v3, p0, Lcom/android/launcher2/cA;->mContext:Landroid/content/Context;

    invoke-static {v3, v0}, Lcom/android/launcher2/LauncherProvider;->C(Landroid/content/Context;Ljava/lang/String;)Ljava/util/List;
    ...
    :cond_0
    invoke-direct {p0, v3}, Lcom/android/launcher2/cA;->v(Ljava/util/List;)Landroid/content/pm/ResolveInfo;
    ...
    invoke-virtual {p3, v7}, Lcom/android/launcher2/dP;->getString(I)Ljava/lang/String;
    ...
    invoke-virtual {p3, v3}, Lcom/android/launcher2/dP;->getString(I)Ljava/lang/String;
...
.method private d(Landroid/database/sqlite/SQLiteDatabase;Landroid/content/ContentValues;Lcom/android/launcher2/dP;)Z
    .locals 6
...
.method private f(Landroid/database/sqlite/SQLiteDatabase;)I
    ...
    iget-object v5, v0, Lcom/android/launcher2/cA;->mContext:Landroid/content/Context;
    ...
    invoke-static {v5, v11}, Lcom/android/launcher2/bP;->a(Landroid/content/Context;Ljava/util/List;)V

    const/4 v12, 0x0

    :try_start_0
    invoke-direct/range {p0 .. p0}, Lcom/android/launcher2/cA;->tI()Lorg/xmlpull/v1/XmlPullParser;
    ...
    invoke-direct/range {p0 .. p0}, Lcom/android/launcher2/cA;->tJ()I
    ...
    invoke-static/range {v21 .. v21}, Lcom/android/launcher2/bS;->c(Ljava/util/HashMap;)V
    ...
    new-instance v8, Lcom/android/launcher2/dP;

    sget-object v5, Lcom/miui/a/a;->ug:[I

    move-object/from16 v0, p0

    move-object/from16 v1, v18

    invoke-direct {v8, v0, v1, v5}, Lcom/android/launcher2/dP;-><init>(Lcom/android/launcher2/cA;Ljava/lang/Object;[I)V

    invoke-virtual {v7}, Landroid/content/ContentValues;->clear()V

    const/4 v5, 0x3

    invoke-virtual {v8, v5}, Lcom/android/launcher2/dP;->getString(I)Ljava/lang/String;
    ...
    invoke-virtual {v8, v14}, Lcom/android/launcher2/dP;->getString(I)Ljava/lang/String;
    ...
    invoke-virtual {v8, v5, v13}, Lcom/android/launcher2/dP;->getInt(II)I
    ...
    invoke-static {v5, v0, v13}, Lcom/android/launcher2/bS;->a(ILjava/util/HashMap;Z)Lcom/android/launcher2/b;

    move-result-object v5

    iget v13, v5, Lcom/android/launcher2/b;->aY:I

    if-ltz v13, :cond_0

    iget v13, v5, Lcom/android/launcher2/b;->aZ:I
    ...
    iget v5, v5, Lcom/android/launcher2/b;->aZ:I
    ...
    invoke-static {v0, v1, v2, v3, v4}, Lcom/android/launcher2/bS;->a(Ljava/util/HashMap;IIIZ)V
    ...
    iget-object v6, v0, Lcom/android/launcher2/cA;->mContext:Landroid/content/Context;
    ...
    invoke-direct/range {v5 .. v11}, Lcom/android/launcher2/cA;->a(Landroid/database/sqlite/SQLiteDatabase;Landroid/content/ContentValues;Lcom/android/launcher2/dP;Landroid/content/pm/PackageManager;Landroid/content/Intent;Ljava/util/List;)Z
    ...
    invoke-direct {v0, v1, v7, v8}, Lcom/android/launcher2/cA;->c(Landroid/database/sqlite/SQLiteDatabase;Landroid/content/ContentValues;Lcom/android/launcher2/dP;)Z
    ...
    invoke-direct {v0, v1, v7}, Lcom/android/launcher2/cA;->a(Landroid/database/sqlite/SQLiteDatabase;Landroid/content/ContentValues;)Z
    ...
    invoke-direct {v0, v1, v7}, Lcom/android/launcher2/cA;->b(Landroid/database/sqlite/SQLiteDatabase;Landroid/content/ContentValues;)Z
    ...
    invoke-direct {v0, v1, v7, v8, v9}, Lcom/android/launcher2/cA;->a(Landroid/database/sqlite/SQLiteDatabase;Landroid/content/ContentValues;Lcom/android/launcher2/dP;Landroid/content/pm/PackageManager;)Z
    ...
    invoke-direct {v0, v1, v7, v8}, Lcom/android/launcher2/cA;->d(Landroid/database/sqlite/SQLiteDatabase;Landroid/content/ContentValues;Lcom/android/launcher2/dP;)Z
    ...
    invoke-virtual {v8, v6}, Lcom/android/launcher2/dP;->getString(I)Ljava/lang/String;
    ...
    invoke-direct {v0, v1, v7, v8}, Lcom/android/launcher2/cA;->a(Landroid/database/sqlite/SQLiteDatabase;Landroid/content/ContentValues;Lcom/android/launcher2/dP;)Z
    ...
    invoke-direct {v0, v1, v7, v8}, Lcom/android/launcher2/cA;->b(Landroid/database/sqlite/SQLiteDatabase;Landroid/content/ContentValues;Lcom/android/launcher2/dP;)Z
    ...
    :cond_11
    :goto_8
    invoke-virtual {v8}, Lcom/android/launcher2/dP;->recycle()V
    :try_end_5
...
.method private tI()Lorg/xmlpull/v1/XmlPullParser;
    .locals 2
...
.method private tJ()I
    ...
    :try_start_0
    invoke-direct {p0}, Lcom/android/launcher2/cA;->tI()Lorg/xmlpull/v1/XmlPullParser;
    ...
    new-instance v2, Lcom/android/launcher2/dP;

    sget-object v7, Lcom/miui/a/a;->ug:[I

    invoke-direct {v2, p0, v6, v7}, Lcom/android/launcher2/dP;-><init>(Lcom/android/launcher2/cA;Ljava/lang/Object;[I)V

    const/4 v7, 0x1

    invoke-virtual {v2, v7}, Lcom/android/launcher2/dP;->getString(I)Ljava/lang/String;

    move-result-object v7

    const/4 v8, 0x0

    invoke-virtual {v2, v8}, Lcom/android/launcher2/dP;->getString(I)Ljava/lang/String;
    ...
    invoke-virtual {v2, v9, v10}, Lcom/android/launcher2/dP;->getBoolean(IZ)Z
    ...
    invoke-virtual {v2, v9, v10}, Lcom/android/launcher2/dP;->getInt(II)I
    :try_end_1
    ...
    iget-object v7, p0, Lcom/android/launcher2/cA;->mContext:Landroid/content/Context;
...
.method private v(Ljava/util/List;)Landroid/content/pm/ResolveInfo;
    ...
    invoke-static {v3, v2}, Lcom/android/launcher2/J;->s(Landroid/content/Context;Ljava/lang/String;)Z
...
.method public d(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    invoke-direct {p0, p1}, Lcom/android/launcher2/cA;->e(Landroid/database/sqlite/SQLiteDatabase;)J
...
.method public kn()J
    ...
    iget-wide v0, p0, Lcom/android/launcher2/cA;->agF:J
    ...
    invoke-virtual {p0}, Lcom/android/launcher2/cA;->getWritableDatabase()Landroid/database/sqlite/SQLiteDatabase;

    move-result-object v0

    invoke-direct {p0, v0}, Lcom/android/launcher2/cA;->e(Landroid/database/sqlite/SQLiteDatabase;)J
...
.method public onCreate(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    invoke-direct {p0}, Lcom/android/launcher2/cA;->tH()V

    :cond_0
    invoke-direct {p0, p1}, Lcom/android/launcher2/cA;->f(Landroid/database/sqlite/SQLiteDatabase;)I

    invoke-direct {p0, p1}, Lcom/android/launcher2/cA;->c(Landroid/database/sqlite/SQLiteDatabase;)V
...
.method public onUpgrade(Landroid/database/sqlite/SQLiteDatabase;II)V
    ...
    invoke-direct {p0, p1, v0}, Lcom/android/launcher2/cA;->a(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p1}, Lcom/android/launcher2/cA;->onCreate(Landroid/database/sqlite/SQLiteDatabase;)V
