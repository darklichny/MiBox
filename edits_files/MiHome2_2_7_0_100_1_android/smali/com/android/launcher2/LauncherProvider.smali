...
# static fields
.field static final EL:Landroid/net/Uri;


# instance fields
.field private EM:Lcom/android/launcher2/cA;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/launcher2/LauncherProvider;->EL:Landroid/net/Uri;
...
.method private static A(Landroid/content/Context;Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-static {p0, p1}, Lcom/android/launcher2/LauncherProvider;->B(Landroid/content/Context;Ljava/lang/String;)Ljava/util/List;
...
.method private static B(Landroid/content/Context;Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-static {}, Lcom/android/launcher2/aa;->hN()Z
    ...
    invoke-static {p0, v1, v0, v2}, Lcom/android/launcher2/J;->a(Landroid/content/Context;Landroid/content/Intent;IZ)Ljava/util/List;
    ...
    :cond_2
    invoke-static {}, Lcom/android/launcher2/aa;->hP()Z
    ...
    :cond_3
    invoke-static {}, Lcom/android/launcher2/aa;->id()Z
    ...
    invoke-static {}, Lcom/android/launcher2/aa;->hO()Z
    ...
    invoke-static {}, Lcom/android/launcher2/aa;->hQ()Z
...
.method static synthetic C(Landroid/content/Context;Ljava/lang/String;)Ljava/util/List;
    .locals 1

    invoke-static {p0, p1}, Lcom/android/launcher2/LauncherProvider;->A(Landroid/content/Context;Ljava/lang/String;)Ljava/util/List;
...
.method private a(Landroid/database/sqlite/SQLiteDatabase;)Ljava/util/ArrayList;
    ...
    iget-object v0, p0, Lcom/android/launcher2/LauncherProvider;->EN:Ljava/util/ArrayList;

    if-nez v0, :cond_0

    invoke-static {p1}, Lcom/android/launcher2/bS;->a(Landroid/database/sqlite/SQLiteDatabase;)Ljava/util/ArrayList;

    move-result-object v0

    iput-object v0, p0, Lcom/android/launcher2/LauncherProvider;->EN:Ljava/util/ArrayList;
...
.method private km()V
    ...
    iget-object v0, p0, Lcom/android/launcher2/LauncherProvider;->EM:Lcom/android/launcher2/cA;

    if-eqz v0, :cond_0

    iget-object v0, p0, Lcom/android/launcher2/LauncherProvider;->EM:Lcom/android/launcher2/cA;

    invoke-virtual {v0}, Lcom/android/launcher2/cA;->close()V
...
.method public bulkInsert(Landroid/net/Uri;[Landroid/content/ContentValues;)I
    ...
    :try_start_0
    new-instance v3, Lcom/android/launcher2/bB;

    invoke-direct {v3, p1}, Lcom/android/launcher2/bB;-><init>(Landroid/net/Uri;)V

    iget-object v1, p0, Lcom/android/launcher2/LauncherProvider;->EM:Lcom/android/launcher2/cA;

    invoke-virtual {v1}, Lcom/android/launcher2/cA;->getWritableDatabase()Landroid/database/sqlite/SQLiteDatabase;
    ...
    iget-object v6, v3, Lcom/android/launcher2/bB;->abV:Ljava/lang/String;
    ...
    invoke-virtual {v0, v4}, Lcom/android/launcher2/cA;->d(Landroid/database/sqlite/SQLiteDatabase;)V
...
.method public call(Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)Landroid/os/Bundle;
    ...
    invoke-virtual {v0}, Lcom/android/launcher2/cA;->getWritableDatabase()Landroid/database/sqlite/SQLiteDatabase;
    ...
    invoke-static {v0, v1, v2}, Lcom/android/launcher2/bS;->b(Landroid/database/sqlite/SQLiteDatabase;J)Z
    ...
    invoke-static {v0}, Lcom/android/launcher2/bS;->ba(Landroid/content/Context;)V
...
.method public delete(Landroid/net/Uri;Ljava/lang/String;[Ljava/lang/String;)I
    ...
    invoke-direct {v0, p1, p2, p3}, Lcom/android/launcher2/bB;-><init>(Landroid/net/Uri;Ljava/lang/String;[Ljava/lang/String;)V

    iget-object v2, p0, Lcom/android/launcher2/LauncherProvider;->EM:Lcom/android/launcher2/cA;

    invoke-virtual {v2}, Lcom/android/launcher2/cA;->getWritableDatabase()Landroid/database/sqlite/SQLiteDatabase;

    move-result-object v2

    iget-object v3, v0, Lcom/android/launcher2/bB;->abV:Ljava/lang/String;

    iget-object v4, v0, Lcom/android/launcher2/bB;->abW:Ljava/lang/String;

    iget-object v0, v0, Lcom/android/launcher2/bB;->args:[Ljava/lang/String;
    ...
    iget-object v3, p0, Lcom/android/launcher2/LauncherProvider;->EM:Lcom/android/launcher2/cA;

    invoke-virtual {v3, v2}, Lcom/android/launcher2/cA;->d(Landroid/database/sqlite/SQLiteDatabase;)V
...
.method public getType(Landroid/net/Uri;)Ljava/lang/String;
    ...
    invoke-direct {v0, p1, v1, v1}, Lcom/android/launcher2/bB;-><init>(Landroid/net/Uri;Ljava/lang/String;[Ljava/lang/String;)V

    iget-object v1, v0, Lcom/android/launcher2/bB;->abW:Ljava/lang/String;
    ...
    iget-object v0, v0, Lcom/android/launcher2/bB;->abV:Ljava/lang/String;
...
.method public insert(Landroid/net/Uri;Landroid/content/ContentValues;)Landroid/net/Uri;
    ...
    :try_start_0
    new-instance v2, Lcom/android/launcher2/bB;

    invoke-direct {v2, p1}, Lcom/android/launcher2/bB;-><init>(Landroid/net/Uri;)V

    iget-object v3, p0, Lcom/android/launcher2/LauncherProvider;->EM:Lcom/android/launcher2/cA;

    invoke-virtual {v3}, Lcom/android/launcher2/cA;->getWritableDatabase()Landroid/database/sqlite/SQLiteDatabase;

    move-result-object v3

    const-string v4, "favorites"

    iget-object v5, v2, Lcom/android/launcher2/bB;->abV:Ljava/lang/String;
    ...
    invoke-static {v5, v3, v6, p2}, Lcom/android/launcher2/bS;->a(Landroid/content/Context;Landroid/database/sqlite/SQLiteDatabase;Ljava/util/ArrayList;Landroid/content/ContentValues;)Z
    ...
    :cond_1
    :try_start_1
    iget-object v2, v2, Lcom/android/launcher2/bB;->abV:Ljava/lang/String;
    ...
    invoke-static {v0, v3, v2, v5, v6}, Lcom/android/launcher2/bS;->a(Landroid/content/Context;Landroid/database/sqlite/SQLiteDatabase;Ljava/util/ArrayList;J)V
...
.method public kn()J
    ...
    invoke-virtual {v0}, Lcom/android/launcher2/cA;->kn()J
...
.method public onCreate()Z
    ...
    invoke-direct {p0}, Lcom/android/launcher2/LauncherProvider;->km()V
    ...
    invoke-direct {v0, v1}, Lcom/android/launcher2/cA;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lcom/android/launcher2/LauncherProvider;->EM:Lcom/android/launcher2/cA;
    ...
    invoke-virtual {v0, p0}, Lcom/android/launcher2/cP;->a(Lcom/android/launcher2/LauncherProvider;)V
...
.method public query(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    ...
    invoke-direct {v2, p1, p3, p4}, Lcom/android/launcher2/bB;-><init>(Landroid/net/Uri;Ljava/lang/String;[Ljava/lang/String;)V

    new-instance v0, Landroid/database/sqlite/SQLiteQueryBuilder;

    invoke-direct {v0}, Landroid/database/sqlite/SQLiteQueryBuilder;-><init>()V

    iget-object v1, v2, Lcom/android/launcher2/bB;->abV:Ljava/lang/String;
    ...
    iget-object v3, v2, Lcom/android/launcher2/bB;->abW:Ljava/lang/String;

    iget-object v4, v2, Lcom/android/launcher2/bB;->args:[Ljava/lang/String;
...
.method public update(Landroid/net/Uri;Landroid/content/ContentValues;Ljava/lang/String;[Ljava/lang/String;)I
    ...
    :try_start_0
    new-instance v6, Lcom/android/launcher2/bB;

    move-object/from16 v0, p3

    move-object/from16 v1, p4

    invoke-direct {v6, p1, v0, v1}, Lcom/android/launcher2/bB;-><init>(Landroid/net/Uri;Ljava/lang/String;[Ljava/lang/String;)V
    ...
    iget-object v3, v6, Lcom/android/launcher2/bB;->abV:Ljava/lang/String;
    ...
    invoke-static {v3, v7, v2}, Lcom/android/launcher2/bS;->b(Landroid/content/Context;Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;)V

    :goto_0
    iget-object v2, p0, Lcom/android/launcher2/LauncherProvider;->EM:Lcom/android/launcher2/cA;

    invoke-virtual {v2, v7}, Lcom/android/launcher2/cA;->d(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    invoke-static {v3, v7, v4, v2, v6}, Lcom/android/launcher2/bS;->a(Landroid/content/Context;Landroid/database/sqlite/SQLiteDatabase;Ljava/util/ArrayList;Ljava/lang/String;Z)V
    ...
    iget-object v10, v6, Lcom/android/launcher2/bB;->abV:Ljava/lang/String;
    ...
    iput-object v2, p0, Lcom/android/launcher2/LauncherProvider;->EN:Ljava/util/ArrayList;
    ...
    invoke-static {v2, v7, v3, v0}, Lcom/android/launcher2/bS;->a(Landroid/content/Context;Landroid/database/sqlite/SQLiteDatabase;Ljava/util/ArrayList;Landroid/content/ContentValues;)Z

    :cond_6
    iget-object v2, v6, Lcom/android/launcher2/bB;->abV:Ljava/lang/String;

    iget-object v3, v6, Lcom/android/launcher2/bB;->abW:Ljava/lang/String;

    iget-object v4, v6, Lcom/android/launcher2/bB;->args:[Ljava/lang/String;
