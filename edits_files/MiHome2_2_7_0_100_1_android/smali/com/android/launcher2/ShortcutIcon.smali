...
# static fields
.field private static wo:Landroid/view/animation/Animation;

.field private static wp:Landroid/view/animation/Animation;

.field static wq:Landroid/util/TypedValue;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/launcher2/ShortcutIcon;->wo:Landroid/view/animation/Animation;

    sput-object v0, Lcom/android/launcher2/ShortcutIcon;->wp:Landroid/view/animation/Animation;

    new-instance v0, Landroid/util/TypedValue;

    invoke-direct {v0}, Landroid/util/TypedValue;-><init>()V

    sput-object v0, Lcom/android/launcher2/ShortcutIcon;->wq:Landroid/util/TypedValue;
...
.method static a(ILcom/android/launcher2/Launcher;Landroid/view/ViewGroup;Lcom/android/launcher2/eb;)Lcom/android/launcher2/ShortcutIcon;
    .locals 2

    invoke-virtual {p3}, Lcom/android/launcher2/eb;->zv()Lcom/android/launcher2/ShortcutIcon;
    ...
    invoke-virtual {p3, v0}, Lcom/android/launcher2/eb;->a(Lcom/android/launcher2/ShortcutIcon;)V

    :cond_0
    invoke-virtual {v0, p1, p2}, Lcom/android/launcher2/ShortcutIcon;->a(Lcom/android/launcher2/Launcher;Landroid/view/ViewGroup;)V

    invoke-virtual {v0, p1, p3}, Lcom/android/launcher2/ShortcutIcon;->a(Lcom/android/launcher2/Launcher;Lcom/android/launcher2/eb;)V

    return-object v0
.end method

.method private k(Lcom/android/launcher2/dn;)Z
    .locals 2
...
.method protected a(Lcom/android/launcher2/Launcher;Landroid/view/ViewGroup;)V
    ...
    invoke-virtual {p0, v8}, Lcom/android/launcher2/ShortcutIcon;->y(F)V
    ...
    invoke-virtual {p0, v6}, Lcom/android/launcher2/ShortcutIcon;->aO(Z)V

    iget-object v1, p0, Lcom/android/launcher2/ShortcutIcon;->ko:Landroid/widget/TextView;
    ...
    sget-object v3, Lcom/android/launcher2/ShortcutIcon;->wq:Landroid/util/TypedValue;

    invoke-virtual {v2, v1, v3, v7}, Landroid/content/res/Resources;->getValue(ILandroid/util/TypedValue;Z)V

    sget-object v1, Lcom/android/launcher2/ShortcutIcon;->wq:Landroid/util/TypedValue;
    ...
    sget-object v4, Lcom/android/launcher2/ShortcutIcon;->wq:Landroid/util/TypedValue;
    ...
    sget-object v5, Lcom/android/launcher2/ShortcutIcon;->wq:Landroid/util/TypedValue;

    invoke-virtual {v2, v4, v5, v7}, Landroid/content/res/Resources;->getValue(ILandroid/util/TypedValue;Z)V

    sget-object v2, Lcom/android/launcher2/ShortcutIcon;->wq:Landroid/util/TypedValue;

    invoke-virtual {v2}, Landroid/util/TypedValue;->getFloat()F

    move-result v2

    iget-object v4, p0, Lcom/android/launcher2/ShortcutIcon;->ko:Landroid/widget/TextView;
    ...
    instance-of v3, v1, Lcom/android/launcher2/bE;

    if-nez v3, :cond_9

    new-instance v0, Lcom/android/launcher2/bE;

    invoke-direct {v0, v1}, Lcom/android/launcher2/bE;-><init>(Landroid/view/ViewGroup$LayoutParams;)V
    ...
    invoke-virtual {p0, v7}, Lcom/android/launcher2/ShortcutIcon;->aO(Z)V
    ...
    invoke-virtual {p0, v1}, Lcom/android/launcher2/ShortcutIcon;->p(I)V
...
.method public a(Lcom/android/launcher2/Launcher;Lcom/android/launcher2/eb;)V
    .locals 2
    ...
    invoke-virtual {p1}, Lcom/android/launcher2/Launcher;->mB()Lcom/android/launcher2/dT;

    move-result-object v1

    invoke-virtual {p2, v0, v1}, Lcom/android/launcher2/eb;->a(Landroid/content/Context;Lcom/android/launcher2/dT;)Landroid/graphics/drawable/Drawable;

    move-result-object v0

    invoke-virtual {p2}, Lcom/android/launcher2/eb;->zu()Landroid/graphics/Bitmap;
    ...
    iget-object v0, p2, Lcom/android/launcher2/eb;->title:Ljava/lang/CharSequence;
    ...
    iget-object v1, p0, Lcom/android/launcher2/ShortcutIcon;->wr:Landroid/widget/ImageView$ScaleType;

    invoke-virtual {v0, v1}, Landroid/widget/ImageView;->setScaleType(Landroid/widget/ImageView$ScaleType;)V

    sget-object v0, Lcom/android/launcher2/ShortcutIcon;->wo:Landroid/view/animation/Animation;
    ...
    :cond_0
    iput-object p1, p0, Lcom/android/launcher2/ShortcutIcon;->S:Lcom/android/launcher2/Launcher;

    invoke-virtual {p2}, Lcom/android/launcher2/eb;->xH()Z
...
.method public a(Lcom/android/launcher2/dn;)V
    ...
    iget-object v0, p0, Lcom/android/launcher2/ShortcutIcon;->wn:Landroid/widget/ImageView;

    sget-object v1, Lcom/android/launcher2/ShortcutIcon;->wo:Landroid/view/animation/Animation;
...
.method public aJ()Z
    ...
    invoke-virtual {p0}, Lcom/android/launcher2/ShortcutIcon;->xP()Z
...
.method public b(Lcom/android/launcher2/dn;)V
    ...
    sget-object v1, Lcom/android/launcher2/ShortcutIcon;->wp:Landroid/view/animation/Animation;
...
.method public d(Lcom/android/launcher2/dn;)Z
    ...
    invoke-direct {p0, p1}, Lcom/android/launcher2/ShortcutIcon;->k(Lcom/android/launcher2/dn;)Z
...
.method public e(Lcom/android/launcher2/dn;)Z
    ...
    iget-object v0, p0, Lcom/android/launcher2/ShortcutIcon;->S:Lcom/android/launcher2/Launcher;
    ...
    invoke-virtual {v2, v0, v1}, Lcom/android/launcher2/Workspace;->d(Lcom/android/launcher2/eb;Lcom/android/launcher2/eb;)Z
...
.method public getHitRect(Landroid/graphics/Rect;)V
    ...
    invoke-super {p0, p1}, Lcom/android/launcher2/dy;->getHitRect(Landroid/graphics/Rect;)V
    ...
    iget-object v1, p0, Lcom/android/launcher2/ShortcutIcon;->arf:Landroid/widget/FrameLayout;
    ...
    iget-object v3, p0, Lcom/android/launcher2/ShortcutIcon;->arf:Landroid/widget/FrameLayout;
...
.method public getLocationInWindow([I)V
    ...
    :cond_2
    invoke-super {p0, p1}, Lcom/android/launcher2/dy;->getLocationInWindow([I)V
...
.method protected onFinishInflate()V
    ...
    iput-object v0, p0, Lcom/android/launcher2/ShortcutIcon;->wr:Landroid/widget/ImageView$ScaleType;
    ...
    iput-object v0, p0, Lcom/android/launcher2/ShortcutIcon;->wn:Landroid/widget/ImageView;
    ...
    invoke-static {v0}, Lcom/android/launcher2/FolderIcon;->N(Landroid/content/Context;)Landroid/graphics/drawable/Drawable;

    move-result-object v0

    if-eqz v0, :cond_0

    iget-object v1, p0, Lcom/android/launcher2/ShortcutIcon;->wn:Landroid/widget/ImageView;
