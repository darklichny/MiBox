...
# instance fields
.field private Aq:Lcom/android/launcher2/upsidescene/K;
...
.method private a(Lcom/android/launcher2/upsidescene/u;[Landroid/content/ComponentName;)Landroid/view/View;
    ...
    invoke-virtual {p1}, Lcom/android/launcher2/upsidescene/u;->pb()Ljava/lang/String;

    move-result-object v0

    iput-object v0, v3, Lcom/android/launcher2/aY;->title:Ljava/lang/CharSequence;

    iget-object v0, v3, Lcom/android/launcher2/aY;->title:Ljava/lang/CharSequence;
    ...
    iget-object v0, p0, Lcom/android/launcher2/upsidescene/p;->gB:Lcom/android/launcher2/upsidescene/SceneScreen;
    ...
    new-instance v6, Lcom/android/launcher2/eb;

    invoke-direct {v6}, Lcom/android/launcher2/eb;-><init>()V

    new-instance v7, Landroid/content/Intent;

    invoke-direct {v7}, Landroid/content/Intent;-><init>()V

    iput-object v7, v6, Lcom/android/launcher2/eb;->intent:Landroid/content/Intent;

    iget-object v7, v6, Lcom/android/launcher2/eb;->intent:Landroid/content/Intent;

    invoke-virtual {v7, v5}, Landroid/content/Intent;->setComponent(Landroid/content/ComponentName;)Landroid/content/Intent;

    iget-object v5, v6, Lcom/android/launcher2/eb;->intent:Landroid/content/Intent;
    ...
    iput-object v5, v6, Lcom/android/launcher2/eb;->title:Ljava/lang/CharSequence;

    invoke-virtual {v3, v6}, Lcom/android/launcher2/aY;->f(Lcom/android/launcher2/eb;)V
    ...
    iget-object v1, p0, Lcom/android/launcher2/upsidescene/p;->gB:Lcom/android/launcher2/upsidescene/SceneScreen;

    invoke-virtual {v1}, Lcom/android/launcher2/upsidescene/SceneScreen;->tT()Lcom/android/launcher2/Launcher;

    move-result-object v1

    invoke-static {v0, v1, v8, v3}, Lcom/android/launcher2/FolderIcon;->a(ILcom/android/launcher2/Launcher;Landroid/view/ViewGroup;Lcom/android/launcher2/aY;)Lcom/android/launcher2/FolderIcon;
...
.method static synthetic a(Lcom/android/launcher2/upsidescene/p;)Lcom/android/launcher2/upsidescene/K;
    .locals 1

    iget-object v0, p0, Lcom/android/launcher2/upsidescene/p;->Aq:Lcom/android/launcher2/upsidescene/K;
...
.method private d(Lcom/android/launcher2/upsidescene/h;)Landroid/view/View;
    ...
    invoke-virtual {p1}, Lcom/android/launcher2/upsidescene/h;->dk()Lcom/android/launcher2/upsidescene/u;

    move-result-object v1

    invoke-virtual {v1}, Lcom/android/launcher2/upsidescene/u;->oX()[Landroid/content/ComponentName;
    ...
    iput-object v4, v3, Lcom/android/launcher2/eb;->intent:Landroid/content/Intent;

    iget-object v4, v3, Lcom/android/launcher2/eb;->intent:Landroid/content/Intent;
    ...
    iput-object v2, v3, Lcom/android/launcher2/eb;->intent:Landroid/content/Intent;
    ...
    iput-object v2, v3, Lcom/android/launcher2/eb;->title:Ljava/lang/CharSequence;

    iget-object v2, p0, Lcom/android/launcher2/upsidescene/p;->mContext:Landroid/content/Context;

    iget-object v4, p0, Lcom/android/launcher2/upsidescene/p;->gB:Lcom/android/launcher2/upsidescene/SceneScreen;

    invoke-virtual {v4}, Lcom/android/launcher2/upsidescene/SceneScreen;->tT()Lcom/android/launcher2/Launcher;

    move-result-object v4

    invoke-virtual {v4}, Lcom/android/launcher2/Launcher;->mB()Lcom/android/launcher2/dT;

    move-result-object v4

    invoke-static {v2, v4, v0, v3}, Lcom/android/launcher2/upsidescene/SpriteShortcutIcon;->a(Landroid/content/Context;Lcom/android/launcher2/dT;Landroid/view/ViewGroup;Lcom/android/launcher2/eb;)Lcom/android/launcher2/upsidescene/SpriteShortcutIcon;

    move-result-object v0

    invoke-virtual {v1}, Lcom/android/launcher2/upsidescene/u;->pa()Z

    move-result v2

    invoke-virtual {v1}, Lcom/android/launcher2/upsidescene/u;->oZ()Z
...
.method private e(Lcom/android/launcher2/upsidescene/h;)Landroid/view/View;
    ...
    invoke-virtual {p1}, Lcom/android/launcher2/upsidescene/h;->dl()Lcom/android/launcher2/upsidescene/H;
    ...
    :cond_0
    invoke-virtual {p1}, Lcom/android/launcher2/upsidescene/h;->dj()I
    ...
    invoke-virtual {v1}, Lcom/android/launcher2/upsidescene/H;->getId()I
    ...
    invoke-virtual {v0}, Lcom/android/launcher2/upsidescene/SceneScreen;->tU()Landroid/appwidget/AppWidgetHost;
    ...
    :pswitch_1
    invoke-virtual {v1}, Lcom/android/launcher2/upsidescene/H;->sn()I

    move-result v2

    invoke-static {v2}, Lcom/android/launcher2/gadget/aq;->dl(I)Lcom/android/launcher2/gadget/O;

    move-result-object v2

    if-eqz v2, :cond_1

    iget-object v3, p0, Lcom/android/launcher2/upsidescene/p;->gB:Lcom/android/launcher2/upsidescene/SceneScreen;

    invoke-virtual {v3}, Lcom/android/launcher2/upsidescene/SceneScreen;->tT()Lcom/android/launcher2/Launcher;

    move-result-object v3

    const/16 v4, 0x65

    invoke-static {v3, v2, v0, v4}, Lcom/android/launcher2/gadget/aq;->a(Landroid/app/Activity;Lcom/android/launcher2/gadget/O;Landroid/view/ViewGroup;I)Lcom/android/launcher2/gadget/I;

    move-result-object v0

    invoke-interface {v0}, Lcom/android/launcher2/gadget/I;->f()V

    invoke-interface {v0}, Lcom/android/launcher2/gadget/I;->onCreate()V

    invoke-virtual {v1}, Lcom/android/launcher2/upsidescene/H;->getLocation()Ljava/lang/String;
    ...
    invoke-interface {v0, v2}, Lcom/android/launcher2/gadget/I;->a(Landroid/os/Bundle;)V
...
.method private iH()V
    ...
    invoke-virtual {v0}, Lcom/android/launcher2/upsidescene/K;->getType()I
    ...
    iget-object v0, p0, Lcom/android/launcher2/upsidescene/p;->Ar:Landroid/view/View;
...
# virtual methods
.method public a(Lcom/android/launcher2/upsidescene/K;)V
    .locals 0

    iput-object p1, p0, Lcom/android/launcher2/upsidescene/p;->Aq:Lcom/android/launcher2/upsidescene/K;

    invoke-virtual {p0}, Lcom/android/launcher2/upsidescene/p;->iJ()V
...
.method public a(Lcom/android/launcher2/upsidescene/SceneScreen;)V
    ...
    iput-object p1, p0, Lcom/android/launcher2/upsidescene/p;->gB:Lcom/android/launcher2/upsidescene/SceneScreen;
...
.method public bk()V
    ...
    iput-object v0, p0, Lcom/android/launcher2/upsidescene/p;->gB:Lcom/android/launcher2/upsidescene/SceneScreen;
...
.method public c(Landroid/os/Bundle;)V
    ...
    instance-of v0, v0, Lcom/android/launcher2/gadget/I;
    ...
    invoke-interface {v0, p1}, Lcom/android/launcher2/gadget/I;->a(Landroid/os/Bundle;)V
    ...
    invoke-virtual {v0, v1}, Lcom/android/launcher2/upsidescene/h;->ab(Ljava/lang/String;)Z
...
.method public clear()V
    ...
    iput-object v0, p0, Lcom/android/launcher2/upsidescene/p;->Ar:Landroid/view/View;
...
.method public dispatchTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {p0}, Lcom/android/launcher2/upsidescene/p;->iG()Z
...
.method public iD()Lcom/android/launcher2/upsidescene/K;
    .locals 1
...
.method public iE()V
    ...
    invoke-virtual {p0}, Lcom/android/launcher2/upsidescene/p;->iI()V

    invoke-direct {p0}, Lcom/android/launcher2/upsidescene/p;->iH()V
...
.method public iG()Z
    ...
    iget-object v1, p0, Lcom/android/launcher2/upsidescene/p;->Aq:Lcom/android/launcher2/upsidescene/K;

    invoke-virtual {v1}, Lcom/android/launcher2/upsidescene/K;->getType()I
...
.method public iI()V
    ...
    invoke-virtual {v0}, Lcom/android/launcher2/upsidescene/SceneScreen;->uc()Lcom/android/launcher2/upsidescene/p;
...
.method public iJ()V
    ...
    iget-object v2, p0, Lcom/android/launcher2/upsidescene/p;->Aq:Lcom/android/launcher2/upsidescene/K;

    invoke-virtual {v2}, Lcom/android/launcher2/upsidescene/K;->getType()I
    ...
    iput-object v1, p0, Lcom/android/launcher2/upsidescene/p;->Ar:Landroid/view/View;
    ...
    invoke-virtual {v0}, Lcom/android/launcher2/upsidescene/q;->jI()Landroid/graphics/Bitmap;
    ...
    invoke-virtual {v0}, Lcom/android/launcher2/upsidescene/q;->jJ()Landroid/graphics/Bitmap;
