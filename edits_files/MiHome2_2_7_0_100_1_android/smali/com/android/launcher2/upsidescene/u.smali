...
.method public constructor <init>(Lcom/android/launcher2/upsidescene/h;)V
    ...
    iput-object p1, p0, Lcom/android/launcher2/upsidescene/u;->Py:Lcom/android/launcher2/upsidescene/h;
    ...
    iput-object v0, p0, Lcom/android/launcher2/upsidescene/u;->Pv:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lcom/android/launcher2/upsidescene/u;->Pw:Ljava/util/ArrayList;

    const/4 v0, 0x0

    iput-object v0, p0, Lcom/android/launcher2/upsidescene/u;->Px:Ljava/lang/String;
...
.method private b(Ljava/util/Collection;)V
    ...
    iget-object v0, p0, Lcom/android/launcher2/upsidescene/u;->Pw:Ljava/util/ArrayList;
...
.method public a(Ljava/io/BufferedWriter;)V
    ...
    :cond_0
    iget-object v0, p0, Lcom/android/launcher2/upsidescene/u;->Px:Ljava/lang/String;
...
.method public a(Lorg/xmlpull/v1/XmlPullParser;Ljava/io/BufferedReader;Ljava/util/zip/ZipFile;)Z
    ...
    :cond_0
    iget-object v0, p0, Lcom/android/launcher2/upsidescene/u;->Pv:Ljava/util/ArrayList;
...
.method public ca(Ljava/lang/String;)Z
    ...
    iget-object v1, p0, Lcom/android/launcher2/upsidescene/u;->Py:Lcom/android/launcher2/upsidescene/h;
    ...
    iput-object p1, p0, Lcom/android/launcher2/upsidescene/u;->Px:Ljava/lang/String;
...
.method public oX()[Landroid/content/ComponentName;
    .locals 2
    ...
    invoke-virtual {p0}, Lcom/android/launcher2/upsidescene/u;->oY()[Landroid/content/ComponentName;
    ...
    iget-object v1, p0, Lcom/android/launcher2/upsidescene/u;->Pw:Ljava/util/ArrayList;
...
.method public oY()[Landroid/content/ComponentName;
    .locals 2

    iget-object v0, p0, Lcom/android/launcher2/upsidescene/u;->Pv:Ljava/util/ArrayList;

    iget-object v1, p0, Lcom/android/launcher2/upsidescene/u;->Pv:Ljava/util/ArrayList;
...
.method public oZ()Z
    ...
    iget-object v0, p0, Lcom/android/launcher2/upsidescene/u;->Py:Lcom/android/launcher2/upsidescene/h;
