...
.field private static final ajd:[Ljava/lang/String;
...
.field private aiZ:Landroid/widget/ImageView;

.field private aja:Landroid/widget/ImageView;

.field private ajb:Lcom/android/launcher2/gadget/g;

.field private aje:[Landroid/graphics/Matrix;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/launcher2/gadget/FlipPage;->ajc:[Ljava/lang/String;
    ...
    sput-object v0, Lcom/android/launcher2/gadget/FlipPage;->ajd:[Ljava/lang/String;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    sput-object v0, Lcom/android/launcher2/gadget/FlipPage;->ajf:Ljava/util/HashMap;
...
.method private static H(II)[Landroid/graphics/Matrix;
    .locals 7
    ...
    sget-object v0, Lcom/android/launcher2/gadget/FlipPage;->ajf:Ljava/util/HashMap;

    invoke-virtual {v0, v6}, Ljava/util/HashMap;->get(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Lcom/android/launcher2/gadget/ae;

    if-eqz v0, :cond_0

    iget-object v1, v0, Lcom/android/launcher2/gadget/ae;->ZD:[Landroid/graphics/Matrix;
    ...
    new-instance v2, Lcom/android/launcher2/gadget/ae;

    invoke-direct {v2, v1}, Lcom/android/launcher2/gadget/ae;-><init>([Landroid/graphics/Matrix;)V
...
.method static synthetic a(Lcom/android/launcher2/gadget/FlipPage;)I
    ...
    iget v0, p0, Lcom/android/launcher2/gadget/FlipPage;->aiX:I
...
.method static synthetic b(Lcom/android/launcher2/gadget/FlipPage;)[Landroid/graphics/Matrix;
    ...
    iget-object v0, p0, Lcom/android/launcher2/gadget/FlipPage;->aje:[Landroid/graphics/Matrix;
...
.method private cA(I)V
    ...
    invoke-static {v1, v0}, Lcom/android/launcher2/gadget/FlipPage;->H(II)[Landroid/graphics/Matrix;

    move-result-object v0

    iput-object v0, p0, Lcom/android/launcher2/gadget/FlipPage;->aje:[Landroid/graphics/Matrix;

    iget-object v0, p0, Lcom/android/launcher2/gadget/FlipPage;->ajb:Lcom/android/launcher2/gadget/g;
    ...
    invoke-direct {v0, p0, v1}, Lcom/android/launcher2/gadget/g;-><init>(Lcom/android/launcher2/gadget/FlipPage;Lcom/android/launcher2/gadget/u;)V

    iput-object v0, p0, Lcom/android/launcher2/gadget/FlipPage;->ajb:Lcom/android/launcher2/gadget/g;

    iget-object v0, p0, Lcom/android/launcher2/gadget/FlipPage;->ajb:Lcom/android/launcher2/gadget/g;

    const-wide/16 v1, 0xc8

    invoke-virtual {v0, v1, v2}, Lcom/android/launcher2/gadget/g;->setDuration(J)V
    ...
    invoke-virtual {v0, v1, v2}, Lcom/android/launcher2/gadget/g;->setStartOffset(J)V

    iget-object v1, p0, Lcom/android/launcher2/gadget/FlipPage;->ajb:Lcom/android/launcher2/gadget/g;

    iget-boolean v0, p0, Lcom/android/launcher2/gadget/FlipPage;->aiY:Z
    ...
    :goto_0
    invoke-virtual {v1, v0}, Lcom/android/launcher2/gadget/g;->setInterpolator(Landroid/view/animation/Interpolator;)V
...
.method public a(Lmiui/mihome/app/screenelement/g;IIIII)V
    ...
    sget-object v0, Lcom/android/launcher2/gadget/FlipPage;->ajd:[Ljava/lang/String;
    ...
    iput p2, p0, Lcom/android/launcher2/gadget/FlipPage;->aiX:I
    ...
    :goto_0
    iput-boolean v0, p0, Lcom/android/launcher2/gadget/FlipPage;->aiY:Z
    ...
    :cond_1
    iget-object v0, p0, Lcom/android/launcher2/gadget/FlipPage;->aiZ:Landroid/widget/ImageView;

    sget-object v4, Lcom/android/launcher2/gadget/FlipPage;->ajc:[Ljava/lang/String;
    ...
    iget-object v0, p0, Lcom/android/launcher2/gadget/FlipPage;->aja:Landroid/widget/ImageView;
    ...
    invoke-direct {p0, v0}, Lcom/android/launcher2/gadget/FlipPage;->cA(I)V
...
.method protected onFinishInflate()V
    ...
    iput-object v0, p0, Lcom/android/launcher2/gadget/FlipPage;->aiZ:Landroid/widget/ImageView;
    ...
    iput-object v0, p0, Lcom/android/launcher2/gadget/FlipPage;->aja:Landroid/widget/ImageView;
