...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput v0, p0, Lcom/android/launcher2/WidgetThumbnailView;->rp:F

    invoke-direct {p0}, Lcom/android/launcher2/WidgetThumbnailView;->fg()V
    ...
    iput v0, p0, Lcom/android/launcher2/WidgetThumbnailView;->cd:I
    ...
    iput v0, p0, Lcom/android/launcher2/WidgetThumbnailView;->ce:I
...
.method private fg()V
    ...
    invoke-virtual {p0, v0, v1}, Lcom/android/launcher2/WidgetThumbnailView;->L(II)V
...
.method protected a(Landroid/content/Context;IIII)Lcom/android/launcher2/dY;
    ...
    iget v2, p0, Lcom/android/launcher2/WidgetThumbnailView;->aqp:I

    iget v3, p0, Lcom/android/launcher2/WidgetThumbnailView;->aqq:I
...
.method public a(Landroid/view/View;Lcom/android/launcher2/dn;Z)V
    ...
    iget-object v0, p0, Lcom/android/launcher2/WidgetThumbnailView;->ro:Lcom/android/launcher2/a;

    const/4 v1, 0x0

    invoke-virtual {v0, v1}, Lcom/android/launcher2/a;->a(Lcom/android/launcher2/bs;)V
...
.method public e(Lcom/android/launcher2/a;)V
    ...
    iput-object p1, p0, Lcom/android/launcher2/WidgetThumbnailView;->ro:Lcom/android/launcher2/a;
...
.method public onLongClick(Landroid/view/View;)Z
    ...
    invoke-virtual {v1}, Lcom/android/launcher2/dw;->oW()Lcom/android/launcher2/dw;

    move-result-object v4

    sget v5, Lcom/android/launcher2/a;->v:I
    ...
    iget-object v1, p0, Lcom/android/launcher2/WidgetThumbnailView;->ro:Lcom/android/launcher2/a;

    iget-object v0, p0, Lcom/android/launcher2/WidgetThumbnailView;->mContext:Landroid/content/Context;

    check-cast v0, Lcom/android/launcher2/Launcher;

    invoke-virtual {v0}, Lcom/android/launcher2/Launcher;->nA()Lcom/android/launcher2/bs;

    move-result-object v0

    invoke-virtual {v1, v0}, Lcom/android/launcher2/a;->a(Lcom/android/launcher2/bs;)V
...
.method public setCameraDistance(F)V
    ...
    iget v0, p0, Lcom/android/launcher2/WidgetThumbnailView;->rp:F

    cmpl-float v0, p1, v0

    if-eqz v0, :cond_0

    iput p1, p0, Lcom/android/launcher2/WidgetThumbnailView;->rp:F

    iget v0, p0, Lcom/android/launcher2/WidgetThumbnailView;->rp:F

    invoke-super {p0, v0}, Lcom/android/launcher2/dv;->setCameraDistance(F)V
