...
# instance fields
.field kY:Landroid/support/v4/app/B;

.field kZ:Landroid/support/v4/b/b;

.field la:Landroid/support/v4/app/h;

.field final synthetic lb:Landroid/support/v4/app/y;
...
.method a(Landroid/support/v4/b/b;Ljava/lang/Object;)V
    ...
    iget-object v0, p0, Landroid/support/v4/app/h;->kY:Landroid/support/v4/app/B;

    if-eqz v0, :cond_2

    const/4 v0, 0x0

    iget-object v1, p0, Landroid/support/v4/app/h;->lb:Landroid/support/v4/app/y;

    iget-object v1, v1, Landroid/support/v4/app/y;->rZ:Landroid/support/v4/app/s;

    if-eqz v1, :cond_4

    iget-object v0, p0, Landroid/support/v4/app/h;->lb:Landroid/support/v4/app/y;

    iget-object v0, v0, Landroid/support/v4/app/y;->rZ:Landroid/support/v4/app/s;
    ...
    iget-object v1, v1, Landroid/support/v4/app/s;->aaG:Landroid/support/v4/app/w;
    ...
    iget-object v2, p0, Landroid/support/v4/app/h;->lb:Landroid/support/v4/app/y;

    iget-object v2, v2, Landroid/support/v4/app/y;->rZ:Landroid/support/v4/app/s;
    ...
    iget-object v2, v2, Landroid/support/v4/app/s;->aaG:Landroid/support/v4/app/w;
...
.method destroy()V
    ...
    iget-object v1, p0, Landroid/support/v4/app/h;->kY:Landroid/support/v4/app/B;

    if-eqz v1, :cond_2

    iget-object v1, p0, Landroid/support/v4/app/h;->kZ:Landroid/support/v4/b/b;
    ...
    iget-object v3, p0, Landroid/support/v4/app/h;->kZ:Landroid/support/v4/b/b;
    ...
    :cond_2
    iput-object v2, p0, Landroid/support/v4/app/h;->kY:Landroid/support/v4/app/B;
    ...
    iget-object v0, p0, Landroid/support/v4/app/h;->kZ:Landroid/support/v4/b/b;
    ...
    :cond_4
    iget-object v0, p0, Landroid/support/v4/app/h;->la:Landroid/support/v4/app/h;
...
.method retain()V
    ...
    iput-object v0, p0, Landroid/support/v4/app/h;->kY:Landroid/support/v4/app/B;
...
.method start()V
    ...
    iput-object v0, p0, Landroid/support/v4/app/h;->kZ:Landroid/support/v4/b/b;
    ...
    iget-object v2, p0, Landroid/support/v4/app/h;->kZ:Landroid/support/v4/b/b;
