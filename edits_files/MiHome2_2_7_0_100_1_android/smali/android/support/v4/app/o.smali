...
# instance fields
.field final FA:Landroid/support/v4/app/w;

.field FB:Landroid/support/v4/app/A;

.field FC:Landroid/support/v4/app/A;
...
.method public constructor <init>(Landroid/support/v4/app/w;)V
    ...
    iput-object p1, p0, Landroid/support/v4/app/o;->FA:Landroid/support/v4/app/w;
...
.method private a(ILandroid/support/v4/app/Fragment;Ljava/lang/String;I)V
    ...
    iget-object v0, p0, Landroid/support/v4/app/o;->FA:Landroid/support/v4/app/w;

    iput-object v0, p2, Landroid/support/v4/app/Fragment;->rY:Landroid/support/v4/app/w;
    ...
    iput-object p2, v0, Landroid/support/v4/app/A;->apX:Landroid/support/v4/app/Fragment;
...
.method public a(Landroid/support/v4/app/Fragment;)Landroid/support/v4/app/D;
    ...
    iput-object p1, v0, Landroid/support/v4/app/A;->apX:Landroid/support/v4/app/Fragment;
...
.method a(Landroid/support/v4/app/A;)V
    ...
    iget-object v0, p0, Landroid/support/v4/app/o;->FB:Landroid/support/v4/app/A;

    if-nez v0, :cond_0

    iput-object p1, p0, Landroid/support/v4/app/o;->FC:Landroid/support/v4/app/A;

    iput-object p1, p0, Landroid/support/v4/app/o;->FB:Landroid/support/v4/app/A;
    ...
    :cond_0
    iget-object v0, p0, Landroid/support/v4/app/o;->FC:Landroid/support/v4/app/A;

    iput-object v0, p1, Landroid/support/v4/app/A;->apW:Landroid/support/v4/app/A;

    iget-object v0, p0, Landroid/support/v4/app/o;->FC:Landroid/support/v4/app/A;

    iput-object p1, v0, Landroid/support/v4/app/A;->apV:Landroid/support/v4/app/A;
...
.method public aE(I)Landroid/support/v4/app/D;
    .locals 0
...
.method public br(Ljava/lang/String;)Landroid/support/v4/app/D;
    .locals 2
...
.method bumpBackStackNesting(I)V
    ...
    iget-object v0, v2, Landroid/support/v4/app/A;->apX:Landroid/support/v4/app/Fragment;
    ...
    iget-object v3, v2, Landroid/support/v4/app/A;->apX:Landroid/support/v4/app/Fragment;
    ...
    :cond_5
    iget-object v0, v2, Landroid/support/v4/app/A;->apV:Landroid/support/v4/app/A;
...
.method public kG()Landroid/support/v4/app/D;
    .locals 2
...
.method public popFromBackStack(Z)V
    ...
    :pswitch_0
    iget-object v0, v3, Landroid/support/v4/app/A;->apX:Landroid/support/v4/app/Fragment;

    iget v1, v3, Landroid/support/v4/app/A;->popExitAnim:I

    iput v1, v0, Landroid/support/v4/app/Fragment;->mNextAnim:I

    iget-object v1, p0, Landroid/support/v4/app/o;->FA:Landroid/support/v4/app/w;
    ...
    :cond_1
    :goto_1
    iget-object v0, v3, Landroid/support/v4/app/A;->apW:Landroid/support/v4/app/A;
    ...
    iget-object v4, p0, Landroid/support/v4/app/o;->FA:Landroid/support/v4/app/w;
...
.method public run()V
    ...
    :pswitch_0
    iget-object v0, v4, Landroid/support/v4/app/A;->apX:Landroid/support/v4/app/Fragment;
    ...
    :cond_2
    :goto_1
    iget-object v0, v4, Landroid/support/v4/app/A;->apV:Landroid/support/v4/app/A;
    ...
    iput-object v3, v4, Landroid/support/v4/app/A;->apX:Landroid/support/v4/app/Fragment;
    ...
    :cond_8
    iget-object v5, p0, Landroid/support/v4/app/o;->FA:Landroid/support/v4/app/w;
