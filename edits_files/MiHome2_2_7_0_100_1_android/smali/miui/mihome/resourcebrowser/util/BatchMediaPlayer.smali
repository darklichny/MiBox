...
# instance fields
.field private agG:Landroid/media/AudioManager;

.field private agH:Lmiui/mihome/resourcebrowser/util/d;

.field private agI:Ljava/util/ArrayList;

.field private agJ:I

.field private agK:Lmiui/mihome/resourcebrowser/util/BatchMediaPlayer$PlayState;

.field private final agL:Ljava/lang/Runnable;
...
.method public constructor <init>(Landroid/app/Activity;)V
    ...
    iput-object v0, p0, Lmiui/mihome/resourcebrowser/util/BatchMediaPlayer;->agG:Landroid/media/AudioManager;

    iput-object v0, p0, Lmiui/mihome/resourcebrowser/util/BatchMediaPlayer;->agH:Lmiui/mihome/resourcebrowser/util/d;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lmiui/mihome/resourcebrowser/util/BatchMediaPlayer;->agI:Ljava/util/ArrayList;

    const/4 v0, -0x1

    iput v0, p0, Lmiui/mihome/resourcebrowser/util/BatchMediaPlayer;->agJ:I
    ...
    iput-object v0, p0, Lmiui/mihome/resourcebrowser/util/BatchMediaPlayer;->agK:Lmiui/mihome/resourcebrowser/util/BatchMediaPlayer$PlayState;
    ...
    iput-object v0, p0, Lmiui/mihome/resourcebrowser/util/BatchMediaPlayer;->agL:Ljava/lang/Runnable;
...
.method static synthetic a(Lmiui/mihome/resourcebrowser/util/BatchMediaPlayer;)V
    ...
    invoke-direct {p0}, Lmiui/mihome/resourcebrowser/util/BatchMediaPlayer;->tL()V
...
.method static synthetic b(Lmiui/mihome/resourcebrowser/util/BatchMediaPlayer;)Ljava/lang/Runnable;
    ...
    iget-object v0, p0, Lmiui/mihome/resourcebrowser/util/BatchMediaPlayer;->agL:Ljava/lang/Runnable;
...
.method static synthetic e(Lmiui/mihome/resourcebrowser/util/BatchMediaPlayer;)V
    ...
    invoke-direct {p0}, Lmiui/mihome/resourcebrowser/util/BatchMediaPlayer;->tK()V
...
.method private tK()V
    ...
    iget-object v0, p0, Lmiui/mihome/resourcebrowser/util/BatchMediaPlayer;->agG:Landroid/media/AudioManager;
    ...
    iget-object v0, p0, Lmiui/mihome/resourcebrowser/util/BatchMediaPlayer;->agH:Lmiui/mihome/resourcebrowser/util/d;

    if-eqz v0, :cond_1

    iget-object v1, p0, Lmiui/mihome/resourcebrowser/util/BatchMediaPlayer;->agH:Lmiui/mihome/resourcebrowser/util/d;

    iget-object v0, p0, Lmiui/mihome/resourcebrowser/util/BatchMediaPlayer;->agI:Ljava/util/ArrayList;

    iget v2, p0, Lmiui/mihome/resourcebrowser/util/BatchMediaPlayer;->agJ:I
...
.method private tL()V
    ...
    :try_start_0
    iget v0, p0, Lmiui/mihome/resourcebrowser/util/BatchMediaPlayer;->agJ:I

    add-int/lit8 v0, v0, 0x1

    iput v0, p0, Lmiui/mihome/resourcebrowser/util/BatchMediaPlayer;->agJ:I

    iget-object v1, p0, Lmiui/mihome/resourcebrowser/util/BatchMediaPlayer;->agI:Ljava/util/ArrayList;
    ...
    iget v3, p0, Lmiui/mihome/resourcebrowser/util/BatchMediaPlayer;->agJ:I
...
.method public a(Lmiui/mihome/resourcebrowser/util/d;)V
    ...
    iput-object p1, p0, Lmiui/mihome/resourcebrowser/util/BatchMediaPlayer;->agH:Lmiui/mihome/resourcebrowser/util/d;
...
.method public isPaused()Z
    ...
    iget-object v0, p0, Lmiui/mihome/resourcebrowser/util/BatchMediaPlayer;->agK:Lmiui/mihome/resourcebrowser/util/BatchMediaPlayer$PlayState;
...
.method public stop(Z)V
    ...
    invoke-interface {v0, p1}, Lmiui/mihome/resourcebrowser/util/d;->B(Z)V
