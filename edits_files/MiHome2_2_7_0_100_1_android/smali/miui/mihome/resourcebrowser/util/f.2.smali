...
.field private tB:Ljava/lang/Long;

.field private tC:Z

.field private tu:Lmiui/mihome/resourcebrowser/util/n;
...
.method public constructor <init>(Landroid/content/Context;Lmiui/mihome/resourcebrowser/ResourceContext;)V
    ...
    iput-boolean v0, p0, Lmiui/mihome/resourcebrowser/util/f;->tx:Z

    iput-object p1, p0, Lmiui/mihome/resourcebrowser/util/f;->mContext:Landroid/content/Context;

    iput-object p2, p0, Lmiui/mihome/resourcebrowser/util/f;->kd:Lmiui/mihome/resourcebrowser/ResourceContext;
    ...
    iput-object v0, p0, Lmiui/mihome/resourcebrowser/util/f;->tv:Lmiui/mihome/resourcebrowser/controller/local/i;
    ...
    iput-object v0, p0, Lmiui/mihome/resourcebrowser/util/f;->tw:Lmiui/mihome/resourcebrowser/controller/local/d;

    invoke-static {p1}, Lcom/miui/home/a/l;->aY(Landroid/content/Context;)Lcom/miui/home/a/l;

    move-result-object v0

    iput-object v0, p0, Lmiui/mihome/resourcebrowser/util/f;->ty:Lcom/miui/home/a/l;

    new-instance v0, Lmiui/mihome/resourcebrowser/util/o;

    iget-object v1, p0, Lmiui/mihome/resourcebrowser/util/f;->ty:Lcom/miui/home/a/l;

    invoke-direct {v0, p0, v1}, Lmiui/mihome/resourcebrowser/util/o;-><init>(Lmiui/mihome/resourcebrowser/util/f;Lcom/miui/home/a/l;)V

    iput-object v0, p0, Lmiui/mihome/resourcebrowser/util/f;->tz:Lcom/miui/home/resourcebrowser/a/d;
...
.method private static aO(Ljava/lang/String;)Ljava/net/URI;
    .locals 9
...
.method public H(Z)V
    ...
    iget-boolean v0, p0, Lmiui/mihome/resourcebrowser/util/f;->tx:Z

    if-nez v0, :cond_0

    iget-object v0, p0, Lmiui/mihome/resourcebrowser/util/f;->tz:Lcom/miui/home/resourcebrowser/a/d;
...
.method public a(Lcom/miui/home/a/l;Lmiui/mihome/resourcebrowser/model/Resource;)J
    ...
    iget-object v1, p0, Lmiui/mihome/resourcebrowser/util/f;->kd:Lmiui/mihome/resourcebrowser/ResourceContext;
    ...
    iget-object v0, p0, Lmiui/mihome/resourcebrowser/util/f;->kd:Lmiui/mihome/resourcebrowser/ResourceContext;
    ...
    invoke-static {v2}, Lmiui/mihome/resourcebrowser/util/f;->aO(Ljava/lang/String;)Ljava/net/URI;
    ...
    iget-object v0, p0, Lmiui/mihome/resourcebrowser/util/f;->tv:Lmiui/mihome/resourcebrowser/controller/local/i;
    ...
    iget-object v0, p0, Lmiui/mihome/resourcebrowser/util/f;->tw:Lmiui/mihome/resourcebrowser/controller/local/d;
...
.method public a(Lmiui/mihome/resourcebrowser/util/n;)V
    ...
    iput-object p1, p0, Lmiui/mihome/resourcebrowser/util/f;->tu:Lmiui/mihome/resourcebrowser/util/n;
...
.method public a(Lmiui/mihome/resourcebrowser/model/Resource;Z)Z
    ...
    iget-object v0, p0, Lmiui/mihome/resourcebrowser/util/f;->ty:Lcom/miui/home/a/l;
...
.method public aN(Ljava/lang/String;)Z
    ...
    :cond_0
    iget-object v0, p0, Lmiui/mihome/resourcebrowser/util/f;->tA:Ljava/lang/String;
    ...
    iget-object v2, p0, Lmiui/mihome/resourcebrowser/util/f;->tB:Ljava/lang/Long;
    ...
    iget-boolean v0, p0, Lmiui/mihome/resourcebrowser/util/f;->tC:Z
    ...
    iput-boolean v0, p0, Lmiui/mihome/resourcebrowser/util/f;->tC:Z

    iput-object p1, p0, Lmiui/mihome/resourcebrowser/util/f;->tA:Ljava/lang/String;
    ...
    iput-object v1, p0, Lmiui/mihome/resourcebrowser/util/f;->tB:Ljava/lang/Long;
...
.method public bQ()V
    ...
    invoke-virtual {p0, v0}, Lmiui/mihome/resourcebrowser/util/f;->H(Z)V
...
.method public v(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v0, p0, Lmiui/mihome/resourcebrowser/util/f;->tu:Lmiui/mihome/resourcebrowser/util/n;

    if-eqz v0, :cond_0

    iget-object v0, p0, Lmiui/mihome/resourcebrowser/util/f;->tu:Lmiui/mihome/resourcebrowser/util/n;

    invoke-interface {v0, p1, p2}, Lmiui/mihome/resourcebrowser/util/n;->l(Ljava/lang/String;Ljava/lang/String;)V
