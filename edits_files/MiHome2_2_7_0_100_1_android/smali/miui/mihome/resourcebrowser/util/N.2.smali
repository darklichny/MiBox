...
# instance fields
.field final synthetic Zo:Lmiui/mihome/resourcebrowser/util/G;

.field private amr:Ljava/util/List;

.field private ams:Landroid/view/View;

.field private amt:Landroid/util/Pair;

.field private amu:Landroid/util/Pair;
...
.method public constructor <init>(Lmiui/mihome/resourcebrowser/util/G;)V
    ...
    iput-object p1, p0, Lmiui/mihome/resourcebrowser/util/N;->Zo:Lmiui/mihome/resourcebrowser/util/G;
    ...
    iput-object v0, p0, Lmiui/mihome/resourcebrowser/util/N;->amr:Ljava/util/List;

    const/4 v0, 0x0

    iput-object v0, p0, Lmiui/mihome/resourcebrowser/util/N;->ams:Landroid/view/View;
...
.method private O(Landroid/view/View;)V
    ...
    iget-object v0, p0, Lmiui/mihome/resourcebrowser/util/N;->amr:Ljava/util/List;
    ...
    iget-object v2, p0, Lmiui/mihome/resourcebrowser/util/N;->Zo:Lmiui/mihome/resourcebrowser/util/G;

    iget-object v3, p0, Lmiui/mihome/resourcebrowser/util/N;->amu:Landroid/util/Pair;
...
.method private R(Landroid/view/View;)V
    ...
    iget-object v1, p0, Lmiui/mihome/resourcebrowser/util/N;->Zo:Lmiui/mihome/resourcebrowser/util/G;
    ...
    iget-object v2, p0, Lmiui/mihome/resourcebrowser/util/N;->amu:Landroid/util/Pair;
...
.method private a(Landroid/view/View;Lmiui/mihome/resourcebrowser/model/Resource;)V
    ...
    iget-object v1, v1, Lmiui/mihome/resourcebrowser/util/G;->agN:Lmiui/mihome/resourcebrowser/util/N;
...
.method static synthetic a(Lmiui/mihome/resourcebrowser/util/N;Landroid/view/View;)V
    ...
    invoke-direct {p0, p1}, Lmiui/mihome/resourcebrowser/util/N;->R(Landroid/view/View;)V
...
.method private b(Landroid/view/View;Lmiui/mihome/resourcebrowser/model/Resource;ZZ)V
    ...
    invoke-virtual {v1}, Lmiui/mihome/resourcebrowser/util/G;->sx()Z
    ...
    iget-object v1, v1, Lmiui/mihome/resourcebrowser/util/G;->kd:Lmiui/mihome/resourcebrowser/ResourceContext;
    ...
    iget-object v0, p0, Lmiui/mihome/resourcebrowser/util/N;->Zo:Lmiui/mihome/resourcebrowser/util/G;

    iget-object v0, v0, Lmiui/mihome/resourcebrowser/util/G;->agM:Lmiui/mihome/resourcebrowser/util/c;
    ...
    iget-object v3, p0, Lmiui/mihome/resourcebrowser/util/N;->Zo:Lmiui/mihome/resourcebrowser/util/G;

    iget-object v3, v3, Lmiui/mihome/resourcebrowser/util/G;->kd:Lmiui/mihome/resourcebrowser/ResourceContext;
...
.method public P(Landroid/view/View;)V
    ...
    :cond_0
    iget-object v0, p0, Lmiui/mihome/resourcebrowser/util/N;->ams:Landroid/view/View;
    ...
    iput-object p1, p0, Lmiui/mihome/resourcebrowser/util/N;->ams:Landroid/view/View;
...
.method public Q(Landroid/view/View;)V
    ...
    invoke-direct {p0, p1}, Lmiui/mihome/resourcebrowser/util/N;->O(Landroid/view/View;)V
    ...
    iget-object v1, p0, Lmiui/mihome/resourcebrowser/util/N;->amu:Landroid/util/Pair;

    iput-object v1, p0, Lmiui/mihome/resourcebrowser/util/N;->amt:Landroid/util/Pair;

    iput-object v0, p0, Lmiui/mihome/resourcebrowser/util/N;->amu:Landroid/util/Pair;
    ...
    iget-object v1, p0, Lmiui/mihome/resourcebrowser/util/N;->amr:Ljava/util/List;

    invoke-interface {v1, p1}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    iget-object v1, p0, Lmiui/mihome/resourcebrowser/util/N;->amu:Landroid/util/Pair;

    iget-object v2, p0, Lmiui/mihome/resourcebrowser/util/N;->amt:Landroid/util/Pair;
    ...
    invoke-direct {p0, v0}, Lmiui/mihome/resourcebrowser/util/N;->R(Landroid/view/View;)V
...
.method public reset()V
    ...
    invoke-direct {p0, v0}, Lmiui/mihome/resourcebrowser/util/N;->O(Landroid/view/View;)V
...
.method public vN()Lmiui/mihome/resourcebrowser/util/M;
    .locals 1
