...
# instance fields
.field protected Wj:Lmiui/mihome/resourcebrowser/util/h;

.field protected Wk:I

.field protected Wl:I

.field private Wm:Ljava/util/HashSet;

.field private Wn:Ljava/util/concurrent/ExecutorService;

.field private Wo:Ljava/util/concurrent/ExecutorService;

.field private Wp:Ljava/util/HashMap;

.field private Wq:Lmiui/mihome/resourcebrowser/util/j;
...
.method public constructor <init>(I)V
    ...
    iput-object v0, p0, Lmiui/mihome/resourcebrowser/util/w;->Wm:Ljava/util/HashSet;
    ...
    iput-object v0, p0, Lmiui/mihome/resourcebrowser/util/w;->Wn:Ljava/util/concurrent/ExecutorService;
    ...
    iput-object v0, p0, Lmiui/mihome/resourcebrowser/util/w;->Wo:Ljava/util/concurrent/ExecutorService;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lmiui/mihome/resourcebrowser/util/w;->Wp:Ljava/util/HashMap;

    const/4 v0, 0x0

    iput-object v0, p0, Lmiui/mihome/resourcebrowser/util/w;->Wq:Lmiui/mihome/resourcebrowser/util/j;
    ...
    iput-object v0, p0, Lmiui/mihome/resourcebrowser/util/w;->Wj:Lmiui/mihome/resourcebrowser/util/h;
...
.method static synthetic a(Lmiui/mihome/resourcebrowser/util/w;)Lmiui/mihome/resourcebrowser/util/j;
    ...
    iget-object v0, p0, Lmiui/mihome/resourcebrowser/util/w;->Wq:Lmiui/mihome/resourcebrowser/util/j;
...
.method static synthetic b(Lmiui/mihome/resourcebrowser/util/w;)Ljava/util/concurrent/ExecutorService;
    ...
    iget-object v0, p0, Lmiui/mihome/resourcebrowser/util/w;->Wo:Ljava/util/concurrent/ExecutorService;
...
.method static synthetic c(Lmiui/mihome/resourcebrowser/util/w;)Ljava/util/concurrent/ExecutorService;
    ...
    iget-object v0, p0, Lmiui/mihome/resourcebrowser/util/w;->Wn:Ljava/util/concurrent/ExecutorService;
...
.method static synthetic d(Lmiui/mihome/resourcebrowser/util/w;)Ljava/util/HashMap;
    ...
    iget-object v0, p0, Lmiui/mihome/resourcebrowser/util/w;->Wp:Ljava/util/HashMap;
...
.method static synthetic e(Lmiui/mihome/resourcebrowser/util/w;)Ljava/util/HashSet;
    ...
    iget-object v0, p0, Lmiui/mihome/resourcebrowser/util/w;->Wm:Ljava/util/HashSet;
...
.method public D(II)V
    ...
    iput p1, p0, Lmiui/mihome/resourcebrowser/util/w;->Wk:I

    iput p2, p0, Lmiui/mihome/resourcebrowser/util/w;->Wl:I
...
.method public a(Ljava/lang/String;IZ)Landroid/graphics/Bitmap;
    ...
    iget v1, p0, Lmiui/mihome/resourcebrowser/util/w;->Wk:I

    iget v2, p0, Lmiui/mihome/resourcebrowser/util/w;->Wl:I

    iget-object v3, p0, Lmiui/mihome/resourcebrowser/util/w;->Wj:Lmiui/mihome/resourcebrowser/util/h;

    const/4 v4, 0x1

    invoke-virtual {v3, v4}, Lmiui/mihome/resourcebrowser/util/h;->P(Z)Landroid/graphics/Bitmap;
    ...
    iget-object v1, p0, Lmiui/mihome/resourcebrowser/util/w;->Wj:Lmiui/mihome/resourcebrowser/util/h;
...
.method public a(Lmiui/mihome/resourcebrowser/util/j;)V
    ...
    iput-object p1, p0, Lmiui/mihome/resourcebrowser/util/w;->Wq:Lmiui/mihome/resourcebrowser/util/j;
...
.method public at(Z)V
    ...
    iget-object v0, p0, Lmiui/mihome/resourcebrowser/util/w;->Wj:Lmiui/mihome/resourcebrowser/util/h;
...
.method public b(Ljava/lang/String;Ljava/lang/String;I)V
    ...
    invoke-virtual {v0}, Lmiui/mihome/resourcebrowser/util/F;->tu()V
...
.method public bL(I)V
    ...
    invoke-virtual {v0, p1}, Lmiui/mihome/resourcebrowser/util/h;->al(I)V
...
.method public qY()I
    ...
    invoke-virtual {v0}, Lmiui/mihome/resourcebrowser/util/h;->in()I
