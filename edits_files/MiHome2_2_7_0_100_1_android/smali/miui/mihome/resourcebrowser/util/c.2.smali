...
# instance fields
.field private kD:Lmiui/mihome/resourcebrowser/model/Resource;

.field private kE:Lmiui/mihome/resourcebrowser/util/BatchMediaPlayer;
...
.field private kI:Lmiui/mihome/resourcebrowser/util/M;
...
.method public constructor <init>(Landroid/app/Activity;Z)V
    ...
    iput-boolean p2, p0, Lmiui/mihome/resourcebrowser/util/c;->kF:Z
...
.method static synthetic a(Lmiui/mihome/resourcebrowser/util/c;Lmiui/mihome/resourcebrowser/model/Resource;)Lmiui/mihome/resourcebrowser/model/Resource;
    ...
    iput-object p1, p0, Lmiui/mihome/resourcebrowser/util/c;->kD:Lmiui/mihome/resourcebrowser/model/Resource;
...
.method static synthetic a(Lmiui/mihome/resourcebrowser/util/c;)Lmiui/mihome/resourcebrowser/util/BatchMediaPlayer;
    ...
    iget-object v0, p0, Lmiui/mihome/resourcebrowser/util/c;->kE:Lmiui/mihome/resourcebrowser/util/BatchMediaPlayer;
...
.method static synthetic a(Lmiui/mihome/resourcebrowser/util/c;Z)Z
    ...
    iput-boolean p1, p0, Lmiui/mihome/resourcebrowser/util/c;->kH:Z
...
.method static synthetic b(Lmiui/mihome/resourcebrowser/util/c;)Lmiui/mihome/resourcebrowser/util/M;
    ...
    iget-object v0, p0, Lmiui/mihome/resourcebrowser/util/c;->kI:Lmiui/mihome/resourcebrowser/util/M;
...
.method private dg()V
    ...
    iput-object v0, p0, Lmiui/mihome/resourcebrowser/util/c;->kE:Lmiui/mihome/resourcebrowser/util/BatchMediaPlayer;
...
.method public a(Lmiui/mihome/resourcebrowser/util/M;)V
    ...
    iput-object p1, p0, Lmiui/mihome/resourcebrowser/util/c;->kI:Lmiui/mihome/resourcebrowser/util/M;
...
.method public de()V
    ...
    iput-object v0, p0, Lmiui/mihome/resourcebrowser/util/c;->kD:Lmiui/mihome/resourcebrowser/model/Resource;

    const/4 v0, 0x0

    iput-boolean v0, p0, Lmiui/mihome/resourcebrowser/util/c;->kH:Z
...
.method public isPlaying()Z
    ...
    iget-boolean v0, p0, Lmiui/mihome/resourcebrowser/util/c;->kH:Z
...
.method public n(Lmiui/mihome/resourcebrowser/model/Resource;)Z
    ...
    iget-object v0, p0, Lmiui/mihome/resourcebrowser/util/c;->kD:Lmiui/mihome/resourcebrowser/model/Resource;
...
.method public o(Lmiui/mihome/resourcebrowser/model/Resource;)V
    .locals 2
    ...
    invoke-direct {p0}, Lmiui/mihome/resourcebrowser/util/c;->dg()V

    :cond_0
    iget-object v0, p0, Lmiui/mihome/resourcebrowser/util/c;->kE:Lmiui/mihome/resourcebrowser/util/BatchMediaPlayer;

    invoke-virtual {p0, p1}, Lmiui/mihome/resourcebrowser/util/c;->p(Lmiui/mihome/resourcebrowser/model/Resource;)Ljava/util/List;
...
.method protected p(Lmiui/mihome/resourcebrowser/model/Resource;)Ljava/util/List;
    .locals 1
