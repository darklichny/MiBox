...
# instance fields
.field private akf:Ljava/util/Map;
...
.method public constructor <init>(Lmiui/mihome/resourcebrowser/util/ResourceImportHandler;Lmiui/mihome/resourcebrowser/controller/f;)V
    ...
    iput-object p1, p0, Lmiui/mihome/resourcebrowser/util/H;->cr:Lmiui/mihome/resourcebrowser/util/ResourceImportHandler;
    ...
    iput-object v0, p0, Lmiui/mihome/resourcebrowser/util/H;->akf:Ljava/util/Map;
...
.method public a(Lmiui/mihome/resourcebrowser/util/ResourceImportHandler$ResourceForImport;)V
    ...
    iget-object v0, p0, Lmiui/mihome/resourcebrowser/util/H;->akf:Ljava/util/Map;
...
.method protected b(Lmiui/mihome/resourcebrowser/util/ResourceImportHandler$ResourceForImport;)V
    ...
    iget-object v0, p0, Lmiui/mihome/resourcebrowser/util/H;->fV:Ljava/util/List;
...
.method protected fM()V
    ...
    iget-object v0, p0, Lmiui/mihome/resourcebrowser/util/H;->cr:Lmiui/mihome/resourcebrowser/util/ResourceImportHandler;
    ...
    new-instance v8, Lmiui/mihome/resourcebrowser/controller/local/j;

    invoke-direct {v8}, Lmiui/mihome/resourcebrowser/controller/local/j;-><init>()V

    new-instance v0, Ljava/io/File;

    iget-object v2, p0, Lmiui/mihome/resourcebrowser/util/H;->cr:Lmiui/mihome/resourcebrowser/util/ResourceImportHandler;
    ...
    iget-object v11, p0, Lmiui/mihome/resourcebrowser/util/H;->cr:Lmiui/mihome/resourcebrowser/util/ResourceImportHandler;
    ...
    iget-object v12, p0, Lmiui/mihome/resourcebrowser/util/H;->akf:Ljava/util/Map;
    ...
    :cond_6
    iget-object v12, p0, Lmiui/mihome/resourcebrowser/util/H;->cr:Lmiui/mihome/resourcebrowser/util/ResourceImportHandler;

    iget-object v12, v12, Lmiui/mihome/resourcebrowser/util/ResourceImportHandler;->ik:Lmiui/mihome/resourcebrowser/util/f;

    invoke-virtual {v12, v11}, Lmiui/mihome/resourcebrowser/util/f;->aN(Ljava/lang/String;)Z
    ...
    :cond_8
    iget-object v3, p0, Lmiui/mihome/resourcebrowser/util/H;->fV:Ljava/util/List;
    ...
    iget-object v4, p0, Lmiui/mihome/resourcebrowser/util/H;->akf:Ljava/util/Map;
...
.method protected fP()V
    ...
    :goto_0
    iget-object v5, p0, Lmiui/mihome/resourcebrowser/util/H;->fV:Ljava/util/List;
    ...
    iget-object v1, p0, Lmiui/mihome/resourcebrowser/util/H;->akf:Ljava/util/Map;
    ...
    :cond_1
    iget-object v4, p0, Lmiui/mihome/resourcebrowser/util/H;->cr:Lmiui/mihome/resourcebrowser/util/ResourceImportHandler;
    ...
    :try_start_2
    iget-object v6, p0, Lmiui/mihome/resourcebrowser/util/H;->fV:Ljava/util/List;

    invoke-interface {v6, v1}, Ljava/util/List;->remove(Ljava/lang/Object;)Z

    iget-object v6, p0, Lmiui/mihome/resourcebrowser/util/H;->akf:Ljava/util/Map;
    ...
    :cond_3
    iget-object v3, p0, Lmiui/mihome/resourcebrowser/util/H;->cr:Lmiui/mihome/resourcebrowser/util/ResourceImportHandler;
...
.method protected kM()V
    ...
    invoke-super {p0}, Lmiui/mihome/resourcebrowser/util/A;->kM()V
...
.method public q(Lmiui/mihome/resourcebrowser/model/Resource;)Z
    ...
    iget-object v1, p0, Lmiui/mihome/resourcebrowser/util/H;->fV:Ljava/util/List;
