...
# static fields
.field private static final Ux:[Ljava/lang/String;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lmiui/mihome/resourcebrowser/controller/local/h;->Ux:[Ljava/lang/String;
...
.method private bD(I)Landroid/net/Uri;
    .locals 1
...
.method private cx(Ljava/lang/String;)Ljava/lang/String;
    ...
    sget-object v3, Lmiui/mihome/resourcebrowser/controller/local/h;->Ux:[Ljava/lang/String;
...
.method private qA()Lmiui/mihome/resourcebrowser/model/Resource;
    .locals 7
    ...
    iget-object v0, p0, Lmiui/mihome/resourcebrowser/controller/local/h;->aj:Lmiui/mihome/resourcebrowser/ResourceContext;
    ...
    iget-object v1, p0, Lmiui/mihome/resourcebrowser/controller/local/h;->aj:Lmiui/mihome/resourcebrowser/ResourceContext;
    ...
    invoke-direct {p0, v1}, Lmiui/mihome/resourcebrowser/controller/local/h;->bD(I)Landroid/net/Uri;
    ...
    invoke-direct {p0, v0}, Lmiui/mihome/resourcebrowser/controller/local/h;->cx(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v0

    const-string v4, ""

    invoke-direct {p0, v1}, Lmiui/mihome/resourcebrowser/controller/local/h;->bE(I)I
...
.method protected bc()V
    ...
    invoke-super {p0}, Lmiui/mihome/resourcebrowser/controller/local/c;->bc()V
    ...
    iget-object v0, p0, Lmiui/mihome/resourcebrowser/controller/local/h;->fV:Ljava/util/List;

    const/4 v1, 0x0

    invoke-direct {p0}, Lmiui/mihome/resourcebrowser/controller/local/h;->qA()Lmiui/mihome/resourcebrowser/model/Resource;
