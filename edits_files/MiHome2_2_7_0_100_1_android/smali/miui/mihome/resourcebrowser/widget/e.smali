...
# static fields
.field private static Ty:Lmiui/mihome/cache/DataCache;
...
.field private Pc:Ljava/util/Set;
...
.field private Tz:Lmiui/mihome/resourcebrowser/widget/f;
...
.method static constructor <clinit>()V
    ...
    invoke-static {}, Lmiui/mihome/resourcebrowser/widget/e;->qp()I

    move-result v1

    invoke-direct {v0, v1}, Lmiui/mihome/resourcebrowser/widget/AsyncAdapter$1;-><init>(I)V

    sput-object v0, Lmiui/mihome/resourcebrowser/widget/e;->Ty:Lmiui/mihome/cache/DataCache;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lmiui/mihome/resourcebrowser/widget/e;->OD:Ljava/util/List;

    new-instance v0, Ljava/util/HashSet;

    invoke-direct {v0}, Ljava/util/HashSet;-><init>()V

    iput-object v0, p0, Lmiui/mihome/resourcebrowser/widget/e;->Pc:Ljava/util/Set;

    iput-boolean v1, p0, Lmiui/mihome/resourcebrowser/widget/e;->Tu:Z

    iput v1, p0, Lmiui/mihome/resourcebrowser/widget/e;->TA:I
...
.method private a(ILmiui/mihome/resourcebrowser/widget/b;)V
    ...
    invoke-virtual {p2, p1}, Lmiui/mihome/resourcebrowser/widget/b;->aj(I)V
...
.method private a(ZILmiui/mihome/resourcebrowser/widget/a;)V
    ...
    iput-boolean p1, v0, Lmiui/mihome/resourcebrowser/widget/c;->Lx:Z

    if-nez p1, :cond_1

    invoke-virtual {p0, p2}, Lmiui/mihome/resourcebrowser/widget/e;->by(I)I
    ...
    invoke-virtual {p3, p2}, Lmiui/mihome/resourcebrowser/widget/a;->aj(I)V
...
.method static synthetic a(Lmiui/mihome/resourcebrowser/widget/e;)Z
    ...
    iget-boolean v0, p0, Lmiui/mihome/resourcebrowser/widget/e;->Tu:Z
...
.method static synthetic b(Lmiui/mihome/resourcebrowser/widget/e;)Ljava/util/Set;
    ...
    iget-object v0, p0, Lmiui/mihome/resourcebrowser/widget/e;->Pc:Ljava/util/Set;

    return-object v0
.end method

.method private static qp()I
    .locals 2
...
.method static synthetic qu()Lmiui/mihome/cache/DataCache;
    .locals 1

    sget-object v0, Lmiui/mihome/resourcebrowser/widget/e;->Ty:Lmiui/mihome/cache/DataCache;
...
.method protected a(Landroid/view/View;Ljava/lang/Object;I)V
    ...
    iget-object v1, p0, Lmiui/mihome/resourcebrowser/widget/e;->Tz:Lmiui/mihome/resourcebrowser/widget/f;
    ...
    :cond_0
    invoke-virtual {p0}, Lmiui/mihome/resourcebrowser/widget/e;->hC()Lmiui/mihome/resourcebrowser/widget/f;

    move-result-object v1

    iput-object v1, p0, Lmiui/mihome/resourcebrowser/widget/e;->Tz:Lmiui/mihome/resourcebrowser/widget/f;
    ...
    sget-object v4, Lmiui/mihome/resourcebrowser/widget/e;->Ty:Lmiui/mihome/cache/DataCache;
    ...
    :cond_4
    iget-object v4, p0, Lmiui/mihome/resourcebrowser/widget/e;->Tz:Lmiui/mihome/resourcebrowser/widget/f;
...
.method public bA(I)V
    ...
    iput p1, p0, Lmiui/mihome/resourcebrowser/widget/e;->Tt:I
...
.method public bC(I)V
    ...
    :goto_0
    iput-boolean v0, p0, Lmiui/mihome/resourcebrowser/widget/e;->Tv:Z
    ...
    :goto_1
    iput-boolean v1, p0, Lmiui/mihome/resourcebrowser/widget/e;->Tw:Z
...
.method public bu(I)Ljava/util/List;
    .locals 3

    invoke-virtual {p0, p1}, Lmiui/mihome/resourcebrowser/widget/e;->bx(I)Landroid/util/Pair;
    ...
    invoke-virtual {p0, v2, v0}, Lmiui/mihome/resourcebrowser/widget/e;->w(II)Ljava/util/List;
...
.method protected bv(I)I
    .locals 2

    invoke-virtual {p0, p1}, Lmiui/mihome/resourcebrowser/widget/e;->by(I)I
    ...
    iget v1, p0, Lmiui/mihome/resourcebrowser/widget/e;->TA:I
...
.method protected bw(I)Lmiui/mihome/resourcebrowser/widget/DataGroup;
    .locals 3

    iget-object v0, p0, Lmiui/mihome/resourcebrowser/widget/e;->OD:Ljava/util/List;
    ...
    iget-object v1, p0, Lmiui/mihome/resourcebrowser/widget/e;->OD:Ljava/util/List;
...
.method public bx(I)Landroid/util/Pair;
    .locals 4
    ...
    :goto_0
    iget-object v2, p0, Lmiui/mihome/resourcebrowser/widget/e;->OD:Ljava/util/List;
    ...
    invoke-virtual {p0, v0}, Lmiui/mihome/resourcebrowser/widget/e;->bv(I)I
...
.method public by(I)I
    ...
    invoke-virtual {p0, p1}, Lmiui/mihome/resourcebrowser/widget/e;->bw(I)Lmiui/mihome/resourcebrowser/widget/DataGroup;
...
.method public bz(I)V
    ...
    iput p1, p0, Lmiui/mihome/resourcebrowser/widget/e;->TA:I
...
.method public clean()V
    ...
    iget-object v0, p0, Lmiui/mihome/resourcebrowser/widget/e;->Tz:Lmiui/mihome/resourcebrowser/widget/f;
...
.method public bridge synthetic getItem(I)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Lmiui/mihome/resourcebrowser/widget/e;->bu(I)Ljava/util/List;
...
.method public getView(ILandroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    :cond_2
    iget-boolean v1, p0, Lmiui/mihome/resourcebrowser/widget/e;->Tx:Z

    if-nez v1, :cond_3

    iget v1, p0, Lmiui/mihome/resourcebrowser/widget/e;->Tt:I

    if-ne p1, v1, :cond_3

    iget-boolean v1, p0, Lmiui/mihome/resourcebrowser/widget/e;->Tv:Z

    if-eqz v1, :cond_3

    const/4 v1, 0x1

    invoke-virtual {p0, v1}, Lmiui/mihome/resourcebrowser/widget/e;->aq(Z)V

    goto :goto_0

    :cond_3
    iget-boolean v1, p0, Lmiui/mihome/resourcebrowser/widget/e;->OJ:Z
    ...
    iget v2, p0, Lmiui/mihome/resourcebrowser/widget/e;->Tt:I

    sub-int/2addr v1, v2

    if-ne p1, v1, :cond_0

    iget-boolean v1, p0, Lmiui/mihome/resourcebrowser/widget/e;->Tw:Z
...
.method public qq()I
    ...
    iget v0, p0, Lmiui/mihome/resourcebrowser/widget/e;->TA:I
...
.method protected w(II)Ljava/util/List;
    .locals 5
    ...
    invoke-virtual {p0, v4, p2}, Lmiui/mihome/resourcebrowser/widget/e;->x(II)Ljava/lang/Object;
...
.method public x(II)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p2}, Lmiui/mihome/resourcebrowser/widget/e;->bw(I)Lmiui/mihome/resourcebrowser/widget/DataGroup;
