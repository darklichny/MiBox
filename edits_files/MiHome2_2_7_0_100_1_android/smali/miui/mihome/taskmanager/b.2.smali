...
.field private oJ:Lmiui/mihome/taskmanager/y;

.field private oK:Landroid/os/AsyncTask;

.field private oL:I

.field private oM:Landroid/graphics/Bitmap;

.field private oN:Ljava/util/Set;
...
.method public constructor <init>(Landroid/content/Context;Z)V
    ...
    iput-object v0, p0, Lmiui/mihome/taskmanager/b;->oP:Ljava/util/List;

    new-instance v0, Ljava/util/HashSet;

    invoke-direct {v0}, Ljava/util/HashSet;-><init>()V

    iput-object v0, p0, Lmiui/mihome/taskmanager/b;->oR:Ljava/util/HashSet;

    iput-object p1, p0, Lmiui/mihome/taskmanager/b;->mContext:Landroid/content/Context;

    iput-boolean p2, p0, Lmiui/mihome/taskmanager/b;->oO:Z
    ...
    iput v5, p0, Lmiui/mihome/taskmanager/b;->oL:I

    :cond_0
    :goto_0
    iput v3, p0, Lmiui/mihome/taskmanager/b;->oL:I
    ...
    iget-boolean v3, p0, Lmiui/mihome/taskmanager/b;->oO:Z
    ...
    iput-object v0, p0, Lmiui/mihome/taskmanager/b;->oM:Landroid/graphics/Bitmap;

    new-instance v0, Landroid/graphics/Canvas;

    iget-object v1, p0, Lmiui/mihome/taskmanager/b;->oM:Landroid/graphics/Bitmap;
    ...
    iput v4, p0, Lmiui/mihome/taskmanager/b;->oL:I
...
.method private a(Ljava/util/Set;)V
    ...
    iget-object v0, p0, Lmiui/mihome/taskmanager/b;->oR:Ljava/util/HashSet;

    invoke-virtual {v0}, Ljava/util/HashSet;->clear()V

    new-instance v2, Ljava/util/HashSet;

    iget-object v0, p0, Lmiui/mihome/taskmanager/b;->oP:Ljava/util/List;
    ...
    iget-object v1, p0, Lmiui/mihome/taskmanager/b;->oR:Ljava/util/HashSet;
...
.method static synthetic b(Lmiui/mihome/taskmanager/b;)Lmiui/mihome/taskmanager/y;
    ...
    iget-object v0, p0, Lmiui/mihome/taskmanager/b;->oJ:Lmiui/mihome/taskmanager/y;
...
.method private b(Ljava/util/ArrayList;)V
    ...
    iput-object v0, p0, Lmiui/mihome/taskmanager/b;->oK:Landroid/os/AsyncTask;
...
.method public a(Lmiui/mihome/taskmanager/C;)V
    ...
    iget-boolean v0, p1, Lmiui/mihome/taskmanager/C;->aup:Z
    ...
    :goto_0
    iput-boolean v0, p1, Lmiui/mihome/taskmanager/C;->aup:Z

    iget-boolean v0, p1, Lmiui/mihome/taskmanager/C;->aup:Z

    if-eqz v0, :cond_1

    iget-object v0, p0, Lmiui/mihome/taskmanager/b;->oN:Ljava/util/Set;
    ...
    iget-object v2, p0, Lmiui/mihome/taskmanager/b;->oN:Ljava/util/Set;
    ...
    iget-object v1, p0, Lmiui/mihome/taskmanager/b;->oN:Ljava/util/Set;

    invoke-direct {v0, v1}, Ljava/util/HashSet;-><init>(Ljava/util/Collection;)V

    iput-object v0, p0, Lmiui/mihome/taskmanager/b;->oN:Ljava/util/Set;
...
.method public b(Lmiui/mihome/taskmanager/C;)V
    ...
    iget-object v1, p0, Lmiui/mihome/taskmanager/b;->oQ:Ljava/util/ArrayList;
...
.method public eb()V
    ...
    iget-object v0, p0, Lmiui/mihome/taskmanager/b;->oK:Landroid/os/AsyncTask;
...
.method ec()Ljava/util/ArrayList;
    ...
    iput-object v0, p0, Lmiui/mihome/taskmanager/b;->oQ:Ljava/util/ArrayList;
    ...
    iput-boolean v0, v3, Lmiui/mihome/taskmanager/C;->aup:Z
    ...
    iget-object v0, p0, Lmiui/mihome/taskmanager/b;->oQ:Ljava/util/ArrayList;
    ...
    :cond_5
    iget-boolean v0, p0, Lmiui/mihome/taskmanager/b;->oO:Z
...
.method public ed()V
    ...
    iget-boolean v1, v1, Lmiui/mihome/taskmanager/C;->aup:Z
    ...
    iget-object v3, p0, Lmiui/mihome/taskmanager/b;->oR:Ljava/util/HashSet;
    ...
    invoke-virtual {v3, v5}, Lcom/miui/mihome/q;->aw(Z)Z
    ...
    invoke-virtual {v3, v1}, Lcom/miui/mihome/q;->cH(Ljava/lang/String;)V
