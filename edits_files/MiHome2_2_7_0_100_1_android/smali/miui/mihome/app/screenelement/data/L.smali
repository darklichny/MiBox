...
.method public constructor <init>(Lorg/w3c/dom/Element;Lmiui/mihome/app/screenelement/W;)V
    ...
    iput-object v0, p0, Lmiui/mihome/app/screenelement/data/L;->jI:Ljava/util/ArrayList;
...
.method private a(Lorg/w3c/dom/Element;)V
    ...
    iput-object v0, p0, Lmiui/mihome/app/screenelement/data/L;->xA:Ljava/lang/String;

    iget-object v0, p0, Lmiui/mihome/app/screenelement/data/L;->xA:Ljava/lang/String;
    ...
    iget-object v1, p0, Lmiui/mihome/app/screenelement/data/L;->xA:Ljava/lang/String;

    invoke-direct {v0, v1}, Landroid/content/IntentFilter;-><init>(Ljava/lang/String;)V

    iput-object v0, p0, Lmiui/mihome/app/screenelement/data/L;->xz:Landroid/content/IntentFilter;

    iget-object v0, p0, Lmiui/mihome/app/screenelement/data/L;->k:Lmiui/mihome/app/screenelement/W;
    ...
    iput-object v0, p0, Lmiui/mihome/app/screenelement/data/L;->yf:Lmiui/mihome/app/screenelement/N;
...
.method private o(Landroid/content/Intent;)V
    ...
    iget-object v0, p0, Lmiui/mihome/app/screenelement/data/L;->jI:Ljava/util/ArrayList;
    ...
    invoke-virtual {v0}, Lmiui/mihome/app/screenelement/data/h;->bg()Z

    move-result v5

    if-eqz v5, :cond_2

    iget-object v3, v0, Lmiui/mihome/app/screenelement/data/h;->pb:Ljava/lang/String;
    ...
    iget-object v2, v0, Lmiui/mihome/app/screenelement/data/h;->gp:Lmiui/mihome/app/screenelement/util/c;

    if-nez v3, :cond_8

    iget-object v1, v0, Lmiui/mihome/app/screenelement/data/h;->pc:Ljava/lang/String;
    ...
    iget-object v0, v0, Lmiui/mihome/app/screenelement/data/h;->gn:Ljava/lang/String;
    ...
    iget-object v6, v0, Lmiui/mihome/app/screenelement/data/h;->gn:Ljava/lang/String;
    ...
    iget-object v1, v0, Lmiui/mihome/app/screenelement/data/h;->pb:Ljava/lang/String;

    iget-wide v5, v0, Lmiui/mihome/app/screenelement/data/h;->pd:D
    ...
    iget-object v7, v0, Lmiui/mihome/app/screenelement/data/h;->gn:Ljava/lang/String;
    ...
    :cond_9
    iget-object v3, v0, Lmiui/mihome/app/screenelement/data/h;->go:Lmiui/mihome/app/screenelement/util/q;
...
.method protected a(Landroid/content/Context;Landroid/content/Intent;Ljava/lang/Object;)V
    ...
    invoke-direct {p0, p2}, Lmiui/mihome/app/screenelement/data/L;->o(Landroid/content/Intent;)V

    iget-object v0, p0, Lmiui/mihome/app/screenelement/data/L;->yf:Lmiui/mihome/app/screenelement/N;
...
.method protected gW()V
    ...
    iget-object v2, p0, Lmiui/mihome/app/screenelement/data/L;->xz:Landroid/content/IntentFilter;

    invoke-virtual {v0, v1, v2}, Landroid/content/Context;->registerReceiver(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;)Landroid/content/Intent;

    move-result-object v0

    invoke-direct {p0, v0}, Lmiui/mihome/app/screenelement/data/L;->o(Landroid/content/Intent;)V
...
.method protected register()V
    ...
    :cond_0
    invoke-virtual {p0}, Lmiui/mihome/app/screenelement/data/L;->gW()V
...
.method protected unregister()V
    ...
    :cond_0
    :try_start_0
    invoke-virtual {p0}, Lmiui/mihome/app/screenelement/data/L;->gX()V
    :try_end_0
