...
.field private oa:Lmiui/mihome/widget/g;
...
.method public constructor <init>(Lorg/w3c/dom/Element;Lmiui/mihome/app/screenelement/W;)V
    ...
    iput-object v0, p0, Lmiui/mihome/app/screenelement/elements/f;->oe:Ljava/lang/String;
    ...
    iput-object v0, p0, Lmiui/mihome/app/screenelement/elements/f;->ob:Ljava/lang/String;
    ...
    iput-object v0, p0, Lmiui/mihome/app/screenelement/elements/f;->oc:Ljava/lang/String;
    ...
    iput-object v0, p0, Lmiui/mihome/app/screenelement/elements/f;->oa:Lmiui/mihome/widget/g;

    iget-object v0, p0, Lmiui/mihome/app/screenelement/elements/f;->oa:Lmiui/mihome/widget/g;

    invoke-virtual {v0, v2}, Lmiui/mihome/widget/g;->F(Z)V

    iget-object v0, p0, Lmiui/mihome/app/screenelement/elements/f;->oa:Lmiui/mihome/widget/g;

    invoke-virtual {v0, v2}, Lmiui/mihome/widget/g;->G(Z)V
    ...
    iput v0, p0, Lmiui/mihome/app/screenelement/elements/f;->og:I
...
.method public a(Landroid/graphics/Canvas;)V
    ...
    iget-object v0, p0, Lmiui/mihome/app/screenelement/elements/f;->of:Landroid/graphics/Bitmap;
    ...
    invoke-virtual {p0}, Lmiui/mihome/app/screenelement/elements/f;->vL()F

    move-result v1

    invoke-virtual {p0}, Lmiui/mihome/app/screenelement/elements/f;->vM()F
...
.method protected getBitmap()Landroid/graphics/Bitmap;
    ...
    iget v1, p0, Lmiui/mihome/app/screenelement/elements/f;->od:I
...
.method public init()V
    ...
    iget-object v0, p0, Lmiui/mihome/app/screenelement/elements/f;->oe:Ljava/lang/String;
    ...
    :goto_0
    iput-object v0, p0, Lmiui/mihome/app/screenelement/elements/f;->of:Landroid/graphics/Bitmap;

    iget-object v0, p0, Lmiui/mihome/app/screenelement/elements/f;->ob:Ljava/lang/String;
    ...
    :goto_1
    iget-object v2, p0, Lmiui/mihome/app/screenelement/elements/f;->oc:Ljava/lang/String;
    ...
    :cond_0
    iget-object v2, p0, Lmiui/mihome/app/screenelement/elements/f;->of:Landroid/graphics/Bitmap;
    ...
    iget-object v2, p0, Lmiui/mihome/app/screenelement/elements/f;->oe:Ljava/lang/String;
    ...
    iget-object v2, p0, Lmiui/mihome/app/screenelement/elements/f;->ob:Ljava/lang/String;
    ...
    :cond_6
    iget-object v4, p0, Lmiui/mihome/app/screenelement/elements/f;->oa:Lmiui/mihome/widget/g;

    invoke-virtual {v4, v3, v2, v0, v1}, Lmiui/mihome/widget/g;->a(IILandroid/graphics/Bitmap;Landroid/graphics/Bitmap;)V

    iget v1, p0, Lmiui/mihome/app/screenelement/elements/f;->og:I

    if-ltz v1, :cond_7

    iget-object v1, p0, Lmiui/mihome/app/screenelement/elements/f;->oa:Lmiui/mihome/widget/g;

    iget v4, p0, Lmiui/mihome/app/screenelement/elements/f;->og:I

    invoke-virtual {v1, v4}, Lmiui/mihome/widget/g;->W(I)V
    ...
    iput v0, p0, Lmiui/mihome/app/screenelement/elements/f;->od:I
