...
# instance fields
.field public FR:Lmiui/mihome/app/screenelement/util/f;

.field public apA:Z

.field final synthetic dd:Lmiui/mihome/app/screenelement/elements/AdvancedSlider;

.field public oj:Lmiui/mihome/app/screenelement/ActionCommand;

.field public yf:Lmiui/mihome/app/screenelement/N;
...
.method private constructor <init>(Lmiui/mihome/app/screenelement/elements/AdvancedSlider;)V
    ...
    iput-object p1, p0, Lmiui/mihome/app/screenelement/elements/G;->dd:Lmiui/mihome/app/screenelement/elements/AdvancedSlider;
...
.method private xj()Landroid/content/Intent;
    .locals 4

    const/4 v0, 0x0

    iget-object v1, p0, Lmiui/mihome/app/screenelement/elements/G;->FR:Lmiui/mihome/app/screenelement/util/f;
    ...
    :cond_1
    iget-boolean v1, p0, Lmiui/mihome/app/screenelement/elements/G;->apA:Z

    if-nez v1, :cond_3

    iget-object v1, p0, Lmiui/mihome/app/screenelement/elements/G;->dd:Lmiui/mihome/app/screenelement/elements/AdvancedSlider;

    iget-object v1, v1, Lmiui/mihome/app/screenelement/elements/AdvancedSlider;->k:Lmiui/mihome/app/screenelement/W;

    iget-object v2, p0, Lmiui/mihome/app/screenelement/elements/G;->FR:Lmiui/mihome/app/screenelement/util/f;

    iget-object v2, v2, Lmiui/mihome/app/screenelement/util/f;->id:Ljava/lang/String;

    invoke-virtual {v1, v2}, Lmiui/mihome/app/screenelement/W;->bD(Ljava/lang/String;)Lmiui/mihome/app/screenelement/util/f;
    ...
    iput-object v1, p0, Lmiui/mihome/app/screenelement/elements/G;->FR:Lmiui/mihome/app/screenelement/util/f;

    :cond_2
    const/4 v1, 0x1

    iput-boolean v1, p0, Lmiui/mihome/app/screenelement/elements/G;->apA:Z
    ...
    iget-object v1, v1, Lmiui/mihome/app/screenelement/util/f;->qY:Ljava/lang/String;
    ...
    iget-object v3, p0, Lmiui/mihome/app/screenelement/elements/G;->FR:Lmiui/mihome/app/screenelement/util/f;
...
.method public finish()V
    ...
    iget-object v0, p0, Lmiui/mihome/app/screenelement/elements/G;->oj:Lmiui/mihome/app/screenelement/ActionCommand;
    ...
    :cond_0
    iget-object v0, p0, Lmiui/mihome/app/screenelement/elements/G;->yf:Lmiui/mihome/app/screenelement/N;
...
.method public xi()Landroid/content/Intent;
    .locals 1

    iget-object v0, p0, Lmiui/mihome/app/screenelement/elements/G;->FR:Lmiui/mihome/app/screenelement/util/f;

    if-eqz v0, :cond_0

    invoke-direct {p0}, Lmiui/mihome/app/screenelement/elements/G;->xj()Landroid/content/Intent;
