...
# static fields
.field private static final WO:Ljava/lang/Integer;

.field private static final aqp:Ljava/util/Map;

.field private static final aqq:Lmiui/utils/CarrierSelector;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/xiaomi/xmsf/account/utils/c;->WO:Ljava/lang/Integer;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    sput-object v0, Lcom/xiaomi/xmsf/account/utils/c;->aqp:Ljava/util/Map;
    ...
    sput-object v0, Lcom/xiaomi/xmsf/account/utils/c;->aqq:Lmiui/utils/CarrierSelector;

    sget-object v0, Lcom/xiaomi/xmsf/account/utils/c;->aqq:Lmiui/utils/CarrierSelector;
...
.method public static Q(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p0}, Lcom/xiaomi/xmsf/account/utils/c;->dZ(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v0

    invoke-static {p1}, Lcom/xiaomi/xmsf/account/utils/c;->dZ(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v1, v0}, Lmiui/net/b;->be(Ljava/lang/String;)Ljava/lang/Object;

    move-result-object v0

    sget-object v4, Lcom/xiaomi/xmsf/account/utils/c;->WO:Ljava/lang/Integer;
    ...
    invoke-virtual {v1, v3}, Lmiui/net/b;->be(Ljava/lang/String;)Ljava/lang/Object;
...
.method public static R(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    sget-object v0, Lcom/xiaomi/xmsf/account/utils/c;->WO:Ljava/lang/Integer;
    ...
    const-string v3, "CloudHelper"

    new-instance v4, Ljava/lang/StringBuilder;

    invoke-direct {v4}, Ljava/lang/StringBuilder;-><init>()V

    const-string v5, "get data node:"
    ...
    const-string v3, "register failed, code: %s, description: %s"
    ...
    invoke-virtual {v1, v2}, Lmiui/net/b;->be(Ljava/lang/String;)Ljava/lang/Object;
...
.method private static S(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v2, v0}, Lmiui/net/b;->be(Ljava/lang/String;)Ljava/lang/Object;

    move-result-object v0

    sget-object v3, Lcom/xiaomi/xmsf/account/utils/c;->WO:Ljava/lang/Integer;
    ...
    const-string v3, "user not registered, id:"
    ...
    invoke-virtual {v2, v5}, Lmiui/net/b;->be(Ljava/lang/String;)Ljava/lang/Object;
    ...
    invoke-virtual {v2, v4}, Lmiui/net/b;->be(Ljava/lang/String;)Ljava/lang/Object;
...
.method public static a(Landroid/content/Context;Landroid/app/PendingIntent;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {p2}, Lcom/xiaomi/xmsf/account/utils/c;->dZ(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v3

    invoke-static {p3}, Lcom/xiaomi/xmsf/account/utils/c;->dZ(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p0}, Lcom/xiaomi/xmsf/account/utils/c;->bk(Landroid/content/Context;)Ljava/lang/String;
...
.method protected static bk(Landroid/content/Context;)Ljava/lang/String;
    .locals 2
    ...
    sget-object v1, Lcom/xiaomi/xmsf/account/utils/c;->aqq:Lmiui/utils/CarrierSelector;

    invoke-virtual {v1, v0}, Lmiui/utils/CarrierSelector;->bO(Ljava/lang/String;)Ljava/lang/Object;
...
.method public static dX(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p0, v0}, Lcom/xiaomi/xmsf/account/utils/c;->S(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method private static dZ(Ljava/lang/String;)Ljava/lang/String;
    ...
    sget-object v1, Lcom/xiaomi/xmsf/account/utils/c;->aqp:Ljava/util/Map;
    ...
    :cond_0
    sget-object v0, Lcom/xiaomi/xmsf/account/utils/c;->aqp:Ljava/util/Map;
    ...
    sget-object v2, Lcom/xiaomi/xmsf/account/utils/c;->aqp:Ljava/util/Map;
