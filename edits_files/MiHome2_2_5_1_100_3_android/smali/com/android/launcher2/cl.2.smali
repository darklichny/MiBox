...
# instance fields
.field final synthetic aex:Lcom/android/launcher2/CellLayout;

.field final synthetic aey:Ljava/util/ArrayList;

.field final synthetic aez:Landroid/appwidget/AppWidgetManager;
...
.method constructor <init>(Lcom/android/launcher2/Workspace;Lcom/android/launcher2/CellLayout;Ljava/util/ArrayList;Landroid/appwidget/AppWidgetManager;)V
    ...
    iput-object p1, p0, Lcom/android/launcher2/cl;->gN:Lcom/android/launcher2/Workspace;

    iput-object p2, p0, Lcom/android/launcher2/cl;->aex:Lcom/android/launcher2/CellLayout;

    iput-object p3, p0, Lcom/android/launcher2/cl;->aey:Ljava/util/ArrayList;

    iput-object p4, p0, Lcom/android/launcher2/cl;->aez:Landroid/appwidget/AppWidgetManager;
...
.method public run()V
    ...
    iget-object v0, p0, Lcom/android/launcher2/cl;->aex:Lcom/android/launcher2/CellLayout;
    ...
    instance-of v1, v0, Lcom/android/launcher2/dK;
    ...
    iget-object v1, p0, Lcom/android/launcher2/cl;->aey:Ljava/util/ArrayList;
    ...
    iget-boolean v9, v1, Lcom/android/launcher2/bf;->Us:Z

    if-nez v9, :cond_1

    iget v9, v0, Lcom/android/launcher2/dK;->itemType:I

    if-eqz v9, :cond_1

    iget-object v9, p0, Lcom/android/launcher2/cl;->gN:Lcom/android/launcher2/Workspace;

    invoke-static {v9}, Lcom/android/launcher2/Workspace;->b(Lcom/android/launcher2/Workspace;)Lcom/android/launcher2/Launcher;

    move-result-object v9

    invoke-static {v9, v0}, Lcom/android/launcher2/bz;->c(Landroid/content/Context;Lcom/android/launcher2/df;)V
    ...
    invoke-static {v9, v1, v0}, Lcom/android/launcher2/Launcher;->a(Landroid/content/Context;Lcom/android/launcher2/bf;Lcom/android/launcher2/dK;)Z
    ...
    iget-object v6, p0, Lcom/android/launcher2/cl;->gN:Lcom/android/launcher2/Workspace;

    invoke-static {v6}, Lcom/android/launcher2/Workspace;->b(Lcom/android/launcher2/Workspace;)Lcom/android/launcher2/Launcher;

    move-result-object v6

    invoke-virtual {v0, v1, v6}, Lcom/android/launcher2/aM;->a(Ljava/util/ArrayList;Lcom/android/launcher2/Launcher;)V
    ...
    iget-object v1, p0, Lcom/android/launcher2/cl;->aez:Landroid/appwidget/AppWidgetManager;

    iget v7, v0, Lcom/android/launcher2/ac;->Ap:I
    ...
    iget-object v1, p0, Lcom/android/launcher2/cl;->gN:Lcom/android/launcher2/Workspace;

    invoke-static {v1}, Lcom/android/launcher2/Workspace;->b(Lcom/android/launcher2/Workspace;)Lcom/android/launcher2/Launcher;

    move-result-object v1

    invoke-static {v1, v0}, Lcom/android/launcher2/bz;->c(Landroid/content/Context;Lcom/android/launcher2/df;)V
    ...
    iget-object v2, p0, Lcom/android/launcher2/cl;->aex:Lcom/android/launcher2/CellLayout;

    invoke-virtual {v2, v0}, Lcom/android/launcher2/CellLayout;->removeViewInLayout(Landroid/view/View;)V

    instance-of v2, v0, Lcom/android/launcher2/aE;

    if-eqz v2, :cond_8

    iget-object v2, p0, Lcom/android/launcher2/cl;->gN:Lcom/android/launcher2/Workspace;
    ...
    invoke-virtual {v2, v0}, Lcom/android/launcher2/a;->b(Lcom/android/launcher2/aE;)V
