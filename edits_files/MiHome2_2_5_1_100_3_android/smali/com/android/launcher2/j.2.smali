...
.field private jD:Lcom/android/launcher2/dL;
...
.method private a(Landroid/content/ComponentName;Ljava/lang/String;Ljava/lang/String;[B)V
    ...
    invoke-virtual {v1, v0}, Lcom/android/launcher2/Launcher;->d(Lcom/android/launcher2/dK;)Lcom/android/launcher2/aM;

    move-result-object v0

    invoke-virtual {p0, v0}, Lcom/android/launcher2/j;->a(Lcom/android/launcher2/aM;)V
...
.method private initialize()V
    ...
    invoke-direct {v1, p0}, Lcom/android/launcher2/dL;-><init>(Lcom/android/launcher2/j;)V

    iput-object v1, p0, Lcom/android/launcher2/j;->jD:Lcom/android/launcher2/dL;

    iget-object v1, p0, Lcom/android/launcher2/j;->O:Lcom/android/launcher2/Launcher;

    iget-object v2, p0, Lcom/android/launcher2/j;->jD:Lcom/android/launcher2/dL;
...
.method public a(Lcom/android/launcher2/ShortcutIcon;Landroid/content/ComponentName;)V
    ...
    invoke-interface {v0}, Lcom/android/launcher2/X;->ic()Ljava/lang/String;

    move-result-object v1

    invoke-interface {v0}, Lcom/android/launcher2/X;->id()Ljava/lang/String;

    move-result-object v2

    invoke-interface {v0}, Lcom/android/launcher2/X;->ie()[B
...
.method public a(Lcom/android/launcher2/aM;)V
    ...
    invoke-virtual {v0, p1}, Lcom/android/launcher2/Launcher;->e(Lcom/android/launcher2/aM;)Lcom/android/launcher2/FolderIcon;
    ...
    iget-wide v5, v1, Lcom/android/launcher2/dK;->anP:J

    iget-wide v7, p1, Lcom/android/launcher2/aM;->id:J

    cmp-long v1, v5, v7

    if-nez v1, :cond_4

    invoke-interface {v0}, Lcom/android/launcher2/X;->if()Z
...
.method public bj()V
    ...
    iget-object v0, p0, Lcom/android/launcher2/j;->jD:Lcom/android/launcher2/dL;

    if-eqz v0, :cond_0

    iget-object v0, p0, Lcom/android/launcher2/j;->O:Lcom/android/launcher2/Launcher;

    iget-object v1, p0, Lcom/android/launcher2/j;->jD:Lcom/android/launcher2/dL;

    invoke-virtual {v0, v1}, Lcom/android/launcher2/Launcher;->unregisterReceiver(Landroid/content/BroadcastReceiver;)V

    iput-object v2, p0, Lcom/android/launcher2/j;->jD:Lcom/android/launcher2/dL;
...
.method public cE()V
    ...
    :cond_0
    invoke-direct {p0}, Lcom/android/launcher2/j;->cF()V
