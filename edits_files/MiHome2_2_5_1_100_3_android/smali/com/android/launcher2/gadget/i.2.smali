...
.method protected varargs b([Ljava/lang/Void;)Landroid/graphics/Bitmap;
    ...
    iget-object v1, v0, Lcom/android/launcher2/gadget/PhotoFramePicker;->zg:Landroid/net/Uri;

    if-nez v1, :cond_0

    new-instance v1, Lmiui/mihome/b/b;

    iget-object v2, v0, Lcom/android/launcher2/gadget/PhotoFramePicker;->zb:Ljava/lang/String;

    iget-object v0, v0, Lcom/android/launcher2/gadget/PhotoFramePicker;->zd:Ljava/lang/String;
    ...
    iget-object v2, v0, Lcom/android/launcher2/gadget/PhotoFramePicker;->zg:Landroid/net/Uri;
...
.method protected d(Landroid/graphics/Bitmap;)V
    ...
    :cond_0
    iget-object v1, v0, Lcom/android/launcher2/gadget/PhotoFramePicker;->zj:Lcom/android/launcher2/gadget/PhotoFrameView;
    ...
    iget v2, v0, Lcom/android/launcher2/gadget/PhotoFramePicker;->zh:I

    invoke-virtual {v1, v2, v3}, Lcom/android/launcher2/gadget/PhotoFrameView;->c(IZ)V

    invoke-virtual {v0}, Lcom/android/launcher2/gadget/PhotoFramePicker;->iw()V

    :cond_1
    :goto_0
    const/4 v1, 0x0

    iput-object v1, v0, Lcom/android/launcher2/gadget/PhotoFramePicker;->zn:Lcom/android/launcher2/gadget/i;
    ...
    invoke-virtual {v1}, Lcom/android/launcher2/gadget/PhotoFrameView;->fv()V
