...
.super Lcom/android/launcher2/de;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {p0, p1, p2, p3}, Lcom/android/launcher2/de;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
...
.method protected aJ(Z)V
    ...
    iget-object v1, v0, Lcom/android/launcher2/WorkspaceThumbnailView;->ano:Lcom/android/launcher2/N;

    invoke-virtual {v1}, Lcom/android/launcher2/N;->bp()I

    move-result v1

    move-object/from16 v0, p0

    iget v2, v0, Lcom/android/launcher2/WorkspaceThumbnailView;->ann:I

    rem-int v3, v1, v2

    move-object/from16 v0, p0

    iget v1, v0, Lcom/android/launcher2/WorkspaceThumbnailView;->yS:I
    ...
    iget v4, v0, Lcom/android/launcher2/WorkspaceThumbnailView;->anc:I
    ...
    invoke-virtual {v1, v0, v4, v3, v2}, Lcom/android/launcher2/dH;->a(ZIILandroid/view/animation/Animation$AnimationListener;)V
    ...
    iget-object v2, v0, Lcom/android/launcher2/WorkspaceThumbnailView;->ano:Lcom/android/launcher2/N;

    move-object/from16 v0, p0

    iget-object v4, v0, Lcom/android/launcher2/WorkspaceThumbnailView;->ano:Lcom/android/launcher2/N;

    invoke-virtual {v4}, Lcom/android/launcher2/N;->bp()I
    ...
    invoke-virtual {v1, v3}, Lcom/android/launcher2/dH;->getChildAt(I)Landroid/view/View;
    ...
    iget v1, v0, Lcom/android/launcher2/WorkspaceThumbnailView;->anc:I
...
.method protected d(Landroid/view/ScaleGestureDetector;)V
    ...
    invoke-virtual {p0}, Lcom/android/launcher2/WorkspaceThumbnailView;->ii()V

    iget v0, p0, Lcom/android/launcher2/WorkspaceThumbnailView;->yS:I
    ...
    invoke-virtual {v0, v1, v2}, Lcom/android/launcher2/dH;->O(II)I

    move-result v0

    if-ltz v0, :cond_0

    iget v1, p0, Lcom/android/launcher2/WorkspaceThumbnailView;->ann:I

    iget v2, p0, Lcom/android/launcher2/WorkspaceThumbnailView;->yS:I

    mul-int/2addr v1, v2

    add-int/2addr v0, v1

    iget-object v1, p0, Lcom/android/launcher2/WorkspaceThumbnailView;->ano:Lcom/android/launcher2/N;
    ...
    :cond_0
    invoke-super {p0, p1}, Lcom/android/launcher2/de;->d(Landroid/view/ScaleGestureDetector;)V
...
.method protected df(I)V
    ...
    invoke-virtual {p0}, Lcom/android/launcher2/WorkspaceThumbnailView;->ua()Landroid/view/View;
    ...
    iget v2, p0, Lcom/android/launcher2/WorkspaceThumbnailView;->ann:I

    rem-int v2, p1, v2

    invoke-virtual {v0}, Lcom/android/launcher2/dH;->getChildCount()I

    move-result v3

    invoke-virtual {v0, v1, v2, v3}, Lcom/android/launcher2/dH;->n(III)V
