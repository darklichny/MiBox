...
# instance fields
.field private final adG:Landroid/appwidget/AppWidgetHost;
...
.method constructor <init>(Landroid/content/Context;)V
    ...
    iput-wide v0, p0, Lcom/android/launcher2/ck;->adH:J

    iput-object p1, p0, Lcom/android/launcher2/ck;->mContext:Landroid/content/Context;
    ...
    iput-object v0, p0, Lcom/android/launcher2/ck;->adG:Landroid/appwidget/AppWidgetHost;

    return-void
.end method

.method static synthetic a(Lcom/android/launcher2/ck;)Landroid/content/Context;
    .locals 1

    iget-object v0, p0, Lcom/android/launcher2/ck;->mContext:Landroid/content/Context;
...
.method private a(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;)V
    ...
    iget-object v1, p0, Lcom/android/launcher2/ck;->mContext:Landroid/content/Context;
...
.method private a(Landroid/database/sqlite/SQLiteDatabase;Landroid/content/ContentValues;)Z
    ...
    invoke-direct {p0, p1, p2, v0}, Lcom/android/launcher2/ck;->a(Landroid/database/sqlite/SQLiteDatabase;Landroid/content/ContentValues;I)Z
...
.method private a(Landroid/database/sqlite/SQLiteDatabase;Landroid/content/ContentValues;I)Z
    ...
    iget v2, v0, Lcom/android/launcher2/gadget/F;->yD:I
...
.method private a(Landroid/database/sqlite/SQLiteDatabase;Landroid/content/ContentValues;Landroid/content/ComponentName;II)Z
    ...
    :try_start_0
    iget-object v0, p0, Lcom/android/launcher2/ck;->adG:Landroid/appwidget/AppWidgetHost;
...
.method private a(Landroid/database/sqlite/SQLiteDatabase;Landroid/content/ContentValues;Lcom/android/launcher2/dy;)Z
    .locals 3
    ...
    invoke-virtual {p3, v1}, Lcom/android/launcher2/dy;->getString(I)Ljava/lang/String;
...
.method private a(Landroid/database/sqlite/SQLiteDatabase;Landroid/content/ContentValues;Lcom/android/launcher2/dy;Landroid/content/pm/PackageManager;)Z
    .locals 6
    ...
    invoke-virtual {p3, v0}, Lcom/android/launcher2/dy;->getString(I)Ljava/lang/String;
    ...
    invoke-virtual {p3, v1, v0}, Lcom/android/launcher2/dy;->getInt(II)I
    ...
    invoke-direct/range {v0 .. v5}, Lcom/android/launcher2/ck;->a(Landroid/database/sqlite/SQLiteDatabase;Landroid/content/ContentValues;Landroid/content/ComponentName;II)Z
...
.method private a(Landroid/database/sqlite/SQLiteDatabase;Landroid/content/ContentValues;Lcom/android/launcher2/dy;Landroid/content/pm/PackageManager;Landroid/content/Intent;)Z
    .locals 7
    ...
    :cond_1
    invoke-static {v3, v6}, Lmiui/mihome/a/a/c;->m(Ljava/lang/String;Ljava/lang/String;)Landroid/graphics/drawable/BitmapDrawable;
    ...
    invoke-virtual {p3, v2}, Lcom/android/launcher2/dy;->getDrawable(I)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v2, p0, Lcom/android/launcher2/ck;->mContext:Landroid/content/Context;
    ...
    invoke-virtual {p3, v4}, Lcom/android/launcher2/dy;->getString(I)Ljava/lang/String;
    ...
    invoke-static {p2, v0}, Lcom/android/launcher2/df;->a(Landroid/content/ContentValues;Landroid/graphics/Bitmap;)V
...
.method private a(Landroid/database/sqlite/SQLiteDatabase;Landroid/content/ContentValues;Lcom/android/launcher2/dy;Landroid/content/pm/PackageManager;Landroid/content/Intent;Ljava/util/List;)Z
    .locals 8
    ...
    invoke-virtual {p3, v2, v3}, Lcom/android/launcher2/dy;->getBoolean(IZ)Z
    ...
    invoke-direct/range {p0 .. p5}, Lcom/android/launcher2/ck;->a(Landroid/database/sqlite/SQLiteDatabase;Landroid/content/ContentValues;Lcom/android/launcher2/dy;Landroid/content/pm/PackageManager;Landroid/content/Intent;)Z
    ...
    invoke-virtual {p3, v2}, Lcom/android/launcher2/dy;->getString(I)Ljava/lang/String;
    ...
    invoke-static {v2, v5}, Lcom/miui/home/a/b;->d(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v2

    iget-object v3, p0, Lcom/android/launcher2/ck;->mContext:Landroid/content/Context;

    invoke-static {v3, v5}, Lcom/miui/home/a/b;->e(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    :goto_4
    const-string v0, "LauncherProvider--addAppShortcut"
    ...
    invoke-virtual {p3, v0, v5}, Lcom/android/launcher2/dy;->getBoolean(IZ)Z
...
.method private b(Landroid/database/sqlite/SQLiteDatabase;Landroid/content/ContentValues;Lcom/android/launcher2/dy;)Z
    .locals 1
    ...
    invoke-static {v0}, Lcom/android/launcher2/gadget/af;->dM(Ljava/lang/String;)I
...
.method private c(Landroid/database/sqlite/SQLiteDatabase;Landroid/content/ContentValues;Lcom/android/launcher2/dy;)Z
    .locals 9
    ...
    :cond_0
    invoke-direct {p0, v3}, Lcom/android/launcher2/ck;->v(Ljava/util/List;)Landroid/content/pm/ResolveInfo;
    ...
    invoke-virtual {p3, v8}, Lcom/android/launcher2/dy;->getString(I)Ljava/lang/String;
    ...
    invoke-virtual {p3, v3}, Lcom/android/launcher2/dy;->getString(I)Ljava/lang/String;
    ...
    const-string v0, "LauncherProvider--addHelperIntentShortcut"
...
.method private d(Landroid/database/sqlite/SQLiteDatabase;Landroid/content/ContentValues;Lcom/android/launcher2/dy;)Z
    .locals 6
...
.method private f(Landroid/database/sqlite/SQLiteDatabase;)I
    ...
    iget-object v5, v0, Lcom/android/launcher2/ck;->mContext:Landroid/content/Context;
    ...
    invoke-static {v5, v11}, Lcom/android/launcher2/bz;->a(Landroid/content/Context;Ljava/util/List;)V

    const/4 v12, 0x0

    :try_start_0
    invoke-direct/range {p0 .. p0}, Lcom/android/launcher2/ck;->sB()Lorg/xmlpull/v1/XmlPullParser;
    ...
    invoke-direct/range {p0 .. p0}, Lcom/android/launcher2/ck;->sC()I
    ...
    invoke-static {v5}, Lcom/android/launcher2/gadget/W;->aN(Landroid/content/Context;)Z
    ...
    invoke-static {v0, v5}, Lcom/android/launcher2/bC;->a(Ljava/util/HashMap;I)V
    ...
    new-instance v8, Lcom/android/launcher2/dy;
    ...
    invoke-direct {v8, v0, v1, v5}, Lcom/android/launcher2/dy;-><init>(Lcom/android/launcher2/ck;Ljava/lang/Object;[I)V

    invoke-virtual {v7}, Landroid/content/ContentValues;->clear()V

    const/4 v5, 0x3

    invoke-virtual {v8, v5}, Lcom/android/launcher2/dy;->getString(I)Ljava/lang/String;
    ...
    invoke-virtual {v8, v14}, Lcom/android/launcher2/dy;->getString(I)Ljava/lang/String;
    ...
    invoke-virtual {v8, v5, v13}, Lcom/android/launcher2/dy;->getInt(II)I
    ...
    invoke-static {v5, v0, v13}, Lcom/android/launcher2/bC;->a(ILjava/util/HashMap;Z)Lcom/android/launcher2/b;
    ...
    invoke-static {v0, v1, v2, v3, v4}, Lcom/android/launcher2/bC;->a(Ljava/util/HashMap;IIIZ)V
    ...
    iget-object v6, v0, Lcom/android/launcher2/ck;->mContext:Landroid/content/Context;
    ...
    invoke-direct/range {v5 .. v11}, Lcom/android/launcher2/ck;->a(Landroid/database/sqlite/SQLiteDatabase;Landroid/content/ContentValues;Lcom/android/launcher2/dy;Landroid/content/pm/PackageManager;Landroid/content/Intent;Ljava/util/List;)Z
    ...
    invoke-direct {v0, v1, v7, v8}, Lcom/android/launcher2/ck;->c(Landroid/database/sqlite/SQLiteDatabase;Landroid/content/ContentValues;Lcom/android/launcher2/dy;)Z
    ...
    invoke-direct {v0, v1, v7}, Lcom/android/launcher2/ck;->a(Landroid/database/sqlite/SQLiteDatabase;Landroid/content/ContentValues;)Z
    ...
    invoke-direct {v0, v1, v7}, Lcom/android/launcher2/ck;->b(Landroid/database/sqlite/SQLiteDatabase;Landroid/content/ContentValues;)Z
    ...
    invoke-direct {v0, v1, v7, v8, v9}, Lcom/android/launcher2/ck;->a(Landroid/database/sqlite/SQLiteDatabase;Landroid/content/ContentValues;Lcom/android/launcher2/dy;Landroid/content/pm/PackageManager;)Z
    ...
    invoke-direct {v0, v1, v7, v8}, Lcom/android/launcher2/ck;->d(Landroid/database/sqlite/SQLiteDatabase;Landroid/content/ContentValues;Lcom/android/launcher2/dy;)Z
    ...
    invoke-virtual {v8, v6}, Lcom/android/launcher2/dy;->getString(I)Ljava/lang/String;
    ...
    invoke-direct {v0, v1, v7, v8}, Lcom/android/launcher2/ck;->a(Landroid/database/sqlite/SQLiteDatabase;Landroid/content/ContentValues;Lcom/android/launcher2/dy;)Z
    ...
    invoke-direct {v0, v1, v7, v8}, Lcom/android/launcher2/ck;->b(Landroid/database/sqlite/SQLiteDatabase;Landroid/content/ContentValues;Lcom/android/launcher2/dy;)Z
    ...
    :cond_12
    :goto_9
    invoke-virtual {v8}, Lcom/android/launcher2/dy;->recycle()V
    :try_end_5
...
.method private sB()Lorg/xmlpull/v1/XmlPullParser;
    .locals 2
    ...
    invoke-static {v0}, Lcom/android/launcher2/gadget/W;->aN(Landroid/content/Context;)Z
...
.method private sC()I
    ...
    :try_start_0
    invoke-direct {p0}, Lcom/android/launcher2/ck;->sB()Lorg/xmlpull/v1/XmlPullParser;
    ...
    new-instance v2, Lcom/android/launcher2/dy;

    sget-object v7, Lcom/miui/a/a;->sR:[I

    invoke-direct {v2, p0, v6, v7}, Lcom/android/launcher2/dy;-><init>(Lcom/android/launcher2/ck;Ljava/lang/Object;[I)V

    const/4 v7, 0x1

    invoke-virtual {v2, v7}, Lcom/android/launcher2/dy;->getString(I)Ljava/lang/String;

    move-result-object v7

    const/4 v8, 0x0

    invoke-virtual {v2, v8}, Lcom/android/launcher2/dy;->getString(I)Ljava/lang/String;
    ...
    invoke-virtual {v2, v9, v10}, Lcom/android/launcher2/dy;->getBoolean(IZ)Z
    ...
    iget-object v7, p0, Lcom/android/launcher2/ck;->mContext:Landroid/content/Context;
...
.method public d(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    invoke-direct {p0, p1}, Lcom/android/launcher2/ck;->e(Landroid/database/sqlite/SQLiteDatabase;)J
...
.method public jF()J
    ...
    iget-wide v0, p0, Lcom/android/launcher2/ck;->adH:J
    ...
    invoke-virtual {p0}, Lcom/android/launcher2/ck;->getWritableDatabase()Landroid/database/sqlite/SQLiteDatabase;

    move-result-object v0

    invoke-direct {p0, v0}, Lcom/android/launcher2/ck;->e(Landroid/database/sqlite/SQLiteDatabase;)J
...
.method public onCreate(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    :cond_0
    invoke-direct {p0, p1}, Lcom/android/launcher2/ck;->f(Landroid/database/sqlite/SQLiteDatabase;)I

    invoke-direct {p0, p1}, Lcom/android/launcher2/ck;->c(Landroid/database/sqlite/SQLiteDatabase;)V
...
.method public onUpgrade(Landroid/database/sqlite/SQLiteDatabase;II)V
    ...
    invoke-direct {p0, p1, v0}, Lcom/android/launcher2/ck;->a(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p1}, Lcom/android/launcher2/ck;->onCreate(Landroid/database/sqlite/SQLiteDatabase;)V
