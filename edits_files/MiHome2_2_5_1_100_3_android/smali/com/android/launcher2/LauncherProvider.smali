...
# static fields
.field static final Cy:Landroid/net/Uri;


# instance fields
.field private CA:Ljava/util/ArrayList;

.field private Cz:Lcom/android/launcher2/ck;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/launcher2/LauncherProvider;->Cy:Landroid/net/Uri;
...
.method private a(Landroid/database/sqlite/SQLiteDatabase;)Ljava/util/ArrayList;
    ...
    iget-object v0, p0, Lcom/android/launcher2/LauncherProvider;->CA:Ljava/util/ArrayList;

    if-nez v0, :cond_0

    invoke-static {p1}, Lcom/android/launcher2/bC;->a(Landroid/database/sqlite/SQLiteDatabase;)Ljava/util/ArrayList;

    move-result-object v0

    iput-object v0, p0, Lcom/android/launcher2/LauncherProvider;->CA:Ljava/util/ArrayList;
...
.method private jE()V
    ...
    iget-object v0, p0, Lcom/android/launcher2/LauncherProvider;->Cz:Lcom/android/launcher2/ck;

    if-eqz v0, :cond_0

    iget-object v0, p0, Lcom/android/launcher2/LauncherProvider;->Cz:Lcom/android/launcher2/ck;

    invoke-virtual {v0}, Lcom/android/launcher2/ck;->close()V
...
.method private static x(Landroid/content/Context;Ljava/lang/String;)Ljava/util/List;
    ...
    :cond_3
    invoke-static {}, Lcom/android/launcher2/T;->hy()Z
    ...
    invoke-static {}, Lcom/android/launcher2/T;->hj()Z
...
.method public bulkInsert(Landroid/net/Uri;[Landroid/content/ContentValues;)I
    ...
    iget-object v1, p0, Lcom/android/launcher2/LauncherProvider;->Cz:Lcom/android/launcher2/ck;

    invoke-virtual {v1}, Lcom/android/launcher2/ck;->getWritableDatabase()Landroid/database/sqlite/SQLiteDatabase;
    ...
    iget-object v6, v3, Lcom/android/launcher2/bq;->YY:Ljava/lang/String;
    ...
    invoke-virtual {v0, v4}, Lcom/android/launcher2/ck;->d(Landroid/database/sqlite/SQLiteDatabase;)V
...
.method public call(Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)Landroid/os/Bundle;
    ...
    invoke-virtual {v0}, Lcom/android/launcher2/ck;->getWritableDatabase()Landroid/database/sqlite/SQLiteDatabase;
    ...
    invoke-static {v0, v1, v2}, Lcom/android/launcher2/bC;->b(Landroid/database/sqlite/SQLiteDatabase;J)Z
    ...
    invoke-static {v0}, Lcom/android/launcher2/bC;->aQ(Landroid/content/Context;)V
...
.method public delete(Landroid/net/Uri;Ljava/lang/String;[Ljava/lang/String;)I
    ...
    iget-object v2, p0, Lcom/android/launcher2/LauncherProvider;->Cz:Lcom/android/launcher2/ck;

    invoke-virtual {v2}, Lcom/android/launcher2/ck;->getWritableDatabase()Landroid/database/sqlite/SQLiteDatabase;

    move-result-object v2

    iget-object v3, v0, Lcom/android/launcher2/bq;->YY:Ljava/lang/String;

    iget-object v4, v0, Lcom/android/launcher2/bq;->YZ:Ljava/lang/String;
    ...
    iget-object v3, p0, Lcom/android/launcher2/LauncherProvider;->Cz:Lcom/android/launcher2/ck;

    invoke-virtual {v3, v2}, Lcom/android/launcher2/ck;->d(Landroid/database/sqlite/SQLiteDatabase;)V
...
.method public getType(Landroid/net/Uri;)Ljava/lang/String;
    ...
    iget-object v1, v0, Lcom/android/launcher2/bq;->YZ:Ljava/lang/String;
    ...
    iget-object v0, v0, Lcom/android/launcher2/bq;->YY:Ljava/lang/String;
...
.method public insert(Landroid/net/Uri;Landroid/content/ContentValues;)Landroid/net/Uri;
    ...
    invoke-virtual {v3}, Lcom/android/launcher2/ck;->getWritableDatabase()Landroid/database/sqlite/SQLiteDatabase;

    move-result-object v3

    const-string v4, "favorites"

    iget-object v5, v2, Lcom/android/launcher2/bq;->YY:Ljava/lang/String;
    ...
    invoke-static {v5, v3, v6, p2}, Lcom/android/launcher2/bC;->a(Landroid/content/Context;Landroid/database/sqlite/SQLiteDatabase;Ljava/util/ArrayList;Landroid/content/ContentValues;)Z
    ...
    :cond_1
    :try_start_1
    iget-object v2, v2, Lcom/android/launcher2/bq;->YY:Ljava/lang/String;
    ...
    invoke-static {v0, v3, v2, v5, v6}, Lcom/android/launcher2/bC;->a(Landroid/content/Context;Landroid/database/sqlite/SQLiteDatabase;Ljava/util/ArrayList;J)V
...
.method public jF()J
    ...
    invoke-virtual {v0}, Lcom/android/launcher2/ck;->jF()J
...
.method public onCreate()Z
    ...
    invoke-direct {p0}, Lcom/android/launcher2/LauncherProvider;->jE()V
    ...
    invoke-direct {v0, v1}, Lcom/android/launcher2/ck;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lcom/android/launcher2/LauncherProvider;->Cz:Lcom/android/launcher2/ck;
    ...
    invoke-virtual {v0, p0}, Lcom/android/launcher2/cz;->a(Lcom/android/launcher2/LauncherProvider;)V
...
.method public query(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    ...
    iget-object v1, v2, Lcom/android/launcher2/bq;->YY:Ljava/lang/String;
    ...
    iget-object v3, v2, Lcom/android/launcher2/bq;->YZ:Ljava/lang/String;
...
.method public update(Landroid/net/Uri;Landroid/content/ContentValues;Ljava/lang/String;[Ljava/lang/String;)I
    ...
    invoke-static {v3, v7, v2}, Lcom/android/launcher2/bC;->b(Landroid/content/Context;Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;)V

    :goto_0
    iget-object v2, p0, Lcom/android/launcher2/LauncherProvider;->Cz:Lcom/android/launcher2/ck;

    invoke-virtual {v2, v7}, Lcom/android/launcher2/ck;->d(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    invoke-static {v3, v7, v4, v2, v6}, Lcom/android/launcher2/bC;->a(Landroid/content/Context;Landroid/database/sqlite/SQLiteDatabase;Ljava/util/ArrayList;Ljava/lang/String;Z)V
    ...
    iget-object v10, v6, Lcom/android/launcher2/bq;->YY:Ljava/lang/String;
    ...
    iput-object v2, p0, Lcom/android/launcher2/LauncherProvider;->CA:Ljava/util/ArrayList;
    ...
    invoke-static {v2, v7, v3, v0}, Lcom/android/launcher2/bC;->a(Landroid/content/Context;Landroid/database/sqlite/SQLiteDatabase;Ljava/util/ArrayList;Landroid/content/ContentValues;)Z

    :cond_6
    iget-object v2, v6, Lcom/android/launcher2/bq;->YY:Ljava/lang/String;

    iget-object v3, v6, Lcom/android/launcher2/bq;->YZ:Ljava/lang/String;
