...
.field private VU:Lcom/android/launcher2/aZ;

.field private VV:I

.field private VW:I

.field private VX:Landroid/view/animation/DecelerateInterpolator;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput v0, p0, Lcom/android/launcher2/DragLayer;->VK:F

    iput v1, p0, Lcom/android/launcher2/DragLayer;->VL:I

    iput v1, p0, Lcom/android/launcher2/DragLayer;->VM:I

    iput v1, p0, Lcom/android/launcher2/DragLayer;->VN:I

    iput-boolean v1, p0, Lcom/android/launcher2/DragLayer;->VO:Z

    iput-boolean v2, p0, Lcom/android/launcher2/DragLayer;->VP:Z

    const/16 v0, 0x28

    iput v0, p0, Lcom/android/launcher2/DragLayer;->VR:I

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lcom/android/launcher2/DragLayer;->VT:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, Lcom/android/launcher2/DragLayer;->VX:Landroid/view/animation/DecelerateInterpolator;
    ...
    iput-object v0, p0, Lcom/android/launcher2/DragLayer;->VY:Ljava/lang/Runnable;

    iput-boolean v2, p0, Lcom/android/launcher2/DragLayer;->VZ:Z
    ...
    iput-object v0, p0, Lcom/android/launcher2/DragLayer;->VS:Landroid/graphics/Paint;
    ...
    iget v1, p0, Lcom/android/launcher2/DragLayer;->VR:I
...
.method private a(Landroid/view/MotionEvent;Z)Z
    ...
    iget-object v0, p0, Lcom/android/launcher2/DragLayer;->VT:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, Lcom/android/launcher2/DragLayer;->VU:Lcom/android/launcher2/aZ;

    iput v3, p0, Lcom/android/launcher2/DragLayer;->VV:I

    iput v4, p0, Lcom/android/launcher2/DragLayer;->VW:I
...
.method public a(Landroid/view/View;FFFFFFFFILandroid/view/animation/Interpolator;Landroid/view/animation/Interpolator;Ljava/lang/Runnable;)V
    ...
    iget-object v4, p0, Lcom/android/launcher2/DragLayer;->VX:Landroid/view/animation/DecelerateInterpolator;
    ...
    :cond_1
    iget-object v1, p0, Lcom/android/launcher2/DragLayer;->VX:Landroid/view/animation/DecelerateInterpolator;
...
.method public a(Lcom/android/launcher2/df;Lcom/android/launcher2/V;Lcom/android/launcher2/CellLayout;)V
    .locals 7
    ...
    invoke-direct/range {v0 .. v5}, Lcom/android/launcher2/aZ;-><init>(Landroid/content/Context;Lcom/android/launcher2/df;Lcom/android/launcher2/V;Lcom/android/launcher2/CellLayout;Lcom/android/launcher2/DragLayer;)V
    ...
    iput-boolean v2, v1, Lcom/android/launcher2/Y;->yG:Z
    ...
    iget-object v1, p0, Lcom/android/launcher2/DragLayer;->VT:Ljava/util/ArrayList;
...
.method public a(Lcom/android/launcher2/dz;Landroid/view/View;ILjava/lang/Runnable;)V
    .locals 19
    ...
    :cond_0
    invoke-virtual/range {p1 .. p1}, Lcom/android/launcher2/dz;->xH()V
    ...
    invoke-direct {v0, v1, v2, v3, v4}, Lcom/android/launcher2/r;-><init>(Lcom/android/launcher2/DragLayer;Landroid/view/View;Ljava/lang/Runnable;Lcom/android/launcher2/dz;)V
    ...
    instance-of v5, v0, Lcom/android/launcher2/dh;

    if-eqz v5, :cond_2

    move-object/from16 v5, p2

    check-cast v5, Lcom/android/launcher2/dh;

    invoke-virtual {v5}, Lcom/android/launcher2/dh;->wA()Z
    ...
    invoke-virtual {v5, v7}, Lcom/android/launcher2/dh;->aM(Z)V
    ...
    :cond_3
    invoke-virtual/range {p1 .. p1}, Lcom/android/launcher2/dz;->getTranslationX()F

    move-result v7

    invoke-virtual/range {p1 .. p1}, Lcom/android/launcher2/dz;->getTranslationY()F
    ...
    invoke-virtual/range {p1 .. p1}, Lcom/android/launcher2/dz;->getAlpha()F

    move-result v11

    const/high16 v12, 0x3f80

    invoke-virtual/range {p1 .. p1}, Lcom/android/launcher2/dz;->getScaleX()F
...
.method public a(Lcom/android/launcher2/dz;Landroid/view/View;Ljava/lang/Runnable;)V
    .locals 1

    const/4 v0, -0x1

    invoke-virtual {p0, p1, p2, v0, p3}, Lcom/android/launcher2/DragLayer;->a(Lcom/android/launcher2/dz;Landroid/view/View;ILjava/lang/Runnable;)V

    return-void
.end method

.method public a(Lcom/android/launcher2/dz;Ljava/lang/Runnable;)V
    .locals 0

    invoke-virtual {p1}, Lcom/android/launcher2/dz;->xH()V
    ...
    :cond_0
    invoke-virtual {p1}, Lcom/android/launcher2/dz;->remove()V
...
.method public at(Z)V
    ...
    iput-boolean p1, p0, Lcom/android/launcher2/DragLayer;->VZ:Z
...
.method public b(FFFF)Z
    ...
    iget-boolean v0, p0, Lcom/android/launcher2/DragLayer;->VP:Z
    ...
    iput p1, p0, Lcom/android/launcher2/DragLayer;->VH:F

    iput p2, p0, Lcom/android/launcher2/DragLayer;->VI:F

    iput p3, p0, Lcom/android/launcher2/DragLayer;->VJ:F

    iput p4, p0, Lcom/android/launcher2/DragLayer;->VK:F
...
.method public c(FFFF)Z
    ...
    iget v0, p0, Lcom/android/launcher2/DragLayer;->VK:F
    ...
    invoke-direct/range {v0 .. v9}, Lcom/android/launcher2/cL;-><init>(Lcom/android/launcher2/DragLayer;FFFFFFFF)V
...
.method public d(Landroid/graphics/Canvas;)V
    ...
    invoke-virtual {p0}, Lcom/android/launcher2/DragLayer;->qv()V
    ...
    invoke-virtual {p0}, Lcom/android/launcher2/DragLayer;->qs()V
...
.method protected dispatchDraw(Landroid/graphics/Canvas;)V
    ...
    iget-object v0, p0, Lcom/android/launcher2/DragLayer;->VG:Landroid/graphics/Bitmap;

    if-eqz v0, :cond_0

    iget-object v0, p0, Lcom/android/launcher2/DragLayer;->VG:Landroid/graphics/Bitmap;

    iget v1, p0, Lcom/android/launcher2/DragLayer;->VN:I
    ...
    iget-object v3, p0, Lcom/android/launcher2/DragLayer;->VS:Landroid/graphics/Paint;
    ...
    iget-boolean v0, p0, Lcom/android/launcher2/DragLayer;->VZ:Z

    if-eqz v0, :cond_1

    iget-object v0, p0, Lcom/android/launcher2/DragLayer;->O:Lcom/android/launcher2/Launcher;

    invoke-virtual {v0}, Lcom/android/launcher2/Launcher;->mU()Z
    ...
    invoke-virtual {v0}, Lcom/android/launcher2/Launcher;->mE()Z
    ...
    invoke-virtual {v0}, Lcom/android/launcher2/Launcher;->mz()V

    const/4 v0, 0x0

    iput-boolean v0, p0, Lcom/android/launcher2/DragLayer;->VZ:Z
...
.method public dispatchTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v0}, Lcom/android/launcher2/Launcher;->mB()Z
    ...
    invoke-virtual {v0}, Lcom/android/launcher2/Launcher;->mA()V
...
.method public invalidateChildInParent([ILandroid/graphics/Rect;)Landroid/view/ViewParent;
    ...
    iput-boolean v0, p0, Lcom/android/launcher2/DragLayer;->VO:Z
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v1, p0, Lcom/android/launcher2/DragLayer;->VQ:[F
    ...
    iput-object v1, p0, Lcom/android/launcher2/DragLayer;->VQ:[F

    :cond_1
    :goto_1
    invoke-virtual {p0}, Lcom/android/launcher2/DragLayer;->qx()V
    ...
    invoke-virtual {v1}, Lcom/android/launcher2/Launcher;->mF()Z
    ...
    invoke-virtual {v1}, Lcom/android/launcher2/Launcher;->mo()Z
    ...
    invoke-virtual {v1}, Lcom/android/launcher2/Launcher;->ml()Z
    ...
    invoke-virtual {v1}, Lcom/android/launcher2/Launcher;->mn()Z
    ...
    iget-object v2, p0, Lcom/android/launcher2/DragLayer;->VQ:[F

    aget v2, v2, v3

    sub-float/2addr v1, v2

    iget v2, p0, Lcom/android/launcher2/DragLayer;->VR:I
    ...
    invoke-virtual {v1}, Lcom/android/launcher2/Launcher;->mT()Z
    ...
    invoke-virtual {v1}, Lcom/android/launcher2/Workspace;->wI()Z

    move-result v1

    if-eqz v1, :cond_1

    iput-object v4, p0, Lcom/android/launcher2/DragLayer;->VQ:[F
    ...
    invoke-virtual {v1}, Lcom/android/launcher2/Launcher;->mp()V
    ...
    invoke-virtual {v1}, Lcom/android/launcher2/Launcher;->mw()V

    goto/16 :goto_0

    :cond_4
    iget-object v0, p0, Lcom/android/launcher2/DragLayer;->VQ:[F
...
.method protected onLayout(ZIIII)V
    ...
    iget-boolean v4, v0, Lcom/android/launcher2/Y;->yG:Z
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    :cond_1
    iget-object v5, p0, Lcom/android/launcher2/DragLayer;->VU:Lcom/android/launcher2/aZ;
    ...
    :pswitch_0
    iget-object v1, p0, Lcom/android/launcher2/DragLayer;->VU:Lcom/android/launcher2/aZ;

    iget v2, p0, Lcom/android/launcher2/DragLayer;->VV:I

    sub-int v2, v3, v2

    iget v3, p0, Lcom/android/launcher2/DragLayer;->VW:I
    ...
    iput-object v1, p0, Lcom/android/launcher2/DragLayer;->VU:Lcom/android/launcher2/aZ;
...
.method public qs()V
    ...
    iput-boolean v3, p0, Lcom/android/launcher2/DragLayer;->VP:Z
    ...
    iput v2, p0, Lcom/android/launcher2/DragLayer;->VJ:F
    ...
    iput-object v0, p0, Lcom/android/launcher2/DragLayer;->VG:Landroid/graphics/Bitmap;
    ...
    iget v2, p0, Lcom/android/launcher2/DragLayer;->VL:I
    ...
    :cond_3
    sget-boolean v0, Lmiui/mihome/c/b;->AL:Z
    ...
    :cond_6
    iput-boolean v1, p0, Lcom/android/launcher2/DragLayer;->VP:Z
...
.method public qv()V
    ...
    iget v1, p0, Lcom/android/launcher2/DragLayer;->VL:I
...
.method public qw()V
    ...
    iget v1, p0, Lcom/android/launcher2/DragLayer;->VH:F
    ...
    iget v2, p0, Lcom/android/launcher2/DragLayer;->VJ:F

    iget v3, p0, Lcom/android/launcher2/DragLayer;->VK:F
    ...
    :cond_0
    iget-object v0, p0, Lcom/android/launcher2/DragLayer;->VY:Ljava/lang/Runnable;
    ...
    :cond_1
    iget v0, p0, Lcom/android/launcher2/DragLayer;->VL:I
    ...
    iget v1, p0, Lcom/android/launcher2/DragLayer;->VJ:F
    ...
    :cond_2
    iput v0, p0, Lcom/android/launcher2/DragLayer;->VN:I
