...
.field private ni:Lmiui/mihome/resourcebrowser/view/ResourceOperationHandler;

.field private nj:Landroid/widget/TextView;

.field private nk:Lcom/android/thememanager/view/FixedHeightGridView;
...
.method private a(Lmiui/mihome/resourcebrowser/view/ResourceOperationView;)Lcom/android/thememanager/util/m;
    .locals 2

    new-instance v0, Lcom/android/thememanager/activity/I;

    iget-object v1, p0, Lcom/android/thememanager/activity/ThemeComponentApplyActivity;->jH:Lmiui/mihome/resourcebrowser/ResourceContext;
...
.method static synthetic a(Lcom/android/thememanager/activity/ThemeComponentApplyActivity;)V
    ...
    invoke-direct {p0}, Lcom/android/thememanager/activity/ThemeComponentApplyActivity;->dE()V
...
.method static synthetic a(Lcom/android/thememanager/activity/ThemeComponentApplyActivity;Z)V
    ...
    invoke-direct {p0, p1}, Lcom/android/thememanager/activity/ThemeComponentApplyActivity;->x(Z)V
...
.method private dC()V
    ...
    iput-object v0, p0, Lcom/android/thememanager/activity/ThemeComponentApplyActivity;->nk:Lcom/android/thememanager/view/FixedHeightGridView;

    iget-object v6, p0, Lcom/android/thememanager/activity/ThemeComponentApplyActivity;->nk:Lcom/android/thememanager/view/FixedHeightGridView;

    new-instance v0, Lcom/android/thememanager/activity/f;

    invoke-direct {p0}, Lcom/android/thememanager/activity/ThemeComponentApplyActivity;->dD()J

    move-result-wide v2

    iget-object v1, p0, Lcom/android/thememanager/activity/ThemeComponentApplyActivity;->ni:Lmiui/mihome/resourcebrowser/view/ResourceOperationHandler;

    invoke-virtual {v1}, Lmiui/mihome/resourcebrowser/view/ResourceOperationHandler;->gC()Z

    move-result v4

    iget-object v5, p0, Lcom/android/thememanager/activity/ThemeComponentApplyActivity;->nk:Lcom/android/thememanager/view/FixedHeightGridView;
    ...
    iget-object v0, p0, Lcom/android/thememanager/activity/ThemeComponentApplyActivity;->nk:Lcom/android/thememanager/view/FixedHeightGridView;
...
.method private dD()J
    ...
    iget-object v0, p0, Lcom/android/thememanager/activity/ThemeComponentApplyActivity;->hh:Lmiui/mihome/resourcebrowser/model/Resource;
    ...
    invoke-static {}, Lcom/android/thememanager/util/c;->cu()J

    move-result-wide v0

    :cond_0
    sget-wide v3, Lcom/android/thememanager/util/c;->iP:J
...
.method private dE()V
    ...
    iput-object v0, p0, Lcom/android/thememanager/activity/ThemeComponentApplyActivity;->nj:Landroid/widget/TextView;
    ...
    invoke-virtual {v0}, Lcom/android/thememanager/activity/f;->dy()J
    ...
    iget-object v1, p0, Lcom/android/thememanager/activity/ThemeComponentApplyActivity;->nj:Landroid/widget/TextView;
...
.method private dF()J
    ...
    iget-wide v3, p0, Lcom/android/thememanager/activity/ThemeComponentApplyActivity;->aF:J
...
.method private dG()Lcom/android/thememanager/util/ThemeApplyParameters;
    .locals 3
    ...
    invoke-direct {p0}, Lcom/android/thememanager/activity/ThemeComponentApplyActivity;->dF()J

    move-result-wide v1

    iput-wide v1, v0, Lcom/android/thememanager/util/ThemeApplyParameters;->applyFlags:J

    invoke-direct {p0}, Lcom/android/thememanager/activity/ThemeComponentApplyActivity;->dw()Z
...
.method private dw()Z
    ...
    iget-wide v0, p0, Lcom/android/thememanager/activity/ThemeComponentApplyActivity;->aF:J
    ...
    invoke-virtual {v0}, Lcom/android/thememanager/activity/f;->dw()Z
...
.method private w()V
    ...
    invoke-virtual {p0}, Lcom/android/thememanager/activity/ThemeComponentApplyActivity;->gp()Lcom/actionbarsherlock/b/f;
    ...
    iget-object v1, p0, Lcom/android/thememanager/activity/ThemeComponentApplyActivity;->hh:Lmiui/mihome/resourcebrowser/model/Resource;
    ...
    invoke-virtual {v0, v1}, Lmiui/mihome/resourcebrowser/view/ResourceOperationView;->aY(I)V

    invoke-virtual {v0, p0}, Lmiui/mihome/resourcebrowser/view/ResourceOperationView;->a(Lmiui/mihome/resourcebrowser/view/q;)V

    invoke-direct {p0, v0}, Lcom/android/thememanager/activity/ThemeComponentApplyActivity;->a(Lmiui/mihome/resourcebrowser/view/ResourceOperationView;)Lcom/android/thememanager/util/m;

    move-result-object v0

    iput-object v0, p0, Lcom/android/thememanager/activity/ThemeComponentApplyActivity;->ni:Lmiui/mihome/resourcebrowser/view/ResourceOperationHandler;

    iget-object v0, p0, Lcom/android/thememanager/activity/ThemeComponentApplyActivity;->ni:Lmiui/mihome/resourcebrowser/view/ResourceOperationHandler;
    ...
    invoke-direct {p0}, Lcom/android/thememanager/activity/ThemeComponentApplyActivity;->dC()V
...
.method public dH()V
    ...
    check-cast v0, Lcom/android/thememanager/util/m;

    invoke-direct {p0}, Lcom/android/thememanager/activity/ThemeComponentApplyActivity;->dG()Lcom/android/thememanager/util/ThemeApplyParameters;

    move-result-object v1

    invoke-virtual {v0, v1}, Lcom/android/thememanager/util/m;->a(Lcom/android/thememanager/util/ThemeApplyParameters;)V
...
.method public dL()V
    ...
    iget v0, p0, Lcom/android/thememanager/activity/ThemeComponentApplyActivity;->nh:I
    ...
    invoke-direct {p0, v0}, Lcom/android/thememanager/activity/ThemeComponentApplyActivity;->x(Z)V
...
.method public finish()V
    ...
    invoke-super {p0}, Lmiui/mihome/resourcebrowser/activity/S;->finish()V
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, Lcom/android/thememanager/activity/ThemeComponentApplyActivity;->jH:Lmiui/mihome/resourcebrowser/ResourceContext;
    ...
    iput-object v0, p0, Lcom/android/thememanager/activity/ThemeComponentApplyActivity;->hh:Lmiui/mihome/resourcebrowser/model/Resource;

    iget-object v0, p0, Lcom/android/thememanager/activity/ThemeComponentApplyActivity;->hh:Lmiui/mihome/resourcebrowser/model/Resource;

    if-eqz v0, :cond_0

    iget-object v0, p0, Lcom/android/thememanager/activity/ThemeComponentApplyActivity;->jH:Lmiui/mihome/resourcebrowser/ResourceContext;
    ...
    iput-wide v2, p0, Lcom/android/thememanager/activity/ThemeComponentApplyActivity;->aF:J
    ...
    iput v0, p0, Lcom/android/thememanager/activity/ThemeComponentApplyActivity;->nh:I
