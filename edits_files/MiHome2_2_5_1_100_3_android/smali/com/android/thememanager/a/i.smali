...
.field private amV:Ljava/lang/Object;
...
.method public constructor <init>(Lcom/android/thememanager/a/h;Lmiui/mihome/resourcebrowser/controller/f;)V
    ...
    iput-object v0, p0, Lcom/android/thememanager/a/i;->amV:Ljava/lang/Object;
...
.method private c(Lmiui/mihome/resourcebrowser/util/ResourceImportHandler$ResourceForImport;)V
    ...
    invoke-virtual {p0, v0}, Lcom/android/thememanager/a/i;->dO(Ljava/lang/String;)Ljava/lang/String;
...
.method private vY()Z
    ...
    invoke-virtual {v6, v0}, Lcom/android/thememanager/a/h;->m(Lmiui/mihome/resourcebrowser/model/Resource;)Z
    ...
    invoke-virtual {v3}, Lmiui/mihome/resourcebrowser/controller/f;->vL()Lmiui/mihome/resourcebrowser/controller/b;

    move-result-object v3

    invoke-virtual {v3, v0}, Lmiui/mihome/resourcebrowser/controller/b;->t(Lmiui/mihome/resourcebrowser/model/Resource;)Z
    ...
    invoke-virtual {p0, v4}, Lcom/android/thememanager/a/i;->dN(Ljava/lang/String;)Ljava/lang/String;
    ...
    :goto_3
    invoke-direct {p0}, Lcom/android/thememanager/a/i;->vZ()V
...
.method private vZ()V
    ...
    iput v1, v0, Lcom/android/thememanager/a/g;->Th:I
...
.method private wa()V
    ...
    invoke-virtual {v3, v0}, Lcom/android/thememanager/a/h;->m(Lmiui/mihome/resourcebrowser/model/Resource;)Z
...
# virtual methods
.method public V(Lmiui/mihome/resourcebrowser/model/Resource;)V
    .locals 3
...
.method public dN(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p1}, Lmiui/mihome/resourcebrowser/util/ResourceHelper;->db(Ljava/lang/String;)Ljava/lang/String;
...
.method protected fk()V
    ...
    invoke-virtual {v3, v4}, Lcom/android/thememanager/a/h;->m(Lmiui/mihome/resourcebrowser/model/Resource;)Z
...
.method protected fl()V
    ...
    invoke-super {p0}, Lmiui/mihome/resourcebrowser/util/k;->fl()V
...
.method protected fm()Z
    ...
    iget-object v1, p0, Lcom/android/thememanager/a/i;->amV:Ljava/lang/Object;

    monitor-enter v1

    :try_start_0
    iget-boolean v2, p0, Lcom/android/thememanager/a/i;->amU:Z

    if-eqz v2, :cond_0

    const/4 v0, 0x0

    iput-boolean v0, p0, Lcom/android/thememanager/a/i;->amU:Z
...
.method protected fn()V
    ...
    :cond_0
    invoke-direct {p0}, Lcom/android/thememanager/a/i;->vY()Z
...
.method protected fo()V
    ...
    invoke-super {p0}, Lmiui/mihome/resourcebrowser/util/k;->fo()V

    return-void
.end method

.method protected fq()Ljava/lang/String;
    .locals 1
...
.method protected kf()V
    ...
    invoke-direct {p0}, Lcom/android/thememanager/a/i;->wa()V

    invoke-super {p0}, Lmiui/mihome/resourcebrowser/util/k;->kf()V
