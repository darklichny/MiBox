...
# static fields
.field public static XQ:Ljava/lang/String;

.field private static XS:Lcom/android/thememanager/a/h;

.field public static XV:Ljava/lang/String;

.field public static XW:Ljava/lang/String;


# instance fields
.field protected XR:Lcom/android/thememanager/a/c;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/thememanager/a/h;->XQ:Ljava/lang/String;

    const-string v0, "result"

    sput-object v0, Lcom/android/thememanager/a/h;->XV:Ljava/lang/String;

    const-string v0, "localId"

    sput-object v0, Lcom/android/thememanager/a/h;->XW:Ljava/lang/String;
...
.method protected constructor <init>(Lmiui/mihome/resourcebrowser/ResourceContext;)V
    ...
    iput-object v0, p0, Lcom/android/thememanager/a/h;->XT:Landroid/content/Context;
...
.method static synthetic a(Lcom/android/thememanager/a/h;)Lmiui/mihome/resourcebrowser/controller/f;
    ...
    iget-object v0, p0, Lcom/android/thememanager/a/h;->ag:Lmiui/mihome/resourcebrowser/controller/f;
...
.method static synthetic a(Lcom/android/thememanager/a/h;Z)Z
    ...
    iput-boolean p1, p0, Lcom/android/thememanager/a/h;->XU:Z
...
.method static synthetic c(Lcom/android/thememanager/a/h;)V
    ...
    invoke-virtual {p0}, Lcom/android/thememanager/a/h;->bO()V
...
.method static synthetic d(Lcom/android/thememanager/a/h;)V
    ...
    invoke-virtual {p0}, Lcom/android/thememanager/a/h;->bg()V
...
.method static synthetic e(Lcom/android/thememanager/a/h;)Lmiui/mihome/resourcebrowser/ResourceContext;
    ...
    iget-object v0, p0, Lcom/android/thememanager/a/h;->af:Lmiui/mihome/resourcebrowser/ResourceContext;
...
.method static synthetic n(Lcom/android/thememanager/a/h;)Lmiui/mihome/resourcebrowser/util/v;
    ...
    iget-object v0, p0, Lcom/android/thememanager/a/h;->hP:Lmiui/mihome/resourcebrowser/util/v;
...
.method public static qY()Lcom/android/thememanager/a/h;
    .locals 4

    sget-object v0, Lcom/android/thememanager/a/h;->XS:Lcom/android/thememanager/a/h;
    ...
    sput-object v2, Lcom/android/thememanager/a/h;->XS:Lcom/android/thememanager/a/h;
...
.method static synthetic t(Lcom/android/thememanager/a/h;)Landroid/content/Context;
    ...
    iget-object v0, p0, Lcom/android/thememanager/a/h;->XT:Landroid/content/Context;
...
# virtual methods
.method public G(Lmiui/mihome/resourcebrowser/model/Resource;)V
    .locals 1

    iget-object v0, p0, Lcom/android/thememanager/a/h;->hW:Lmiui/mihome/resourcebrowser/util/k;

    check-cast v0, Lcom/android/thememanager/a/i;

    invoke-virtual {v0, p1}, Lcom/android/thememanager/a/i;->V(Lmiui/mihome/resourcebrowser/model/Resource;)V
...
.method public aI(Landroid/content/Context;)V
    ...
    invoke-virtual {v0}, Lcom/android/thememanager/a/i;->vX()V

    const/4 v0, 0x1

    invoke-virtual {p0, v0}, Lcom/android/thememanager/a/h;->q(Z)V
...
.method public aZ()Ljava/util/List;
    ...
    invoke-virtual {v0}, Lmiui/mihome/resourcebrowser/util/k;->fr()Ljava/util/List;
...
.method protected bN()Lmiui/mihome/resourcebrowser/util/v;
    .locals 1
...
.method protected bS()Ljava/util/List;
    .locals 4

    const/4 v3, 0x0

    invoke-super {p0}, Lmiui/mihome/resourcebrowser/util/ResourceImportHandler;->bS()Ljava/util/List;

    move-result-object v0

    new-instance v1, Lcom/android/thememanager/a/c;

    iget-object v2, p0, Lcom/android/thememanager/a/h;->ag:Lmiui/mihome/resourcebrowser/controller/f;
    ...
    iput-object v1, p0, Lcom/android/thememanager/a/h;->XR:Lcom/android/thememanager/a/c;

    iget-object v1, p0, Lcom/android/thememanager/a/h;->XR:Lcom/android/thememanager/a/c;
...
.method protected bU()Lmiui/mihome/resourcebrowser/util/k;
    .locals 2

    new-instance v0, Lcom/android/thememanager/a/i;

    iget-object v1, p0, Lcom/android/thememanager/a/h;->ag:Lmiui/mihome/resourcebrowser/controller/f;
...
.method public cA(Ljava/lang/String;)Z
    ...
    invoke-virtual {p0, v0}, Lcom/android/thememanager/a/h;->C(Ljava/lang/String;)Z
...
.method public d(Landroid/content/Context;Ljava/lang/String;Z)V
    ...
    invoke-virtual {p0, v0}, Lcom/android/thememanager/a/h;->m(Lmiui/mihome/resourcebrowser/model/Resource;)Z

    move-result v0

    if-nez v0, :cond_1

    invoke-virtual {p0, v3}, Lcom/android/thememanager/a/h;->r(Z)Z
    ...
    iget-object v1, p0, Lcom/android/thememanager/a/h;->af:Lmiui/mihome/resourcebrowser/ResourceContext;
    ...
    invoke-virtual {p0, v0}, Lcom/android/thememanager/a/h;->cB(Ljava/lang/String;)V

    iget-object v0, p0, Lcom/android/thememanager/a/h;->XR:Lcom/android/thememanager/a/c;

    invoke-virtual {v0, p3}, Lcom/android/thememanager/a/c;->S(Z)V
...
.method public qX()Z
    ...
    iget-boolean v0, p0, Lcom/android/thememanager/a/h;->XU:Z
...
.method public qZ()V
    ...
    iget-object v1, p0, Lcom/android/thememanager/a/h;->hP:Lmiui/mihome/resourcebrowser/util/v;
    ...
    iget-object v0, v0, Lmiui/mihome/resourcebrowser/util/v;->Rz:Ljava/lang/String;
...
.method public ra()I
    ...
    iget v0, v0, Lcom/android/thememanager/a/g;->Th:I
