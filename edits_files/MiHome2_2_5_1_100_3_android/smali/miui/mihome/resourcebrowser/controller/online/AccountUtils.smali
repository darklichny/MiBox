...
# static fields
.field private static yk:J

.field private static yl:Landroid/util/Pair;
...
.method public static P(Z)Landroid/util/Pair;
    ...
    invoke-static {}, Lmiui/mihome/resourcebrowser/controller/online/AccountUtils;->hN()Z
    ...
    :cond_1
    invoke-static {}, Lmiui/mihome/resourcebrowser/controller/online/AccountUtils;->hP()Landroid/util/Pair;

    move-result-object v0

    sput-object v0, Lmiui/mihome/resourcebrowser/controller/online/AccountUtils;->yl:Landroid/util/Pair;

    sget-object v0, Lmiui/mihome/resourcebrowser/controller/online/AccountUtils;->yl:Landroid/util/Pair;
    ...
    sput-wide v2, Lmiui/mihome/resourcebrowser/controller/online/AccountUtils;->yk:J
...
.method public static a(Landroid/app/Activity;Lmiui/mihome/resourcebrowser/controller/online/H;)V
    ...
    sget-object v1, Lmiui/mihome/resourcebrowser/controller/online/L;->alB:Ljava/lang/String;
...
.method private static hN()Z
    ...
    sget-wide v2, Lmiui/mihome/resourcebrowser/controller/online/AccountUtils;->yk:J
...
.method public static hO()Landroid/util/Pair;
    .locals 1
...
.method private static hP()Landroid/util/Pair;
    .locals 4
    ...
    invoke-virtual {v1}, Lcom/xiaomi/xmsf/account/a;->kj()Landroid/accounts/Account;
    ...
    :try_start_0
    sget-object v3, Lmiui/mihome/resourcebrowser/controller/online/L;->alB:Ljava/lang/String;
    ...
    invoke-virtual {v1, v3}, Lcom/xiaomi/xmsf/account/a;->bw(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v1

    invoke-static {v1}, Lmiui/mihome/net/i;->cs(Ljava/lang/String;)Lmiui/mihome/net/i;

    move-result-object v1

    if-eqz v1, :cond_0

    iget-object v3, v1, Lmiui/mihome/net/i;->RH:Ljava/lang/String;

    if-eqz v3, :cond_0

    iget-object v3, v1, Lmiui/mihome/net/i;->Dd:Ljava/lang/String;
