...
# instance fields
.field private RX:Lmiui/mihome/resourcebrowser/controller/online/J;

.field private RY:Lmiui/mihome/resourcebrowser/controller/online/f;

.field private RZ:Lmiui/mihome/resourcebrowser/controller/online/G;

.field private Sa:Ljava/util/UUID;

.field protected Sb:J
...
.method public constructor <init>(Ljava/lang/String;Ljava/util/UUID;)V
    ...
    iput-object v0, p0, Lmiui/mihome/resourcebrowser/controller/online/x;->RY:Lmiui/mihome/resourcebrowser/controller/online/f;

    iput-object p2, p0, Lmiui/mihome/resourcebrowser/controller/online/x;->Sa:Ljava/util/UUID;
...
.method public static d(Ljava/nio/ByteBuffer;)Lmiui/mihome/resourcebrowser/controller/online/x;
    ...
    invoke-virtual {v0}, Lmiui/mihome/resourcebrowser/controller/online/x;->bi()V

    invoke-virtual {p0, v1}, Ljava/nio/ByteBuffer;->position(I)Ljava/nio/Buffer;

    iget-wide v1, v0, Lmiui/mihome/resourcebrowser/controller/online/x;->Sb:J
    ...
    iget-object v4, v0, Lmiui/mihome/resourcebrowser/controller/online/x;->RY:Lmiui/mihome/resourcebrowser/controller/online/f;

    invoke-virtual {v4}, Lmiui/mihome/resourcebrowser/controller/online/f;->tE()J
...
.method public static p(Ljava/io/File;)Ljava/nio/ByteBuffer;
    .locals 7
...
.method public bi()V
    ...
    iget-object v0, p0, Lmiui/mihome/resourcebrowser/controller/online/x;->RX:Lmiui/mihome/resourcebrowser/controller/online/J;
    ...
    iput-object v0, p0, Lmiui/mihome/resourcebrowser/controller/online/x;->RX:Lmiui/mihome/resourcebrowser/controller/online/J;

    iget-object v0, p0, Lmiui/mihome/resourcebrowser/controller/online/x;->RX:Lmiui/mihome/resourcebrowser/controller/online/J;

    invoke-virtual {v0}, Lmiui/mihome/resourcebrowser/controller/online/J;->tE()J

    move-result-wide v0

    iput-wide v0, p0, Lmiui/mihome/resourcebrowser/controller/online/x;->Sb:J

    iget-object v0, p0, Lmiui/mihome/resourcebrowser/controller/online/x;->RY:Lmiui/mihome/resourcebrowser/controller/online/f;
    ...
    iget-object v0, p0, Lmiui/mihome/resourcebrowser/controller/online/x;->RZ:Lmiui/mihome/resourcebrowser/controller/online/G;
    ...
    iput-object v0, p0, Lmiui/mihome/resourcebrowser/controller/online/x;->RZ:Lmiui/mihome/resourcebrowser/controller/online/G;

    iget-object v0, p0, Lmiui/mihome/resourcebrowser/controller/online/x;->RZ:Lmiui/mihome/resourcebrowser/controller/online/G;

    invoke-virtual {v0}, Lmiui/mihome/resourcebrowser/controller/online/G;->tE()J
    ...
    iget-object v1, p0, Lmiui/mihome/resourcebrowser/controller/online/x;->RY:Lmiui/mihome/resourcebrowser/controller/online/f;
    ...
    iget-object v0, p0, Lmiui/mihome/resourcebrowser/controller/online/x;->Sa:Ljava/util/UUID;

    invoke-virtual {p0, v0}, Lmiui/mihome/resourcebrowser/controller/online/x;->a(Ljava/util/UUID;)Ljava/util/UUID;

    move-result-object v0

    iput-object v0, p0, Lmiui/mihome/resourcebrowser/controller/online/x;->Sa:Ljava/util/UUID;
    ...
    invoke-virtual {p0}, Lmiui/mihome/resourcebrowser/controller/online/x;->gk()Ljava/nio/ByteBuffer;
...
.method public pJ()Lmiui/mihome/resourcebrowser/controller/online/f;
    .locals 1
