...
# static fields
.field private static adQ:Lmiui/mihome/resourcebrowser/model/Resource;


# instance fields
.field protected adO:Lmiui/mihome/resourcebrowser/util/c;

.field protected adP:Lmiui/mihome/resourcebrowser/util/N;
...
.method public constructor <init>(Lmiui/mihome/resourcebrowser/activity/e;Lmiui/mihome/resourcebrowser/activity/n;Lmiui/mihome/resourcebrowser/ResourceContext;)V
    ...
    invoke-direct {p0, p1, p2, p3}, Lmiui/mihome/resourcebrowser/util/B;-><init>(Lmiui/mihome/resourcebrowser/activity/e;Lmiui/mihome/resourcebrowser/activity/n;Lmiui/mihome/resourcebrowser/ResourceContext;)V
    ...
    iput-object v0, p0, Lmiui/mihome/resourcebrowser/util/G;->adO:Lmiui/mihome/resourcebrowser/util/c;
    ...
    iput-object v0, p0, Lmiui/mihome/resourcebrowser/util/G;->adP:Lmiui/mihome/resourcebrowser/util/N;

    iget-object v0, p0, Lmiui/mihome/resourcebrowser/util/G;->adO:Lmiui/mihome/resourcebrowser/util/c;

    iget-object v1, p0, Lmiui/mihome/resourcebrowser/util/G;->adP:Lmiui/mihome/resourcebrowser/util/N;

    invoke-virtual {v1}, Lmiui/mihome/resourcebrowser/util/N;->uy()Lmiui/mihome/resourcebrowser/util/M;
    ...
    iput-boolean v0, p0, Lmiui/mihome/resourcebrowser/util/G;->Zi:Z

    invoke-direct {p0}, Lmiui/mihome/resourcebrowser/util/G;->sH()V
...
.method private J(Landroid/view/View;)V
    ...
    iget-object v1, p0, Lmiui/mihome/resourcebrowser/util/G;->adO:Lmiui/mihome/resourcebrowser/util/c;

    invoke-virtual {v1, v0}, Lmiui/mihome/resourcebrowser/util/c;->o(Lmiui/mihome/resourcebrowser/model/Resource;)Z

    move-result v1

    iget-object v2, p0, Lmiui/mihome/resourcebrowser/util/G;->adO:Lmiui/mihome/resourcebrowser/util/c;

    invoke-virtual {v2}, Lmiui/mihome/resourcebrowser/util/c;->dd()V

    if-eqz v1, :cond_0

    iget-object v1, p0, Lmiui/mihome/resourcebrowser/util/G;->adO:Lmiui/mihome/resourcebrowser/util/c;

    invoke-virtual {v1, v0}, Lmiui/mihome/resourcebrowser/util/c;->p(Lmiui/mihome/resourcebrowser/model/Resource;)V

    :cond_0
    invoke-direct {p0, v0}, Lmiui/mihome/resourcebrowser/util/G;->S(Lmiui/mihome/resourcebrowser/model/Resource;)Z

    move-result v1

    if-eqz v1, :cond_1

    sput-object v0, Lmiui/mihome/resourcebrowser/util/G;->adQ:Lmiui/mihome/resourcebrowser/model/Resource;

    :goto_0
    iget-object v0, p0, Lmiui/mihome/resourcebrowser/util/G;->adP:Lmiui/mihome/resourcebrowser/util/N;
...
.method private S(Lmiui/mihome/resourcebrowser/model/Resource;)Z
    .locals 1

    iget-boolean v0, p0, Lmiui/mihome/resourcebrowser/util/G;->Zg:Z
...
.method static synthetic a(Lmiui/mihome/resourcebrowser/util/G;Lmiui/mihome/resourcebrowser/model/Resource;)Z
    ...
    invoke-direct {p0, p1}, Lmiui/mihome/resourcebrowser/util/G;->S(Lmiui/mihome/resourcebrowser/model/Resource;)Z
...
.method private sH()V
    ...
    iget-object v0, p0, Lmiui/mihome/resourcebrowser/util/G;->jH:Lmiui/mihome/resourcebrowser/ResourceContext;
...
.method static synthetic sI()Lmiui/mihome/resourcebrowser/model/Resource;
    .locals 1

    sget-object v0, Lmiui/mihome/resourcebrowser/util/G;->adQ:Lmiui/mihome/resourcebrowser/model/Resource;
...
.method protected E(Landroid/view/View;)V
    ...
    invoke-virtual {p0}, Lmiui/mihome/resourcebrowser/util/G;->rn()Z
    ...
    invoke-direct {p0, p1}, Lmiui/mihome/resourcebrowser/util/G;->J(Landroid/view/View;)V

    :goto_0
    return-void

    :cond_0
    invoke-super {p0, p1}, Lmiui/mihome/resourcebrowser/util/B;->E(Landroid/view/View;)V

    goto :goto_0
.end method

.method protected R(Lmiui/mihome/resourcebrowser/model/Resource;)V
    .locals 2
...
.method protected T(Lmiui/mihome/resourcebrowser/model/Resource;)V
    ...
    iget-object v2, p0, Lmiui/mihome/resourcebrowser/util/G;->jH:Lmiui/mihome/resourcebrowser/ResourceContext;
...
.method protected U(Lmiui/mihome/resourcebrowser/model/Resource;)V
    .locals 0

    invoke-virtual {p0, p1}, Lmiui/mihome/resourcebrowser/util/G;->K(Lmiui/mihome/resourcebrowser/model/Resource;)V
...
.method protected a(Landroid/view/View;Landroid/util/Pair;)V
    ...
    invoke-virtual {v0}, Lmiui/mihome/resourcebrowser/util/c;->dd()V
...
.method public b(Landroid/view/View;Landroid/util/Pair;)V
    ...
    invoke-virtual {v0, p1}, Lmiui/mihome/resourcebrowser/util/N;->O(Landroid/view/View;)V
...
.method public rm()V
    ...
    invoke-super {p0}, Lmiui/mihome/resourcebrowser/util/B;->rm()V
