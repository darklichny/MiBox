...
# instance fields
.field protected Zb:Lmiui/mihome/resourcebrowser/activity/e;

.field private Zc:Lcom/actionbarsherlock/a/b;

.field private Zd:Z

.field private Ze:Ljava/util/Set;
...
.field private Zj:Landroid/view/View$OnClickListener;

.field private Zk:Landroid/view/View$OnLongClickListener;

.field private Zl:Lcom/actionbarsherlock/a/a;
...
.method public constructor <init>(Lmiui/mihome/resourcebrowser/activity/e;Lmiui/mihome/resourcebrowser/activity/n;Lmiui/mihome/resourcebrowser/ResourceContext;)V
    ...
    iput-object v0, p0, Lmiui/mihome/resourcebrowser/util/B;->Ze:Ljava/util/Set;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lmiui/mihome/resourcebrowser/util/B;->Zf:Ljava/util/Map;
    ...
    iput-object v0, p0, Lmiui/mihome/resourcebrowser/util/B;->Zj:Landroid/view/View$OnClickListener;
    ...
    iput-object v0, p0, Lmiui/mihome/resourcebrowser/util/B;->Zk:Landroid/view/View$OnLongClickListener;
    ...
    iput-object v0, p0, Lmiui/mihome/resourcebrowser/util/B;->Zl:Lcom/actionbarsherlock/a/a;
    ...
    :cond_1
    iput-object p1, p0, Lmiui/mihome/resourcebrowser/util/B;->Zb:Lmiui/mihome/resourcebrowser/activity/e;

    invoke-virtual {p1}, Lmiui/mihome/resourcebrowser/activity/e;->eV()Landroid/support/v4/app/s;
...
.method private G(Landroid/view/View;)V
    ...
    invoke-virtual {p0}, Lmiui/mihome/resourcebrowser/util/B;->rp()Z
    ...
    iget-boolean v1, p0, Lmiui/mihome/resourcebrowser/util/B;->Zd:Z

    if-eqz v1, :cond_2

    iget-object v1, p0, Lmiui/mihome/resourcebrowser/util/B;->Ze:Ljava/util/Set;
    ...
    :goto_1
    iget-boolean v4, p0, Lmiui/mihome/resourcebrowser/util/B;->Zd:Z

    if-eqz v4, :cond_3

    invoke-virtual {p0, v0}, Lmiui/mihome/resourcebrowser/util/B;->H(Lmiui/mihome/resourcebrowser/model/Resource;)Z
...
.method static synthetic a(Lmiui/mihome/resourcebrowser/util/B;Lcom/actionbarsherlock/a/b;)Lcom/actionbarsherlock/a/b;
    ...
    iput-object p1, p0, Lmiui/mihome/resourcebrowser/util/B;->Zc:Lcom/actionbarsherlock/a/b;
...
.method static synthetic b(Lmiui/mihome/resourcebrowser/util/B;)Ljava/util/Set;
    ...
    iget-object v0, p0, Lmiui/mihome/resourcebrowser/util/B;->Ze:Ljava/util/Set;
...
.method static synthetic c(Lmiui/mihome/resourcebrowser/util/B;)V
    ...
    invoke-direct {p0}, Lmiui/mihome/resourcebrowser/util/B;->rl()V
...
.method protected E(Landroid/view/View;)V
    ...
    invoke-virtual {p0}, Lmiui/mihome/resourcebrowser/util/B;->rm()V
    ...
    invoke-virtual {p0}, Lmiui/mihome/resourcebrowser/util/B;->rk()V
    ...
    :cond_5
    iget-object v1, p0, Lmiui/mihome/resourcebrowser/util/B;->Zb:Lmiui/mihome/resourcebrowser/activity/e;
...
.method protected F(Landroid/view/View;)Z
    ...
    :cond_0
    iget-boolean v3, p0, Lmiui/mihome/resourcebrowser/util/B;->Zg:Z

    if-eqz v3, :cond_2

    iget-object v3, p0, Lmiui/mihome/resourcebrowser/util/B;->jJ:Lmiui/mihome/resourcebrowser/activity/n;

    invoke-virtual {v3}, Lmiui/mihome/resourcebrowser/activity/n;->px()Z
    ...
    iget-boolean v3, p0, Lmiui/mihome/resourcebrowser/util/B;->Zd:Z
    ...
    invoke-virtual {p0, v3}, Lmiui/mihome/resourcebrowser/util/B;->H(Lmiui/mihome/resourcebrowser/model/Resource;)Z
...
.method protected H(Lmiui/mihome/resourcebrowser/model/Resource;)Z
    ...
    invoke-virtual {p0, p1}, Lmiui/mihome/resourcebrowser/util/B;->J(Lmiui/mihome/resourcebrowser/model/Resource;)Z
...
.method protected J(Lmiui/mihome/resourcebrowser/model/Resource;)Z
    .locals 2
...
.method protected K(Lmiui/mihome/resourcebrowser/model/Resource;)V
    .locals 3

    iget-object v0, p0, Lmiui/mihome/resourcebrowser/util/B;->wi:Lmiui/mihome/resourcebrowser/util/f;

    iget-boolean v1, p0, Lmiui/mihome/resourcebrowser/util/B;->Zi:Z
    ...
    iget-object v0, p0, Lmiui/mihome/resourcebrowser/util/B;->Zf:Ljava/util/Map;
...
.method protected L(Lmiui/mihome/resourcebrowser/model/Resource;)Z
    .locals 2
...
.method protected a(Landroid/view/View;Landroid/util/Pair;)V
    ...
    iput-boolean v0, p0, Lmiui/mihome/resourcebrowser/util/B;->Zd:Z
    ...
    iget-object v1, p0, Lmiui/mihome/resourcebrowser/util/B;->Zl:Lcom/actionbarsherlock/a/a;

    invoke-virtual {v0, v1}, Lcom/actionbarsherlock/b/c;->a(Lcom/actionbarsherlock/a/a;)Lcom/actionbarsherlock/a/b;

    move-result-object v0

    iput-object v0, p0, Lmiui/mihome/resourcebrowser/util/B;->Zc:Lcom/actionbarsherlock/a/b;
...
.method public b(Landroid/view/View;Landroid/util/Pair;)V
    ...
    iget-object v0, p0, Lmiui/mihome/resourcebrowser/util/B;->Zj:Landroid/view/View$OnClickListener;

    invoke-virtual {p1, v0}, Landroid/view/View;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    iget-object v0, p0, Lmiui/mihome/resourcebrowser/util/B;->Zk:Landroid/view/View$OnLongClickListener;
...
.method public cb(I)V
    ...
    :goto_0
    iput-boolean v0, p0, Lmiui/mihome/resourcebrowser/util/B;->Zg:Z
...
.method protected rk()V
    ...
    iget-boolean v0, p0, Lmiui/mihome/resourcebrowser/util/B;->Zh:Z
    ...
    iget-object v3, p0, Lmiui/mihome/resourcebrowser/util/B;->Ze:Ljava/util/Set;
    ...
    iget-object v1, p0, Lmiui/mihome/resourcebrowser/util/B;->Zc:Lcom/actionbarsherlock/a/b;
...
.method public rm()V
    ...
    iget-boolean v0, p0, Lmiui/mihome/resourcebrowser/util/B;->Zd:Z
    ...
    iget-object v0, p0, Lmiui/mihome/resourcebrowser/util/B;->Zc:Lcom/actionbarsherlock/a/b;
...
.method public ro()Landroid/view/View$OnClickListener;
    .locals 1
