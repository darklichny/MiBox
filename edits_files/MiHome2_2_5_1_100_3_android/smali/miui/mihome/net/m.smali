...
.method constructor <init>(Lmiui/mihome/net/e;Landroid/app/Activity;Landroid/os/Handler;Lmiui/mihome/net/a;Landroid/os/Bundle;Landroid/accounts/Account;Ljava/lang/String;)V
    ...
    iput-object p5, p0, Lmiui/mihome/net/m;->Un:Landroid/os/Bundle;

    iput-object p6, p0, Lmiui/mihome/net/m;->val$account:Landroid/accounts/Account;

    iput-object p7, p0, Lmiui/mihome/net/m;->Um:Ljava/lang/String;
...
.method protected doWork()V
    ...
    invoke-virtual {p0}, Lmiui/mihome/net/m;->nH()Lmiui/mihome/net/v;
    ...
    iget-object v2, p0, Lmiui/mihome/net/m;->Un:Landroid/os/Bundle;
    ...
    :cond_0
    invoke-virtual {p0}, Lmiui/mihome/net/m;->nG()Lmiui/mihome/net/t;

    move-result-object v2

    iget-object v3, p0, Lmiui/mihome/net/m;->val$account:Landroid/accounts/Account;

    iget-object v4, p0, Lmiui/mihome/net/m;->Um:Ljava/lang/String;
