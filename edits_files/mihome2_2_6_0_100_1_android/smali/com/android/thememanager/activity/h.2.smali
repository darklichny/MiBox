...
.method private a(Lmiui/mihome/resourcebrowser/util/v;Z)V
    ...
    iget-object v0, p1, Lmiui/mihome/resourcebrowser/util/v;->Ry:Ljava/lang/String;
...
.method static synthetic d(Lcom/android/thememanager/activity/h;)V
    ...
    invoke-direct {p0}, Lcom/android/thememanager/activity/h;->eB()V
...
.method static synthetic e(Lcom/android/thememanager/activity/h;)Z
    ...
    invoke-direct {p0}, Lcom/android/thememanager/activity/h;->eE()Z
...
.method private eB()V
    ...
    invoke-direct {p0}, Lcom/android/thememanager/activity/h;->eC()V
...
.method private eC()V
    ...
    :cond_4
    invoke-direct {p0}, Lcom/android/thememanager/activity/h;->eG()Lcom/android/thememanager/a/j;

    move-result-object v0

    iget-object v1, v0, Lcom/android/thememanager/a/j;->title:Ljava/lang/String;

    iget-object v2, v0, Lcom/android/thememanager/a/j;->asl:Ljava/util/Map;

    sget-object v3, Lcom/android/thememanager/a/h;->XP:Ljava/lang/String;
...
.method private eE()Z
    ...
    invoke-virtual {v0}, Lcom/android/thememanager/a/h;->rb()Z
    ...
    invoke-static {}, Lmiui/mihome/c/e;->lg()Z
    ...
    invoke-direct {p0}, Lcom/android/thememanager/activity/h;->eF()Landroid/app/ProgressDialog;
    ...
    invoke-virtual {v0}, Lcom/android/thememanager/a/h;->re()I
...
.method private eF()Landroid/app/ProgressDialog;
    .locals 3
...
.method private eG()Lcom/android/thememanager/a/j;
    .locals 7
    ...
    :cond_0
    iput-boolean v5, v3, Lcom/android/thememanager/a/j;->ask:Z
    ...
    iget-object v0, v3, Lcom/android/thememanager/a/j;->asl:Ljava/util/Map;

    sget-object v1, Lcom/android/thememanager/a/h;->XP:Ljava/lang/String;
...
.method protected cI()V
    ...
    invoke-super {p0}, Lmiui/mihome/resourcebrowser/activity/k;->cI()V

    invoke-direct {p0}, Lcom/android/thememanager/activity/h;->eB()V

    invoke-direct {p0}, Lcom/android/thememanager/activity/h;->ex()V
...
.method public cK()V
    ...
    invoke-super {p0}, Lmiui/mihome/resourcebrowser/activity/k;->cK()V
...
.method protected cP()Lmiui/mihome/resourcebrowser/util/B;
    ...
    :cond_0
    invoke-super {p0}, Lmiui/mihome/resourcebrowser/activity/k;->cP()Lmiui/mihome/resourcebrowser/util/B;
...
.method protected cS()Lmiui/mihome/resourcebrowser/activity/n;
    ...
    :cond_0
    invoke-super {p0}, Lmiui/mihome/resourcebrowser/activity/k;->cS()Lmiui/mihome/resourcebrowser/activity/n;
...
.method public cU()V
    ...
    invoke-super {p0}, Lmiui/mihome/resourcebrowser/activity/k;->cU()V
...
.method public eD()V
    ...
    invoke-super {p0}, Lmiui/mihome/resourcebrowser/activity/k;->eD()V
...
.method protected ew()Z
    ...
    invoke-super {p0}, Lmiui/mihome/resourcebrowser/activity/k;->ew()Z
...
.method protected getHeaderView()Landroid/view/View;
    ...
    invoke-direct {p0}, Lcom/android/thememanager/activity/h;->ez()Landroid/view/View;
