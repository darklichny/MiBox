...
.field private I:Lcom/android/launcher2/aE;
...
.field private N:Lcom/android/launcher2/aF;
...
.field private final S:Lcom/android/launcher2/aH;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/android/launcher2/a;->S:Lcom/android/launcher2/aH;
...
.method private a(Landroid/graphics/Bitmap;I)Landroid/graphics/Bitmap;
    ...
    iget-object v3, p0, Lcom/android/launcher2/a;->S:Lcom/android/launcher2/aH;

    invoke-virtual {v3, v1, v2, v0, v0}, Lcom/android/launcher2/aH;->a(Landroid/graphics/Bitmap;Landroid/graphics/Canvas;II)V
...
.method static synthetic a(Lcom/android/launcher2/a;)Lcom/android/launcher2/aE;
    .locals 1

    iget-object v0, p0, Lcom/android/launcher2/a;->I:Lcom/android/launcher2/aE;

    return-object v0
.end method

.method private a(II[I)Lcom/android/launcher2/aF;
    .locals 9
    ...
    invoke-interface {v0, v3}, Lcom/android/launcher2/aF;->getHitRect(Landroid/graphics/Rect;)V

    invoke-interface {v0, p3}, Lcom/android/launcher2/aF;->getLocationOnScreen([I)V

    aget v1, p3, v7

    invoke-interface {v0}, Lcom/android/launcher2/aF;->getLeft()I
    ...
    invoke-interface {v0}, Lcom/android/launcher2/aF;->getTop()I
...
.method private a(IILandroid/view/MotionEvent;)V
    ...
    iget-object v0, p0, Lcom/android/launcher2/a;->B:Lcom/android/launcher2/cX;

    iget-object v0, v0, Lcom/android/launcher2/cX;->amD:Lcom/android/launcher2/dA;

    invoke-virtual {v0, p1, p2}, Lcom/android/launcher2/dA;->N(II)V

    iget-object v0, p0, Lcom/android/launcher2/a;->u:[I

    invoke-direct {p0, p1, p2, v0}, Lcom/android/launcher2/a;->a(II[I)Lcom/android/launcher2/aF;

    move-result-object v1

    iget-object v2, p0, Lcom/android/launcher2/a;->B:Lcom/android/launcher2/cX;

    const/4 v3, 0x0

    aget v3, v0, v3

    iput v3, v2, Lcom/android/launcher2/cX;->x:I
    ...
    iput v0, v2, Lcom/android/launcher2/cX;->y:I

    if-eqz v1, :cond_5

    iget-object v0, p0, Lcom/android/launcher2/a;->B:Lcom/android/launcher2/cX;

    invoke-interface {v1, v0}, Lcom/android/launcher2/aF;->j(Lcom/android/launcher2/cX;)Lcom/android/launcher2/aF;
    ...
    :goto_0
    iget-object v1, p0, Lcom/android/launcher2/a;->N:Lcom/android/launcher2/aF;
    ...
    invoke-interface {v1, v2}, Lcom/android/launcher2/aF;->b(Lcom/android/launcher2/cX;)V

    :cond_0
    iget-object v1, p0, Lcom/android/launcher2/a;->B:Lcom/android/launcher2/cX;
    ...
    invoke-interface {v0, v1}, Lcom/android/launcher2/aF;->c(Lcom/android/launcher2/cX;)V

    move-object v1, v0

    :cond_2
    :goto_1
    iput-object v1, p0, Lcom/android/launcher2/a;->N:Lcom/android/launcher2/aF;
    ...
    invoke-interface {v0, p1, p2, v1}, Lcom/android/launcher2/aE;->g(III)Z
    ...
    :cond_5
    iget-object v0, p0, Lcom/android/launcher2/a;->N:Lcom/android/launcher2/aF;
    ...
    invoke-interface {v0, v2}, Lcom/android/launcher2/aF;->b(Lcom/android/launcher2/cX;)V
    ...
    invoke-interface {v0}, Lcom/android/launcher2/aE;->kR()Z
    ...
    invoke-interface {v0, p3, v1}, Lcom/android/launcher2/aE;->g(Landroid/view/MotionEvent;I)V
...
.method private b(FF)V
    ...
    invoke-direct {p0, v0, v4, v1}, Lcom/android/launcher2/a;->a(II[I)Lcom/android/launcher2/aF;

    move-result-object v0

    iget-object v4, p0, Lcom/android/launcher2/a;->B:Lcom/android/launcher2/cX;

    aget v5, v1, v2

    iput v5, v4, Lcom/android/launcher2/cX;->x:I

    iget-object v4, p0, Lcom/android/launcher2/a;->B:Lcom/android/launcher2/cX;

    aget v1, v1, v3

    iput v1, v4, Lcom/android/launcher2/cX;->y:I

    if-eqz v0, :cond_3

    iget-object v1, p0, Lcom/android/launcher2/a;->B:Lcom/android/launcher2/cX;

    iput-boolean v3, v1, Lcom/android/launcher2/cX;->amC:Z
    ...
    invoke-interface {v0, v1}, Lcom/android/launcher2/aF;->e(Lcom/android/launcher2/cX;)Z
    ...
    invoke-interface {v0, v4}, Lcom/android/launcher2/aF;->b(Lcom/android/launcher2/cX;)V
    ...
    :cond_0
    iput-boolean v2, v4, Lcom/android/launcher2/cX;->cancelled:Z

    iget-object v2, p0, Lcom/android/launcher2/a;->B:Lcom/android/launcher2/cX;

    iget-object v2, v2, Lcom/android/launcher2/cX;->amF:Lcom/android/launcher2/aL;
    ...
    iget-object v3, p0, Lcom/android/launcher2/a;->B:Lcom/android/launcher2/cX;

    invoke-interface {v2, v0, v3, v1}, Lcom/android/launcher2/aL;->a(Landroid/view/View;Lcom/android/launcher2/cX;Z)V
...
.method private j()V
    ...
    invoke-interface {v0}, Lcom/android/launcher2/bp;->aH()V
    ...
    iget-object v1, v1, Lcom/android/launcher2/cX;->amD:Lcom/android/launcher2/dA;

    invoke-virtual {v0, v1, v2}, Lcom/android/launcher2/DragLayer;->a(Lcom/android/launcher2/dA;Ljava/lang/Runnable;)V

    :cond_1
    iput-object v2, p0, Lcom/android/launcher2/a;->B:Lcom/android/launcher2/cX;
    ...
    invoke-virtual {v1}, Lcom/android/launcher2/Launcher;->mM()I
...
# virtual methods
.method public a(Landroid/graphics/Bitmap;Landroid/graphics/Bitmap;IIFLcom/android/launcher2/aL;Lcom/android/launcher2/dg;I)V
    .locals 7
    ...
    invoke-interface {v0, p6, p7, p8}, Lcom/android/launcher2/bp;->a(Lcom/android/launcher2/aL;Lcom/android/launcher2/dg;I)V
    ...
    invoke-direct {v2}, Lcom/android/launcher2/cX;-><init>()V

    iput-object v2, p0, Lcom/android/launcher2/a;->B:Lcom/android/launcher2/cX;

    iget-object v2, p0, Lcom/android/launcher2/a;->B:Lcom/android/launcher2/cX;

    iput-boolean v5, v2, Lcom/android/launcher2/cX;->amC:Z
    ...
    iput v1, v2, Lcom/android/launcher2/cX;->amA:I
    ...
    iput v0, v1, Lcom/android/launcher2/cX;->amB:I

    iget-object v0, p0, Lcom/android/launcher2/a;->B:Lcom/android/launcher2/cX;

    iput-object p6, v0, Lcom/android/launcher2/cX;->amF:Lcom/android/launcher2/aL;

    iget-object v0, p0, Lcom/android/launcher2/a;->B:Lcom/android/launcher2/cX;

    iput-object p7, v0, Lcom/android/launcher2/cX;->amE:Lcom/android/launcher2/dg;

    iget-object v0, p0, Lcom/android/launcher2/a;->B:Lcom/android/launcher2/cX;

    iput-object p2, v0, Lcom/android/launcher2/cX;->amH:Landroid/graphics/Bitmap;
    ...
    iget-object v6, p0, Lcom/android/launcher2/a;->B:Lcom/android/launcher2/cX;
    ...
    invoke-direct/range {v0 .. v5}, Lcom/android/launcher2/dA;-><init>(Landroid/view/ViewGroup;Landroid/graphics/Bitmap;IIF)V

    iput-object v0, v6, Lcom/android/launcher2/cX;->amD:Lcom/android/launcher2/dA;

    iget v1, p0, Lcom/android/launcher2/a;->w:I

    iget v2, p0, Lcom/android/launcher2/a;->z:I

    invoke-virtual {v0, v1, v2}, Lcom/android/launcher2/dA;->M(II)V
...
.method public a(Landroid/view/View;Lcom/android/launcher2/aL;Lcom/android/launcher2/dg;I)V
    .locals 7
...
.method public a(Landroid/view/View;ZLcom/android/launcher2/aL;Lcom/android/launcher2/dg;IF)V
    .locals 9
    ...
    sget v0, Lcom/android/launcher2/aH;->Im:I
    ...
    invoke-virtual {v3}, Lcom/android/launcher2/Launcher;->lS()Lcom/android/launcher2/DragLayer;
    ...
    invoke-virtual/range {v0 .. v8}, Lcom/android/launcher2/a;->a(Landroid/graphics/Bitmap;Landroid/graphics/Bitmap;IIFLcom/android/launcher2/aL;Lcom/android/launcher2/dg;I)V
...
.method public a(Lcom/android/launcher2/aE;)V
    ...
    iput-object p1, p0, Lcom/android/launcher2/a;->I:Lcom/android/launcher2/aE;

    return-void
.end method

.method public a(Lcom/android/launcher2/aF;)V
    .locals 1
...
.method public b(Lcom/android/launcher2/aF;)V
    .locals 2
    ...
    invoke-interface {v0, v1}, Lcom/android/launcher2/aF;->b(Lcom/android/launcher2/cX;)V

    const/4 v0, 0x0

    iput-object v0, p0, Lcom/android/launcher2/a;->N:Lcom/android/launcher2/aF;
...
.method public h()V
    ...
    iput-boolean v2, v0, Lcom/android/launcher2/cX;->cancelled:Z

    iget-object v0, p0, Lcom/android/launcher2/a;->B:Lcom/android/launcher2/cX;

    iput-boolean v2, v0, Lcom/android/launcher2/cX;->amC:Z

    iget-object v0, p0, Lcom/android/launcher2/a;->B:Lcom/android/launcher2/cX;

    iget-object v0, v0, Lcom/android/launcher2/cX;->amF:Lcom/android/launcher2/aL;
    ...
    invoke-interface {v0, v1, v2, v3}, Lcom/android/launcher2/aL;->a(Landroid/view/View;Lcom/android/launcher2/cX;Z)V
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-interface {v0, p1, v2}, Lcom/android/launcher2/aE;->e(Landroid/view/MotionEvent;I)V
    ...
    invoke-interface {v0, p1, v2}, Lcom/android/launcher2/aE;->f(Landroid/view/MotionEvent;I)V
