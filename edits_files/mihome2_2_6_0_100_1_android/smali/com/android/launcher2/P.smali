...
.method private a(Landroid/content/Context;Landroid/content/pm/ResolveInfo;)V
    ...
    invoke-direct {v0, p1, p2}, Lcom/android/launcher2/dL;-><init>(Landroid/content/Context;Landroid/content/pm/ResolveInfo;)V

    iget-object v1, p2, Landroid/content/pm/ResolveInfo;->activityInfo:Landroid/content/pm/ActivityInfo;

    iget-object v1, v1, Landroid/content/pm/ActivityInfo;->packageName:Ljava/lang/String;

    invoke-direct {p0, p1, v1, v0}, Lcom/android/launcher2/P;->a(Landroid/content/Context;Ljava/lang/String;Lcom/android/launcher2/dL;)V

    invoke-virtual {p0, v0}, Lcom/android/launcher2/P;->a(Lcom/android/launcher2/dL;)V
...
.method private a(Landroid/content/Context;Ljava/lang/String;Lcom/android/launcher2/dL;)V
    .locals 7
    ...
    iget-object v2, p3, Lcom/android/launcher2/dL;->intent:Landroid/content/Intent;
    ...
    iput-wide v2, p3, Lcom/android/launcher2/dL;->id:J
    ...
    iput-wide v2, p3, Lcom/android/launcher2/dL;->yD:J
    ...
    iput v0, p3, Lcom/android/launcher2/dL;->aT:I
    ...
    iput v0, p3, Lcom/android/launcher2/dL;->aU:I

    const/4 v0, 0x1

    iput v0, p3, Lcom/android/launcher2/dL;->yF:I

    iput v0, p3, Lcom/android/launcher2/dL;->yE:I
    ...
    iput-wide v2, p3, Lcom/android/launcher2/dL;->anS:J
    ...
    iget-object v5, p3, Lcom/android/launcher2/dL;->title:Ljava/lang/CharSequence;

    aput-object v5, v3, v4

    const/4 v4, 0x1

    iget v5, p3, Lcom/android/launcher2/dL;->aT:I
    ...
    iget v5, p3, Lcom/android/launcher2/dL;->aU:I
    ...
    iget-wide v5, p3, Lcom/android/launcher2/dL;->yD:J
    ...
    iget-wide v5, p3, Lcom/android/launcher2/dL;->anS:J
    ...
    iget-object v3, p3, Lcom/android/launcher2/dL;->title:Ljava/lang/CharSequence;
...
.method private b(Landroid/content/Context;Landroid/content/Intent;Ljava/lang/String;)V
    ...
    invoke-virtual {v1}, Lcom/android/launcher2/cA;->tx()Lcom/android/launcher2/bA;
    ...
    invoke-virtual/range {v1 .. v9}, Lcom/android/launcher2/bA;->a(Landroid/content/Intent;Landroid/database/Cursor;Landroid/content/Context;IIIII)Lcom/android/launcher2/dL;

    move-result-object v1

    invoke-virtual {v1, v3}, Lcom/android/launcher2/dL;->a(Landroid/database/Cursor;)V

    iput-object p2, v1, Lcom/android/launcher2/dL;->intent:Landroid/content/Intent;

    invoke-virtual {p0, v1}, Lcom/android/launcher2/P;->a(Lcom/android/launcher2/dL;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public q(Landroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-static {p1, p2}, Lcom/android/launcher2/bD;->F(Landroid/content/Context;Ljava/lang/String;)Ljava/util/List;
