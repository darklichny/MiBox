...
.field private Fz:Lcom/android/launcher2/D;
...
.field private UX:Ljava/lang/ref/SoftReference;

.field private UY:Ljava/lang/ref/SoftReference;

.field private final UZ:[I

.field private Va:[Landroid/graphics/Bitmap;

.field private final Vb:[I

.field private Vc:[Landroid/graphics/Bitmap;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/android/launcher2/AnimateWave;->FD:Landroid/graphics/Rect;

    iput v2, p0, Lcom/android/launcher2/AnimateWave;->UQ:I

    const/16 v0, 0x9

    iput v0, p0, Lcom/android/launcher2/AnimateWave;->UR:I

    const/16 v0, 0xb4

    iput v0, p0, Lcom/android/launcher2/AnimateWave;->US:I

    iput v2, p0, Lcom/android/launcher2/AnimateWave;->UT:I

    iput v2, p0, Lcom/android/launcher2/AnimateWave;->UU:I

    iput v1, p0, Lcom/android/launcher2/AnimateWave;->UV:F

    const/4 v0, 0x1

    iput-boolean v0, p0, Lcom/android/launcher2/AnimateWave;->UW:Z

    new-instance v0, Lcom/android/launcher2/D;

    invoke-direct {v0}, Lcom/android/launcher2/D;-><init>()V

    iput-object v0, p0, Lcom/android/launcher2/AnimateWave;->Fz:Lcom/android/launcher2/D;
    ...
    iput-object v0, p0, Lcom/android/launcher2/AnimateWave;->UZ:[I

    iget-object v0, p0, Lcom/android/launcher2/AnimateWave;->UZ:[I

    array-length v0, v0

    new-array v0, v0, [Landroid/graphics/Bitmap;

    iput-object v0, p0, Lcom/android/launcher2/AnimateWave;->Va:[Landroid/graphics/Bitmap;
    ...
    iput-object v0, p0, Lcom/android/launcher2/AnimateWave;->Vb:[I

    iget-object v0, p0, Lcom/android/launcher2/AnimateWave;->Vb:[I

    array-length v0, v0

    new-array v0, v0, [Landroid/graphics/Bitmap;

    iput-object v0, p0, Lcom/android/launcher2/AnimateWave;->Vc:[Landroid/graphics/Bitmap;

    iput v1, p0, Lcom/android/launcher2/AnimateWave;->Vd:F

    iput v1, p0, Lcom/android/launcher2/AnimateWave;->Ve:F

    const/high16 v0, 0x3f80

    iput v0, p0, Lcom/android/launcher2/AnimateWave;->Vf:F
...
.method public bO(I)V
    ...
    iget-object v0, p0, Lcom/android/launcher2/AnimateWave;->Fz:Lcom/android/launcher2/D;
...
.method protected onDraw(Landroid/graphics/Canvas;)V
    ...
    invoke-virtual {p0}, Lcom/android/launcher2/AnimateWave;->qn()Landroid/graphics/Bitmap;
    ...
    iget v3, p0, Lcom/android/launcher2/AnimateWave;->Vg:I
    ...
    iget v4, p0, Lcom/android/launcher2/AnimateWave;->Vd:F

    int-to-float v5, v2

    mul-float/2addr v4, v5

    iget v5, p0, Lcom/android/launcher2/AnimateWave;->Ve:F

    iget v6, p0, Lcom/android/launcher2/AnimateWave;->Vd:F
    ...
    iget v4, p0, Lcom/android/launcher2/AnimateWave;->Vh:I
    ...
    iget-object v3, p0, Lcom/android/launcher2/AnimateWave;->FD:Landroid/graphics/Rect;
    ...
    iget-object v4, p0, Lcom/android/launcher2/AnimateWave;->FD:Landroid/graphics/Rect;
    ...
    invoke-virtual {p0}, Lcom/android/launcher2/AnimateWave;->ql()Landroid/graphics/Bitmap;
    ...
    iget-object v5, p0, Lcom/android/launcher2/AnimateWave;->FC:Landroid/graphics/Rect;
    ...
    invoke-virtual {p0}, Lcom/android/launcher2/AnimateWave;->qm()Landroid/graphics/Bitmap;
    ...
    invoke-virtual {p0}, Lcom/android/launcher2/AnimateWave;->qp()I

    move-result v3

    invoke-virtual {v0, v3}, Landroid/graphics/Paint;->setAlpha(I)V

    invoke-virtual {p0}, Lcom/android/launcher2/AnimateWave;->qo()Landroid/graphics/Bitmap;
    ...
    iget-object v1, p0, Lcom/android/launcher2/AnimateWave;->FD:Landroid/graphics/Rect;
    ...
    iget-object v2, p0, Lcom/android/launcher2/AnimateWave;->FD:Landroid/graphics/Rect;
    ...
    iget v6, p0, Lcom/android/launcher2/AnimateWave;->Vh:I
    ...
    iget v5, p0, Lcom/android/launcher2/AnimateWave;->Vh:I
...
.method protected onMeasure(II)V
    ...
    iput v0, p0, Lcom/android/launcher2/AnimateWave;->Vg:I
...
.method public q(F)V
    ...
    iget v0, p0, Lcom/android/launcher2/AnimateWave;->Vd:F

    iget v1, p0, Lcom/android/launcher2/AnimateWave;->Ve:F

    iget v2, p0, Lcom/android/launcher2/AnimateWave;->Vd:F

    sub-float/2addr v1, v2

    iget-object v2, p0, Lcom/android/launcher2/AnimateWave;->Fz:Lcom/android/launcher2/D;

    invoke-virtual {v2}, Lcom/android/launcher2/D;->eI()F
    ...
    iput v0, p0, Lcom/android/launcher2/AnimateWave;->Vd:F

    iput p1, p0, Lcom/android/launcher2/AnimateWave;->Ve:F
...
.method public ql()Landroid/graphics/Bitmap;
    .locals 3

    const/4 v1, 0x0

    iget-object v0, p0, Lcom/android/launcher2/AnimateWave;->UX:Ljava/lang/ref/SoftReference;
    ...
    iput-object v1, p0, Lcom/android/launcher2/AnimateWave;->UX:Ljava/lang/ref/SoftReference;
...
.method public qm()Landroid/graphics/Bitmap;
    .locals 3
...
.method public qn()Landroid/graphics/Bitmap;
    .locals 5

    iget v0, p0, Lcom/android/launcher2/AnimateWave;->UQ:I

    iget v1, p0, Lcom/android/launcher2/AnimateWave;->UR:I

    div-int/2addr v0, v1

    iget-object v1, p0, Lcom/android/launcher2/AnimateWave;->Va:[Landroid/graphics/Bitmap;
    ...
    iget-object v2, p0, Lcom/android/launcher2/AnimateWave;->UZ:[I
    ...
    iget-object v2, p0, Lcom/android/launcher2/AnimateWave;->Va:[Landroid/graphics/Bitmap;
    ...
    :cond_0
    iget v1, p0, Lcom/android/launcher2/AnimateWave;->UQ:I

    add-int/lit8 v1, v1, 0x1

    iput v1, p0, Lcom/android/launcher2/AnimateWave;->UQ:I

    iget-object v2, p0, Lcom/android/launcher2/AnimateWave;->UZ:[I

    array-length v2, v2

    iget v3, p0, Lcom/android/launcher2/AnimateWave;->UR:I
...
.method public qo()Landroid/graphics/Bitmap;
    .locals 4

    iget v0, p0, Lcom/android/launcher2/AnimateWave;->UT:I

    iget v1, p0, Lcom/android/launcher2/AnimateWave;->US:I

    div-int/2addr v0, v1

    iget-object v1, p0, Lcom/android/launcher2/AnimateWave;->Vc:[Landroid/graphics/Bitmap;
    ...
    iget-object v2, p0, Lcom/android/launcher2/AnimateWave;->Vb:[I
    ...
    iget-object v2, p0, Lcom/android/launcher2/AnimateWave;->Vc:[Landroid/graphics/Bitmap;
    ...
    iput v1, p0, Lcom/android/launcher2/AnimateWave;->UT:I
    ...
    :cond_1
    iput v0, p0, Lcom/android/launcher2/AnimateWave;->UU:I
...
.method public qp()I
    ...
    iget v2, p0, Lcom/android/launcher2/AnimateWave;->US:I

    div-int/2addr v1, v2

    if-eq v0, v1, :cond_0

    iput v3, p0, Lcom/android/launcher2/AnimateWave;->UV:F
    ...
    iget-boolean v1, p0, Lcom/android/launcher2/AnimateWave;->UW:Z

    if-eqz v1, :cond_2

    iget v1, p0, Lcom/android/launcher2/AnimateWave;->UV:F

    add-float/2addr v0, v1

    iput v0, p0, Lcom/android/launcher2/AnimateWave;->UV:F

    :goto_0
    iget v0, p0, Lcom/android/launcher2/AnimateWave;->UV:F
    ...
    iput v4, p0, Lcom/android/launcher2/AnimateWave;->UV:F
...
.method public qq()V
    ...
    :cond_0
    :goto_1
    iget-object v0, p0, Lcom/android/launcher2/AnimateWave;->Vc:[Landroid/graphics/Bitmap;
