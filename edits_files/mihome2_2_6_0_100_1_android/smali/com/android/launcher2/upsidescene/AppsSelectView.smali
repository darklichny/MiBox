...
.method static synthetic b(Lcom/android/launcher2/upsidescene/AppsSelectView;)Lcom/android/launcher2/dD;
    .locals 1

    iget-object v0, p0, Lcom/android/launcher2/upsidescene/AppsSelectView;->jQ:Lcom/android/launcher2/dD;
...
.method static synthetic c(Lcom/android/launcher2/upsidescene/AppsSelectView;)Landroid/widget/GridView;
    ...
    iget-object v0, p0, Lcom/android/launcher2/upsidescene/AppsSelectView;->jP:Landroid/widget/GridView;
...
.method private cX()V
    ...
    iget-object v0, p0, Lcom/android/launcher2/upsidescene/AppsSelectView;->jS:Landroid/widget/TextView;
    ...
    iget-object v2, p0, Lcom/android/launcher2/upsidescene/AppsSelectView;->jP:Landroid/widget/GridView;
...
.method private close()V
    ...
    iget-object v0, p0, Lcom/android/launcher2/upsidescene/AppsSelectView;->gl:Lcom/android/launcher2/upsidescene/SceneScreen;

    invoke-virtual {v0}, Lcom/android/launcher2/upsidescene/SceneScreen;->oW()V
...
.method static synthetic d(Lcom/android/launcher2/upsidescene/AppsSelectView;)[Z
    ...
    iget-object v0, p0, Lcom/android/launcher2/upsidescene/AppsSelectView;->jT:[Z
...
.method private getCheckedItemCount()I
    ...
    :goto_0
    iget-object v3, p0, Lcom/android/launcher2/upsidescene/AppsSelectView;->jT:[Z
...
# virtual methods
.method public a(Landroid/content/pm/PackageManager;Lcom/android/launcher2/dD;Landroid/content/pm/ResolveInfo;)Lcom/android/launcher2/dL;
    .locals 5
    ...
    iput-object v1, v2, Lcom/android/launcher2/dL;->intent:Landroid/content/Intent;

    :goto_0
    invoke-virtual {p2, v0, p3}, Lcom/android/launcher2/dD;->a(Landroid/content/ComponentName;Landroid/content/pm/ResolveInfo;)Landroid/graphics/drawable/Drawable;

    move-result-object v1

    if-nez v1, :cond_1

    invoke-virtual {p2}, Lcom/android/launcher2/dD;->xO()Landroid/graphics/drawable/Drawable;

    move-result-object v1

    const/4 v3, 0x1

    iput-boolean v3, v2, Lcom/android/launcher2/dL;->atQ:Z

    :cond_1
    invoke-virtual {v2, v1}, Lcom/android/launcher2/dL;->setIcon(Landroid/graphics/drawable/Drawable;)V
    ...
    iput-object v1, v2, Lcom/android/launcher2/dL;->title:Ljava/lang/CharSequence;

    iget-object v1, v2, Lcom/android/launcher2/dL;->title:Ljava/lang/CharSequence;
    ...
    iput-object v0, v2, Lcom/android/launcher2/dL;->title:Ljava/lang/CharSequence;

    :cond_2
    const/4 v0, 0x0

    iput v0, v2, Lcom/android/launcher2/dL;->itemType:I
    ...
    iget-object v1, v2, Lcom/android/launcher2/dL;->intent:Landroid/content/Intent;
...
.method public a(Lcom/android/launcher2/upsidescene/SceneScreen;Lcom/android/launcher2/upsidescene/h;)V
    ...
    iput-object p1, p0, Lcom/android/launcher2/upsidescene/AppsSelectView;->gl:Lcom/android/launcher2/upsidescene/SceneScreen;
    ...
    iput-object v0, p0, Lcom/android/launcher2/upsidescene/AppsSelectView;->jQ:Lcom/android/launcher2/dD;
    ...
    iget-object v8, p0, Lcom/android/launcher2/upsidescene/AppsSelectView;->jQ:Lcom/android/launcher2/dD;

    invoke-virtual {p0, v1, v8, v0}, Lcom/android/launcher2/upsidescene/AppsSelectView;->a(Landroid/content/pm/PackageManager;Lcom/android/launcher2/dD;Landroid/content/pm/ResolveInfo;)Lcom/android/launcher2/dL;

    move-result-object v8

    if-eqz v3, :cond_9

    invoke-virtual {v3}, Lcom/android/launcher2/upsidescene/u;->ok()[Landroid/content/ComponentName;
    ...
    iget-object v12, v8, Lcom/android/launcher2/dL;->intent:Landroid/content/Intent;
    ...
    :cond_3
    invoke-static {v5}, Lcom/android/launcher2/dL;->D(Ljava/util/List;)V

    invoke-static {v6}, Lcom/android/launcher2/dL;->D(Ljava/util/List;)V
    ...
    iput-object v0, p0, Lcom/android/launcher2/upsidescene/AppsSelectView;->jT:[Z

    new-instance v0, Lcom/android/launcher2/upsidescene/B;

    invoke-direct {v0, p0, v5}, Lcom/android/launcher2/upsidescene/B;-><init>(Lcom/android/launcher2/upsidescene/AppsSelectView;Ljava/util/List;)V

    iget-object v1, p0, Lcom/android/launcher2/upsidescene/AppsSelectView;->jP:Landroid/widget/GridView;
...
.method protected onFinishInflate()V
    ...
    iput-object v0, p0, Lcom/android/launcher2/upsidescene/AppsSelectView;->jR:Landroid/view/View;
    ...
    iput-object v0, p0, Lcom/android/launcher2/upsidescene/AppsSelectView;->jS:Landroid/widget/TextView;
    ...
    iput-object v0, p0, Lcom/android/launcher2/upsidescene/AppsSelectView;->jN:Landroid/widget/TextView;
    ...
    iput-object v0, p0, Lcom/android/launcher2/upsidescene/AppsSelectView;->jO:Landroid/widget/TextView;
    ...
    iput-object v0, p0, Lcom/android/launcher2/upsidescene/AppsSelectView;->jP:Landroid/widget/GridView;

    iget-object v0, p0, Lcom/android/launcher2/upsidescene/AppsSelectView;->jN:Landroid/widget/TextView;
    ...
    iget-object v0, p0, Lcom/android/launcher2/upsidescene/AppsSelectView;->jO:Landroid/widget/TextView;
