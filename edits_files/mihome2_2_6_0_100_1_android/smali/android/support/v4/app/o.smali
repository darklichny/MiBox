...
# instance fields
.field final Dn:Landroid/support/v4/app/w;

.field Do:Landroid/support/v4/app/A;

.field Dp:Landroid/support/v4/app/A;
...
.method public constructor <init>(Landroid/support/v4/app/w;)V
    ...
    iput-object p1, p0, Landroid/support/v4/app/o;->Dn:Landroid/support/v4/app/w;
...
.method private a(ILandroid/support/v4/app/Fragment;Ljava/lang/String;I)V
    ...
    iget-object v0, p0, Landroid/support/v4/app/o;->Dn:Landroid/support/v4/app/w;
    ...
    iput-object p2, v0, Landroid/support/v4/app/A;->amW:Landroid/support/v4/app/Fragment;
...
.method public a(Landroid/support/v4/app/Fragment;)Landroid/support/v4/app/D;
    ...
    iput-object p1, v0, Landroid/support/v4/app/A;->amW:Landroid/support/v4/app/Fragment;
...
.method a(Landroid/support/v4/app/A;)V
    ...
    iput-object p1, p0, Landroid/support/v4/app/o;->Dp:Landroid/support/v4/app/A;
    ...
    :cond_0
    iget-object v0, p0, Landroid/support/v4/app/o;->Dp:Landroid/support/v4/app/A;

    iput-object v0, p1, Landroid/support/v4/app/A;->amV:Landroid/support/v4/app/A;

    iget-object v0, p0, Landroid/support/v4/app/o;->Dp:Landroid/support/v4/app/A;

    iput-object p1, v0, Landroid/support/v4/app/A;->amU:Landroid/support/v4/app/A;
...
.method public bo(Ljava/lang/String;)Landroid/support/v4/app/D;
    .locals 2
...
.method bumpBackStackNesting(I)V
    ...
    iget-object v0, v2, Landroid/support/v4/app/A;->amW:Landroid/support/v4/app/Fragment;
    ...
    iget-object v3, v2, Landroid/support/v4/app/A;->amW:Landroid/support/v4/app/Fragment;
    ...
    :cond_5
    iget-object v0, v2, Landroid/support/v4/app/A;->amU:Landroid/support/v4/app/A;
...
.method public kb()Landroid/support/v4/app/D;
    .locals 2
...
.method public popFromBackStack(Z)V
    ...
    :pswitch_0
    iget-object v0, v3, Landroid/support/v4/app/A;->amW:Landroid/support/v4/app/Fragment;

    iget v1, v3, Landroid/support/v4/app/A;->popExitAnim:I

    iput v1, v0, Landroid/support/v4/app/Fragment;->mNextAnim:I

    iget-object v1, p0, Landroid/support/v4/app/o;->Dn:Landroid/support/v4/app/w;
    ...
    :cond_1
    :goto_1
    iget-object v0, v3, Landroid/support/v4/app/A;->amV:Landroid/support/v4/app/A;
    ...
    iget-object v4, p0, Landroid/support/v4/app/o;->Dn:Landroid/support/v4/app/w;
...
.method public run()V
    ...
    :pswitch_0
    iget-object v0, v4, Landroid/support/v4/app/A;->amW:Landroid/support/v4/app/Fragment;
    ...
    :cond_2
    :goto_1
    iget-object v0, v4, Landroid/support/v4/app/A;->amU:Landroid/support/v4/app/A;
    ...
    iput-object v3, v4, Landroid/support/v4/app/A;->amW:Landroid/support/v4/app/Fragment;
    ...
    :cond_8
    iget-object v5, p0, Landroid/support/v4/app/o;->Dn:Landroid/support/v4/app/w;
