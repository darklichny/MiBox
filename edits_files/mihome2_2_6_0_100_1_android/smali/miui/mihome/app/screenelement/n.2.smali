...
# static fields
.field private static xH:Landroid/media/MediaPlayer;
...
.field private xE:Ljava/util/HashMap;

.field private xF:Ljava/util/ArrayList;

.field private xG:Lmiui/mihome/app/screenelement/g;
...
.method public constructor <init>(Landroid/content/Context;Lmiui/mihome/app/screenelement/g;)V
    ...
    iput-object v0, p0, Lmiui/mihome/app/screenelement/n;->xD:Ljava/util/HashMap;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lmiui/mihome/app/screenelement/n;->xE:Ljava/util/HashMap;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lmiui/mihome/app/screenelement/n;->xF:Ljava/util/ArrayList;

    iput-object p2, p0, Lmiui/mihome/app/screenelement/n;->xG:Lmiui/mihome/app/screenelement/g;
    ...
    iput-object v0, p0, Lmiui/mihome/app/screenelement/n;->xC:Landroid/media/SoundPool;

    iget-object v0, p0, Lmiui/mihome/app/screenelement/n;->xC:Landroid/media/SoundPool;
...
.method private declared-synchronized a(ILmiui/mihome/app/screenelement/K;)V
    ...
    :cond_1
    :try_start_1
    iget-boolean v0, p2, Lmiui/mihome/app/screenelement/K;->CV:Z

    if-nez v0, :cond_3

    iget-object v0, p0, Lmiui/mihome/app/screenelement/n;->xF:Ljava/util/ArrayList;
    ...
    iget-object v2, p0, Lmiui/mihome/app/screenelement/n;->xC:Landroid/media/SoundPool;
    ...
    iget v2, p2, Lmiui/mihome/app/screenelement/K;->YZ:F

    iget v3, p2, Lmiui/mihome/app/screenelement/K;->YZ:F

    const/4 v4, 0x1

    iget-boolean v1, p2, Lmiui/mihome/app/screenelement/K;->CW:Z
    ...
    iget-object v1, p0, Lmiui/mihome/app/screenelement/n;->xF:Ljava/util/ArrayList;
    ...
    sget-object v2, Lcom/android/thememanager/util/c;->iA:Ljava/lang/String;
    ...
    iget-object v2, p0, Lmiui/mihome/app/screenelement/n;->xI:Ljava/lang/String;
    ...
    iget-object v1, p0, Lmiui/mihome/app/screenelement/n;->xG:Lmiui/mihome/app/screenelement/g;

    iget-object v2, p0, Lmiui/mihome/app/screenelement/n;->xI:Ljava/lang/String;

    invoke-virtual {v1, v2}, Lmiui/mihome/app/screenelement/g;->aw(Ljava/lang/String;)Landroid/os/MemoryFile;
...
.method private a(Ljava/io/File;Landroid/os/MemoryFile;)V
    ...
    :try_start_2
    invoke-static {v1, v3}, Lcom/android/launcher2/gadget/W;->a(Ljava/io/OutputStream;Ljava/io/InputStream;)V
    :try_end_2
...
.method private static n(Ljava/io/File;)V
    ...
    :try_start_0
    sget-object v0, Lmiui/mihome/app/screenelement/n;->xH:Landroid/media/MediaPlayer;
    ...
    sput-object v0, Lmiui/mihome/app/screenelement/n;->xH:Landroid/media/MediaPlayer;
...
.method public declared-synchronized a(Ljava/lang/String;Lmiui/mihome/app/screenelement/K;)V
    ...
    :try_start_0
    iput-object p1, p0, Lmiui/mihome/app/screenelement/n;->xI:Ljava/lang/String;

    iget-object v1, p0, Lmiui/mihome/app/screenelement/n;->xC:Landroid/media/SoundPool;
    ...
    iget-object v1, p0, Lmiui/mihome/app/screenelement/n;->xD:Ljava/util/HashMap;
    ...
    invoke-virtual {v1, p1}, Lmiui/mihome/app/screenelement/g;->aw(Ljava/lang/String;)Landroid/os/MemoryFile;
    ...
    :goto_1
    :try_start_3
    iget-object v1, p0, Lmiui/mihome/app/screenelement/n;->xE:Ljava/util/HashMap;
...
.method public onLoadComplete(Landroid/media/SoundPool;II)V
    ...
    iget-object v0, p0, Lmiui/mihome/app/screenelement/n;->xE:Ljava/util/HashMap;
...
.method public declared-synchronized release()V
    ...
    iget-object v0, p0, Lmiui/mihome/app/screenelement/n;->xD:Ljava/util/HashMap;
