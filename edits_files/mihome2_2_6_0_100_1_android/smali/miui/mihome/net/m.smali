...
.method constructor <init>(Lmiui/mihome/net/e;Landroid/app/Activity;Landroid/os/Handler;Lmiui/mihome/net/a;Landroid/os/Bundle;Landroid/accounts/Account;Ljava/lang/String;)V
    ...
    iput-object p1, p0, Lmiui/mihome/net/m;->vC:Lmiui/mihome/net/e;

    iput-object p5, p0, Lmiui/mihome/net/m;->Um:Landroid/os/Bundle;

    iput-object p6, p0, Lmiui/mihome/net/m;->val$account:Landroid/accounts/Account;

    iput-object p7, p0, Lmiui/mihome/net/m;->Ul:Ljava/lang/String;
...
.method protected doWork()V
    ...
    invoke-virtual {p0}, Lmiui/mihome/net/m;->nL()Lmiui/mihome/net/v;
    ...
    iget-object v2, p0, Lmiui/mihome/net/m;->Um:Landroid/os/Bundle;
    ...
    :cond_0
    invoke-virtual {p0}, Lmiui/mihome/net/m;->nK()Lmiui/mihome/net/t;

    move-result-object v2

    iget-object v3, p0, Lmiui/mihome/net/m;->val$account:Landroid/accounts/Account;

    iget-object v4, p0, Lmiui/mihome/net/m;->Ul:Ljava/lang/String;
