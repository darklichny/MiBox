...
# static fields
.field private static final wW:Landroid/view/ViewGroup$LayoutParams;
...
.field protected wX:Landroid/app/Activity;

.field protected wY:Lmiui/mihome/resourcebrowser/activity/c;

.field private wZ:I

.field protected xa:Lmiui/mihome/resourcebrowser/util/B;

.field private xb:Lmiui/mihome/resourcebrowser/activity/E;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lmiui/mihome/resourcebrowser/activity/n;->wW:Landroid/view/ViewGroup$LayoutParams;
...
.method private constructor <init>(Lmiui/mihome/resourcebrowser/activity/c;Landroid/content/Context;Lmiui/mihome/resourcebrowser/ResourceContext;)V
    ...
    iput-object v0, p0, Lmiui/mihome/resourcebrowser/activity/n;->xb:Lmiui/mihome/resourcebrowser/activity/E;

    iput-object p1, p0, Lmiui/mihome/resourcebrowser/activity/n;->wY:Lmiui/mihome/resourcebrowser/activity/c;

    check-cast p2, Landroid/app/Activity;

    iput-object p2, p0, Lmiui/mihome/resourcebrowser/activity/n;->wX:Landroid/app/Activity;

    iget-object v0, p0, Lmiui/mihome/resourcebrowser/activity/n;->wY:Lmiui/mihome/resourcebrowser/activity/c;

    if-nez v0, :cond_0

    iget-object v0, p0, Lmiui/mihome/resourcebrowser/activity/n;->wX:Landroid/app/Activity;
    ...
    iput-boolean v0, p0, Lmiui/mihome/resourcebrowser/activity/n;->xc:Z
    ...
    invoke-virtual {p0}, Lmiui/mihome/resourcebrowser/activity/n;->pz()I
    ...
    invoke-direct {p0}, Lmiui/mihome/resourcebrowser/activity/n;->gY()V
...
.method public constructor <init>(Lmiui/mihome/resourcebrowser/activity/c;Lmiui/mihome/resourcebrowser/ResourceContext;)V
    ...
    invoke-virtual {p1}, Lmiui/mihome/resourcebrowser/activity/c;->eX()Landroid/support/v4/app/s;
...
.method private gY()V
    ...
    iput v0, p0, Lmiui/mihome/resourcebrowser/activity/n;->wZ:I
    ...
    iget v2, p0, Lmiui/mihome/resourcebrowser/activity/n;->wZ:I
...
.method protected a(Lmiui/mihome/resourcebrowser/model/Resource;I)I
    ...
    iget-object v2, p0, Lmiui/mihome/resourcebrowser/activity/n;->jH:Lmiui/mihome/resourcebrowser/ResourceContext;
...
.method protected a(Landroid/view/View;Ljava/util/List;III)Landroid/view/View;
    ...
    iget-object v1, p0, Lmiui/mihome/resourcebrowser/activity/n;->wX:Landroid/app/Activity;
    ...
    sget-object v1, Lmiui/mihome/resourcebrowser/activity/n;->wW:Landroid/view/ViewGroup$LayoutParams;
    ...
    sget-object v0, Lmiui/mihome/resourcebrowser/activity/n;->wW:Landroid/view/ViewGroup$LayoutParams;
    ...
    iget v0, p0, Lmiui/mihome/resourcebrowser/activity/n;->wZ:I

    iget v2, p0, Lmiui/mihome/resourcebrowser/activity/n;->wZ:I

    iget v3, p0, Lmiui/mihome/resourcebrowser/activity/n;->wZ:I

    iget v4, p0, Lmiui/mihome/resourcebrowser/activity/n;->wZ:I
    ...
    iget v6, p0, Lmiui/mihome/resourcebrowser/activity/n;->wZ:I
    ...
    iget-object v2, p0, Lmiui/mihome/resourcebrowser/activity/n;->xa:Lmiui/mihome/resourcebrowser/util/B;

    if-eqz v2, :cond_3

    iget-object v2, p0, Lmiui/mihome/resourcebrowser/activity/n;->xa:Lmiui/mihome/resourcebrowser/util/B;

    invoke-virtual {v2}, Lmiui/mihome/resourcebrowser/util/B;->rs()Landroid/view/View$OnClickListener;
    ...
    iget-object v0, p0, Lmiui/mihome/resourcebrowser/activity/n;->xa:Lmiui/mihome/resourcebrowser/util/B;
...
.method public a(Lmiui/mihome/resourcebrowser/util/B;)V
    ...
    iput-object p1, p0, Lmiui/mihome/resourcebrowser/activity/n;->xa:Lmiui/mihome/resourcebrowser/util/B;
...
.method protected c(Lmiui/mihome/resourcebrowser/model/PathEntry;)V
    ...
    :cond_0
    iget-object v0, p0, Lmiui/mihome/resourcebrowser/activity/n;->xb:Lmiui/mihome/resourcebrowser/activity/E;
...
.method public clean()V
    ...
    invoke-virtual {v0}, Lmiui/mihome/resourcebrowser/util/B;->rq()V
...
.method protected bridge synthetic e(Ljava/lang/Object;)Ljava/util/List;
    ...
    invoke-virtual {p0, p1}, Lmiui/mihome/resourcebrowser/activity/n;->C(Lmiui/mihome/resourcebrowser/model/Resource;)Ljava/util/List;
...
.method protected final gW()Lmiui/mihome/c/g;
    .locals 1
...
.method public gX()V
    ...
    invoke-super {p0}, Lmiui/mihome/resourcebrowser/widget/d;->gX()V
...
.method protected ha()Z
    ...
    iget-boolean v0, p0, Lmiui/mihome/resourcebrowser/activity/n;->xc:Z
...
.method protected hb()V
    ...
    sput-boolean v1, Lmiui/mihome/resourcebrowser/activity/U;->atM:Z
