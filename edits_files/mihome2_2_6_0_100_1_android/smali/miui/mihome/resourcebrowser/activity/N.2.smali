...
.field protected alP:Landroid/support/v4/view/ViewPager;

.field protected alQ:Lmiui/mihome/resourcebrowser/activity/A;

.field protected alR:Ljava/util/List;

.field protected alS:Ljava/util/List;

.field protected alT:I
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lmiui/mihome/resourcebrowser/activity/N;->alR:Ljava/util/List;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lmiui/mihome/resourcebrowser/activity/N;->alS:Ljava/util/List;
...
.method private h(IZ)V
    ...
    iget v0, p0, Lmiui/mihome/resourcebrowser/activity/N;->alT:I
    ...
    iput p1, p0, Lmiui/mihome/resourcebrowser/activity/N;->alT:I
    ...
    iget-object v0, p0, Lmiui/mihome/resourcebrowser/activity/N;->alP:Landroid/support/v4/view/ViewPager;
...
.method private i(IZ)V
    ...
    iget-object v0, p0, Lmiui/mihome/resourcebrowser/activity/N;->alR:Ljava/util/List;
    ...
    invoke-virtual {v0}, Lmiui/mihome/resourcebrowser/activity/c;->bM()V
...
.method private vI()V
    ...
    invoke-virtual {p0}, Lmiui/mihome/resourcebrowser/activity/N;->vJ()Lmiui/mihome/resourcebrowser/activity/A;

    move-result-object v0

    iput-object v0, p0, Lmiui/mihome/resourcebrowser/activity/N;->alQ:Lmiui/mihome/resourcebrowser/activity/A;

    iget-object v0, p0, Lmiui/mihome/resourcebrowser/activity/N;->alP:Landroid/support/v4/view/ViewPager;

    iget-object v1, p0, Lmiui/mihome/resourcebrowser/activity/N;->alQ:Lmiui/mihome/resourcebrowser/activity/A;
...
.method private vK()V
    ...
    invoke-virtual {p0}, Lmiui/mihome/resourcebrowser/activity/N;->gr()Lcom/actionbarsherlock/b/f;
    ...
    invoke-virtual {p0}, Lmiui/mihome/resourcebrowser/activity/N;->cA()Ljava/util/List;
...
.method private vL()V
    ...
    invoke-virtual {p0}, Lmiui/mihome/resourcebrowser/activity/N;->qZ()Landroid/support/v4/app/z;

    move-result-object v3

    invoke-virtual {v3}, Landroid/support/v4/app/z;->tL()Landroid/support/v4/app/D;
    ...
    invoke-virtual {v3, v5}, Landroid/support/v4/app/z;->dj(Ljava/lang/String;)Landroid/support/v4/app/Fragment;
    ...
    :cond_0
    iget-object v5, p0, Lmiui/mihome/resourcebrowser/activity/N;->alR:Ljava/util/List;
...
.method public a(Lcom/actionbarsherlock/a/c;)Z
    ...
    iget-object v0, p0, Lmiui/mihome/resourcebrowser/activity/N;->alS:Ljava/util/List;
    ...
    iget-object v2, p0, Lmiui/mihome/resourcebrowser/activity/N;->alS:Ljava/util/List;
...
.method public c(Lcom/actionbarsherlock/a/c;)Z
    ...
    iget v3, p0, Lmiui/mihome/resourcebrowser/activity/N;->alT:I
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, Lmiui/mihome/resourcebrowser/activity/N;->alP:Landroid/support/v4/view/ViewPager;
    ...
    invoke-direct {p0}, Lmiui/mihome/resourcebrowser/activity/N;->vI()V

    invoke-direct {p0}, Lmiui/mihome/resourcebrowser/activity/N;->vK()V

    invoke-direct {p0}, Lmiui/mihome/resourcebrowser/activity/N;->vL()V

    return-void
.end method

.method protected vJ()Lmiui/mihome/resourcebrowser/activity/A;
    .locals 1
