...
.field private abQ:Ljava/util/Set;

.field private abR:Ljava/util/Map;

.field private abS:I

.field final synthetic abT:Lmiui/mihome/resourcebrowser/activity/n;
...
.method private constructor <init>(Lmiui/mihome/resourcebrowser/activity/n;)V
    ...
    iput-object p1, p0, Lmiui/mihome/resourcebrowser/activity/E;->abT:Lmiui/mihome/resourcebrowser/activity/n;
    ...
    invoke-static {}, Lmiui/mihome/resourcebrowser/util/g;->fI()I

    move-result v0

    :goto_0
    iput v0, p0, Lmiui/mihome/resourcebrowser/activity/E;->abO:I
    ...
    iput-object v0, p0, Lmiui/mihome/resourcebrowser/activity/E;->abQ:Ljava/util/Set;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lmiui/mihome/resourcebrowser/activity/E;->abR:Ljava/util/Map;

    iput v3, p0, Lmiui/mihome/resourcebrowser/activity/E;->abS:I
...
.method static synthetic a(Lmiui/mihome/resourcebrowser/activity/E;)Ljava/util/Set;
    ...
    iget-object v0, p0, Lmiui/mihome/resourcebrowser/activity/E;->abQ:Ljava/util/Set;
...
.method static synthetic b(Lmiui/mihome/resourcebrowser/activity/E;)Ljava/util/Map;
    ...
    iget-object v0, p0, Lmiui/mihome/resourcebrowser/activity/E;->abR:Ljava/util/Map;
...
.method static synthetic c(Lmiui/mihome/resourcebrowser/activity/E;)I
    ...
    iget v0, p0, Lmiui/mihome/resourcebrowser/activity/E;->abS:I

    add-int/lit8 v0, v0, -0x1

    iput v0, p0, Lmiui/mihome/resourcebrowser/activity/E;->abS:I
...
.method static synthetic f(Lmiui/mihome/resourcebrowser/activity/E;)V
    ...
    invoke-direct {p0}, Lmiui/mihome/resourcebrowser/activity/E;->sh()V

    return-void
.end method

.method private sg()Lmiui/mihome/resourcebrowser/model/PathEntry;
    .locals 3

    const/4 v0, 0x0

    iget-object v1, p0, Lmiui/mihome/resourcebrowser/activity/E;->abP:Ljava/util/Map;
...
.method private sh()V
    ...
    iget v1, p0, Lmiui/mihome/resourcebrowser/activity/E;->abO:I

    if-ge v0, v1, :cond_0

    invoke-direct {p0}, Lmiui/mihome/resourcebrowser/activity/E;->sg()Lmiui/mihome/resourcebrowser/model/PathEntry;
    ...
    iget-object v2, p0, Lmiui/mihome/resourcebrowser/activity/E;->abP:Ljava/util/Map;
    ...
    iget v2, p0, Lmiui/mihome/resourcebrowser/activity/E;->abS:I
