...
.field final synthetic xl:Lmiui/mihome/resourcebrowser/widget/e;
...
.method public constructor <init>(Lmiui/mihome/resourcebrowser/widget/e;)V
    ...
    iput-object p1, p0, Lmiui/mihome/resourcebrowser/widget/b;->xl:Lmiui/mihome/resourcebrowser/widget/e;

    invoke-direct {p0}, Lmiui/mihome/c/h;-><init>()V

    const/4 v0, 0x1

    iput-boolean v0, p0, Lmiui/mihome/resourcebrowser/widget/b;->xy:Z

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lmiui/mihome/resourcebrowser/widget/b;->xz:Ljava/util/List;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lmiui/mihome/resourcebrowser/widget/b;->xA:Ljava/util/List;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lmiui/mihome/resourcebrowser/widget/b;->xB:Ljava/util/List;
...
.method private hE()Z
    ...
    :goto_1
    iget-object v0, p0, Lmiui/mihome/resourcebrowser/widget/b;->xB:Ljava/util/List;
    ...
    invoke-interface {v0}, Lmiui/mihome/resourcebrowser/widget/h;->xV()Z
...
.method public ah(I)V
    ...
    iput p1, p0, Lmiui/mihome/resourcebrowser/widget/b;->vb:I

    return-void
.end method

.method protected ai(I)[Ljava/lang/Object;
    .locals 1
...
.method protected varargs d([Ljava/lang/Void;)Ljava/util/List;
    ...
    :goto_1
    invoke-virtual {p0, v0}, Lmiui/mihome/resourcebrowser/widget/b;->ai(I)[Ljava/lang/Object;

    move-result-object v1

    if-eqz v1, :cond_2

    iget-object v2, p0, Lmiui/mihome/resourcebrowser/widget/b;->xz:Ljava/util/List;
    ...
    :cond_1
    invoke-virtual {p0}, Lmiui/mihome/resourcebrowser/widget/b;->hF()[Ljava/lang/Object;

    move-result-object v0

    if-eqz v0, :cond_2

    iget-object v1, p0, Lmiui/mihome/resourcebrowser/widget/b;->xz:Ljava/util/List;
    ...
    :cond_2
    iget-object v0, p0, Lmiui/mihome/resourcebrowser/widget/b;->xz:Ljava/util/List;
...
.method protected d(Ljava/util/List;)V
    ...
    iget-object v0, p0, Lmiui/mihome/resourcebrowser/widget/b;->xl:Lmiui/mihome/resourcebrowser/widget/e;
    ...
    iget-boolean v0, p0, Lmiui/mihome/resourcebrowser/widget/b;->xy:Z

    if-nez v0, :cond_0

    iget-object v0, p0, Lmiui/mihome/resourcebrowser/widget/b;->xl:Lmiui/mihome/resourcebrowser/widget/e;

    iget v1, p0, Lmiui/mihome/resourcebrowser/widget/b;->vb:I
    ...
    iget-object v1, p0, Lmiui/mihome/resourcebrowser/widget/b;->xA:Ljava/util/List;
...
.method protected hF()[Ljava/lang/Object;
    .locals 1
...
.method protected onPreExecute()V
    ...
    invoke-direct {p0}, Lmiui/mihome/resourcebrowser/widget/b;->hE()Z
    ...
    :cond_0
    iget-object v1, p0, Lmiui/mihome/resourcebrowser/widget/b;->xl:Lmiui/mihome/resourcebrowser/widget/e;

    iget v2, p0, Lmiui/mihome/resourcebrowser/widget/b;->vb:I
    ...
    :cond_3
    iget-object v0, p0, Lmiui/mihome/resourcebrowser/widget/b;->xA:Ljava/util/List;
...
.method protected varargs onProgressUpdate([Ljava/lang/Object;)V
    ...
    iget-boolean v1, p0, Lmiui/mihome/resourcebrowser/widget/b;->xy:Z
