...
# instance fields
.field private RW:Lmiui/mihome/resourcebrowser/controller/online/J;

.field private RX:Lmiui/mihome/resourcebrowser/controller/online/f;

.field private RY:Lmiui/mihome/resourcebrowser/controller/online/G;

.field private RZ:Ljava/util/UUID;

.field protected Sa:J
...
.method public constructor <init>(Ljava/lang/String;Ljava/util/UUID;)V
    ...
    iput-object v0, p0, Lmiui/mihome/resourcebrowser/controller/online/x;->RX:Lmiui/mihome/resourcebrowser/controller/online/f;

    iput-object p2, p0, Lmiui/mihome/resourcebrowser/controller/online/x;->RZ:Ljava/util/UUID;
...
.method public static d(Ljava/nio/ByteBuffer;)Lmiui/mihome/resourcebrowser/controller/online/x;
    ...
    iget-wide v1, v0, Lmiui/mihome/resourcebrowser/controller/online/x;->Sa:J
    ...
    iget-object v4, v0, Lmiui/mihome/resourcebrowser/controller/online/x;->RX:Lmiui/mihome/resourcebrowser/controller/online/f;

    invoke-virtual {v4}, Lmiui/mihome/resourcebrowser/controller/online/f;->tI()J
...
.method public bj()V
    ...
    iget-object v0, p0, Lmiui/mihome/resourcebrowser/controller/online/x;->RW:Lmiui/mihome/resourcebrowser/controller/online/J;
    ...
    iput-object v0, p0, Lmiui/mihome/resourcebrowser/controller/online/x;->RW:Lmiui/mihome/resourcebrowser/controller/online/J;

    iget-object v0, p0, Lmiui/mihome/resourcebrowser/controller/online/x;->RW:Lmiui/mihome/resourcebrowser/controller/online/J;

    invoke-virtual {v0}, Lmiui/mihome/resourcebrowser/controller/online/J;->tI()J

    move-result-wide v0

    iput-wide v0, p0, Lmiui/mihome/resourcebrowser/controller/online/x;->Sa:J

    iget-object v0, p0, Lmiui/mihome/resourcebrowser/controller/online/x;->RX:Lmiui/mihome/resourcebrowser/controller/online/f;
    ...
    iget-object v0, p0, Lmiui/mihome/resourcebrowser/controller/online/x;->RY:Lmiui/mihome/resourcebrowser/controller/online/G;
    ...
    iput-object v0, p0, Lmiui/mihome/resourcebrowser/controller/online/x;->RY:Lmiui/mihome/resourcebrowser/controller/online/G;

    iget-object v0, p0, Lmiui/mihome/resourcebrowser/controller/online/x;->RY:Lmiui/mihome/resourcebrowser/controller/online/G;

    invoke-virtual {v0}, Lmiui/mihome/resourcebrowser/controller/online/G;->tI()J
    ...
    iget-object v1, p0, Lmiui/mihome/resourcebrowser/controller/online/x;->RX:Lmiui/mihome/resourcebrowser/controller/online/f;
    ...
    iget-object v0, p0, Lmiui/mihome/resourcebrowser/controller/online/x;->RZ:Ljava/util/UUID;

    invoke-virtual {p0, v0}, Lmiui/mihome/resourcebrowser/controller/online/x;->a(Ljava/util/UUID;)Ljava/util/UUID;

    move-result-object v0

    iput-object v0, p0, Lmiui/mihome/resourcebrowser/controller/online/x;->RZ:Ljava/util/UUID;
    ...
    invoke-virtual {p0}, Lmiui/mihome/resourcebrowser/controller/online/x;->gm()Ljava/nio/ByteBuffer;
...
.method public pN()Lmiui/mihome/resourcebrowser/controller/online/f;
    .locals 1
