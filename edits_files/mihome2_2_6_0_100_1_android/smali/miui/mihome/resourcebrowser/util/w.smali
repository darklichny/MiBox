...
# instance fields
.field protected To:Lmiui/mihome/resourcebrowser/util/h;

.field protected Tp:I

.field protected Tq:I

.field private Tr:Ljava/util/HashSet;

.field private Ts:Ljava/util/concurrent/ExecutorService;

.field private Tt:Ljava/util/concurrent/ExecutorService;

.field private Tu:Ljava/util/HashMap;

.field private Tv:Lmiui/mihome/resourcebrowser/util/j;
...
.method public constructor <init>(I)V
    ...
    iput-object v0, p0, Lmiui/mihome/resourcebrowser/util/w;->Tr:Ljava/util/HashSet;
    ...
    iput-object v0, p0, Lmiui/mihome/resourcebrowser/util/w;->Ts:Ljava/util/concurrent/ExecutorService;
    ...
    iput-object v0, p0, Lmiui/mihome/resourcebrowser/util/w;->Tu:Ljava/util/HashMap;

    const/4 v0, 0x0

    iput-object v0, p0, Lmiui/mihome/resourcebrowser/util/w;->Tv:Lmiui/mihome/resourcebrowser/util/j;
    ...
    iput-object v0, p0, Lmiui/mihome/resourcebrowser/util/w;->To:Lmiui/mihome/resourcebrowser/util/h;
...
.method static synthetic a(Lmiui/mihome/resourcebrowser/util/w;)Lmiui/mihome/resourcebrowser/util/j;
    ...
    iget-object v0, p0, Lmiui/mihome/resourcebrowser/util/w;->Tv:Lmiui/mihome/resourcebrowser/util/j;
...
.method static synthetic c(Lmiui/mihome/resourcebrowser/util/w;)Ljava/util/concurrent/ExecutorService;
    ...
    iget-object v0, p0, Lmiui/mihome/resourcebrowser/util/w;->Ts:Ljava/util/concurrent/ExecutorService;
...
.method static synthetic d(Lmiui/mihome/resourcebrowser/util/w;)Ljava/util/HashMap;
    ...
    iget-object v0, p0, Lmiui/mihome/resourcebrowser/util/w;->Tu:Ljava/util/HashMap;
...
.method static synthetic e(Lmiui/mihome/resourcebrowser/util/w;)Ljava/util/HashSet;
    ...
    iget-object v0, p0, Lmiui/mihome/resourcebrowser/util/w;->Tr:Ljava/util/HashSet;
...
.method public C(II)V
    ...
    iput p1, p0, Lmiui/mihome/resourcebrowser/util/w;->Tp:I

    iput p2, p0, Lmiui/mihome/resourcebrowser/util/w;->Tq:I
...
.method public a(Ljava/lang/String;IZ)Landroid/graphics/Bitmap;
    ...
    iget v1, p0, Lmiui/mihome/resourcebrowser/util/w;->Tp:I

    iget v2, p0, Lmiui/mihome/resourcebrowser/util/w;->Tq:I

    iget-object v3, p0, Lmiui/mihome/resourcebrowser/util/w;->To:Lmiui/mihome/resourcebrowser/util/h;
    ...
    iget-object v1, p0, Lmiui/mihome/resourcebrowser/util/w;->To:Lmiui/mihome/resourcebrowser/util/h;
...
.method public a(Lmiui/mihome/resourcebrowser/util/j;)V
    ...
    iput-object p1, p0, Lmiui/mihome/resourcebrowser/util/w;->Tv:Lmiui/mihome/resourcebrowser/util/j;
...
.method public ar(Z)V
    ...
    iget-object v0, p0, Lmiui/mihome/resourcebrowser/util/w;->To:Lmiui/mihome/resourcebrowser/util/h;
...
.method public b(Ljava/lang/String;Ljava/lang/String;I)V
    ...
    invoke-virtual {v0}, Lmiui/mihome/resourcebrowser/util/F;->sr()V
...
.method public pZ()I
    ...
    invoke-virtual {v0}, Lmiui/mihome/resourcebrowser/util/h;->hH()I
