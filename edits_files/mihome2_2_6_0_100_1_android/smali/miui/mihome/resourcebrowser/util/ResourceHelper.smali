...
# static fields
.field private static agn:Ljava/util/Map;

.field private static ago:Ljava/io/File;

.field protected static agp:Ljava/util/Map;

.field private static agq:Landroid/os/Handler;

.field private static agr:Ljava/lang/Runnable;
...
.method static constructor <clinit>()V
    ...
    sput-object v1, Lmiui/mihome/resourcebrowser/util/ResourceHelper;->ago:Ljava/io/File;

    :try_start_0
    new-instance v0, Ljava/io/FileInputStream;

    sget-object v1, Lmiui/mihome/resourcebrowser/util/ResourceHelper;->ago:Ljava/io/File;
    ...
    sput-object v0, Lmiui/mihome/resourcebrowser/util/ResourceHelper;->agp:Ljava/util/Map;
    ...
    :cond_0
    :goto_0
    sget-object v0, Lmiui/mihome/resourcebrowser/util/ResourceHelper;->agp:Ljava/util/Map;
    ...
    sget-object v2, Lmiui/mihome/resourcebrowser/util/ResourceHelper;->agp:Ljava/util/Map;
    ...
    sput-object v0, Lmiui/mihome/resourcebrowser/util/ResourceHelper;->agq:Landroid/os/Handler;

    new-instance v0, Lmiui/mihome/resourcebrowser/util/t;

    invoke-direct {v0}, Lmiui/mihome/resourcebrowser/util/t;-><init>()V

    sput-object v0, Lmiui/mihome/resourcebrowser/util/ResourceHelper;->agr:Ljava/lang/Runnable;
...
.method public static a(Lmiui/mihome/resourcebrowser/ResourceContext;Landroid/content/Intent;Landroid/content/Context;)Lmiui/mihome/resourcebrowser/ResourceContext;
    ...
    invoke-static {v1}, Lmiui/mihome/c/a;->as(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v2}, Lmiui/mihome/c/a;->as(Ljava/lang/String;)Ljava/lang/String;
...
.method private static a(Ljava/lang/String;Lmiui/mihome/resourcebrowser/util/ResourceHelper$FileHash;)V
    ...
    sget-object v1, Lmiui/mihome/resourcebrowser/util/ResourceHelper;->agp:Ljava/util/Map;
    ...
    sget-object v0, Lmiui/mihome/resourcebrowser/util/ResourceHelper;->ago:Ljava/io/File;

    if-eqz v0, :cond_0

    sget-object v0, Lmiui/mihome/resourcebrowser/util/ResourceHelper;->agq:Landroid/os/Handler;

    sget-object v1, Lmiui/mihome/resourcebrowser/util/ResourceHelper;->agr:Ljava/lang/Runnable;
...
.method public static b(Ljava/io/InputStream;)Ljava/util/Map;
    ...
    invoke-virtual {v2}, Lmiui/mihome/resourcebrowser/util/m;->oh()Ljava/util/HashMap;
...
.method public static da(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p0}, Lmiui/mihome/c/a;->ar(Ljava/lang/String;)Ljava/lang/String;
...
.method public static db(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p0}, Lmiui/mihome/resourcebrowser/util/ResourceHelper;->dc(Ljava/lang/String;)Ljava/lang/String;
...
.method public static dg(Ljava/lang/String;)Landroid/net/Uri;
    .locals 2
...
.method static synthetic tJ()Ljava/io/File;
    .locals 1
