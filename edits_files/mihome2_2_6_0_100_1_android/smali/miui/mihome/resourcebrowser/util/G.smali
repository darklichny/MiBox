...
# static fields
.field private static adS:Lmiui/mihome/resourcebrowser/model/Resource;


# instance fields
.field protected adQ:Lmiui/mihome/resourcebrowser/util/c;

.field protected adR:Lmiui/mihome/resourcebrowser/util/N;
...
.method public constructor <init>(Lmiui/mihome/resourcebrowser/activity/e;Lmiui/mihome/resourcebrowser/activity/n;Lmiui/mihome/resourcebrowser/ResourceContext;)V
    ...
    iput-object v0, p0, Lmiui/mihome/resourcebrowser/util/G;->adQ:Lmiui/mihome/resourcebrowser/util/c;
    ...
    iput-object v0, p0, Lmiui/mihome/resourcebrowser/util/G;->adR:Lmiui/mihome/resourcebrowser/util/N;

    iget-object v0, p0, Lmiui/mihome/resourcebrowser/util/G;->adQ:Lmiui/mihome/resourcebrowser/util/c;

    iget-object v1, p0, Lmiui/mihome/resourcebrowser/util/G;->adR:Lmiui/mihome/resourcebrowser/util/N;

    invoke-virtual {v1}, Lmiui/mihome/resourcebrowser/util/N;->uC()Lmiui/mihome/resourcebrowser/util/M;
    ...
    iput-boolean v0, p0, Lmiui/mihome/resourcebrowser/util/G;->Zh:Z

    invoke-direct {p0}, Lmiui/mihome/resourcebrowser/util/G;->sL()V
...
.method private J(Landroid/view/View;)V
    ...
    iget-object v1, p0, Lmiui/mihome/resourcebrowser/util/G;->adQ:Lmiui/mihome/resourcebrowser/util/c;

    invoke-virtual {v1, v0}, Lmiui/mihome/resourcebrowser/util/c;->n(Lmiui/mihome/resourcebrowser/model/Resource;)Z

    move-result v1

    iget-object v2, p0, Lmiui/mihome/resourcebrowser/util/G;->adQ:Lmiui/mihome/resourcebrowser/util/c;
    ...
    sput-object v0, Lmiui/mihome/resourcebrowser/util/G;->adS:Lmiui/mihome/resourcebrowser/model/Resource;

    :goto_0
    iget-object v0, p0, Lmiui/mihome/resourcebrowser/util/G;->adR:Lmiui/mihome/resourcebrowser/util/N;
...
.method private R(Lmiui/mihome/resourcebrowser/model/Resource;)Z
    ...
    iget-boolean v0, p0, Lmiui/mihome/resourcebrowser/util/G;->Zf:Z
...
.method static synthetic sM()Lmiui/mihome/resourcebrowser/model/Resource;
    .locals 1

    sget-object v0, Lmiui/mihome/resourcebrowser/util/G;->adS:Lmiui/mihome/resourcebrowser/model/Resource;
...
.method protected E(Landroid/view/View;)V
    ...
    invoke-virtual {p0}, Lmiui/mihome/resourcebrowser/util/G;->rr()Z
...
.method protected S(Lmiui/mihome/resourcebrowser/model/Resource;)V
    ...
    invoke-static {v0}, Lmiui/mihome/resourcebrowser/util/ResourceHelper;->dg(Ljava/lang/String;)Landroid/net/Uri;
...
.method public rq()V
    ...
    invoke-super {p0}, Lmiui/mihome/resourcebrowser/util/B;->rq()V
